<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="fms_Supplier_Outstanding.aspx.cs" Inherits="FMS_FMS_Reports_fms_Supplier_Outstanding_fms_Supplier_Outstanding" %>
          ...
          function PostdatedChqDisplay(LdgrId) {
            ...
            if (LdgrId != "") {
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Supplier_Outstanding.aspx/LoadPostdatedChqDtls",
          ...
          function OpenCustomerDetails(StrId, RowId, mode) {
              ...
              if (datefrom != "") {
                  ...
                  $noCon.ajax({
                      type: "POST",
                      async: false,
                      url: "fms_Supplier_Outstanding.aspx/CustomerDetails_ById",
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <ol class="breadcrumb sticky1">
        ...
        <li class="active">Suppiler Outstanding Report</li>
    </ol>
    ...
    <div class="content_sec2 cont_contr">
        <div class="content_area_container cont_contr">
            <div class="content_box1 cont_contr">
                <h2>
                    <asp:Label ID="lblEntry" runat="server">Supplier Outstanding Report</asp:Label>
                </h2>
        ...
        function PrintClick(PrintMode) {
            ...
            if (datefrom != "") {
                ...
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Supplier_Outstanding.aspx/CustomerDetails",
        ...
        function PrintClickDrillDwn(PrintMode) {
            ...
            if (datefrom != "") {
                ...
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Supplier_Outstanding.aspx/CustomerDetails_ById_Print",

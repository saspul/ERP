<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="fms_Outstanding_Ageing.aspx.cs" Inherits="FMS_FMS_Reports_fms_Outstanding_Ageing_fms_Outstanding_Ageing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        //            resizable: false,
        //            modal: true,
        //            title: "CUSTOMER OUTSTANDING AGEING REPORT",
        //        });
        //    });
        //}
          ...
          function PendingReceiptsDisplay(LdgrId) {
              ...
              if (LdgrId != "") {
                  $noCon.ajax({
                      type: "POST",
                      async: false,
                      url: "fms_Outstanding_Ageing.aspx/LoadPendingReceipts",
        ...
        function PostdatedChqDisplay(LdgrId) {
            ...
            if (LdgrId != "") {
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Outstanding_Ageing.aspx/LoadPostdatedChqDtls",
                    data: '{OrgId:"' + OrgId + '" ,CorpId:"' + CorpId + '",LdgrId:"' + LdgrId + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <ol class="breadcrumb sticky1">
        ...
        <li class="active">Customer Outstanding Ageing Report  </li>
    </ol>
    ...
    <div class="content_sec2 cont_contr">
        <div class="content_area_container cont_contr">
            <div class="content_box1 cont_contr">
                <h2>
                    <asp:Label ID="lblEntry" runat="server">CUSTOMER OUTSTANDING AGEING REPORT </asp:Label>
                </h2>
            ...
            <div class="">
              <div class="fg12">
                ...
                <div class="form-group fg7 mar_lt" id="divMode">
                ...
                <div class="motd_1" id="divMethod1">
                    <div class="form-group fg7">
                        <label for="email" class="fg2_la1">Ageing From:</label>
                        <input id="txtFromAgeing" runat="server" type="text" onchange="return ChangeFromToAge(cphMain_txtFromAgeing);" onkeypress="return isNumber(event)"  autocomplete="off" onkeydown="return isNumber(event)" class="form-control fg2_inp1 inp_mst" maxlength="10" />
                    </div>
                    <div class="form-group fg7">
                        <label for="email" class="fg2_la1">Ageing To:</label>
                        <input id="txtToAgeing" runat="server" type="text" onchange="return ChangeFromToAge(cphMain_txtToAgeing);" onkeypress="return isNumber(event)" autocomplete="off" onkeydown="return isNumber(event)" class="form-control fg2_inp1 inp_mst" maxlength="10" />
                    </div>
                </div>


                <div class="motd_2" id="divMethod2">
                    <div class="form-group fg2">
                        <label for="email" class="fg2_la1">Ageing Split:<span class="spn1">*</span></label>
                        <div class="col-md-4 pa_l">
                            <input id="txtSplit1" runat="server" type="text" autocomplete="off" onchange="return ChangeSplit(cphMain_txtSplit1);" onkeypress="return isNumber(event)" onkeydown="return isNumber(event)" class="form-control fg2_inp1 inp_mst tr_r" maxlength="10" />
                        </div>
                        <div class="col-md-4 pa_l">
                            <input id="txtSplit2" runat="server" type="text" autocomplete="off" onchange="return ChangeSplit(cphMain_txtSplit2);" onkeypress="return isNumber(event)" onkeydown="return isNumber(event)" class="form-control fg2_inp1 inp_mst tr_r" maxlength="10" />
                        </div>
                        <div class="col-md-4 pa_l">
                            <input id="txtSplit3" runat="server" type="text" autocomplete="off" onchange="return ChangeSplit(cphMain_txtSplit3);" onkeypress="return isNumber(event)" onkeydown="return isNumber(event)" class="form-control fg2_inp1 inp_mst tr_r" maxlength="10" />
                        </div>
                    </div>
                    <div class="form-group fg7 fg2_mr">
                        <div class="row">
                            <div class="">
                                <div class="form-check">
                                    <input name="optradio" type="radio" class="form-check-input" checked="true" onkeypress="return DisableEnter(event)" runat="server" id="radioConsoldtd" />
                                    <label class="form-check-label" for="gridRadios12">Consolidated</label>
                                </div>
                                <div class="form-check">
                                    <input name="optradio" type="radio" class="form-check-input" id="radioIndividual" onkeypress="return DisableEnter(event)" runat="server" />
                                    <label class="form-check-label" for="gridRadios21">Individual</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog mod2" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title tr_c" id="hStatementType">CUSTOMER OUTSTANDING AGEING REPORT</h4>
    ...
    <script>
        ...
        function PrintClick(PrintMode) {
            ...
            $noCon.ajax({
                type: "POST",
                async: false,
                url: "fms_Outstanding_Ageing.aspx/LoadConvertToTable_Print",
        ...
        function PrintClickDrillDwn(PrintMode) {
            ...
            if (datefrom != "" && dateto != "") {
                ...
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Outstanding_Ageing.aspx/TrailBalance_Lists_ById_Print",
        ...
        function OpenReconView(StrId, strName, mode, AgeingFrom, AgeingTo, Split1, Split2, Split3) {
            ...
            if (datefrom != "" && dateto != "") {
                ...
                $noCon.ajax({
                    type: "POST",
                    async: false,
                    url: "fms_Outstanding_Ageing.aspx/TrailBalance_Lists_ById",
                    ...
                    success: function (response) {
                        ...
                        //alert(strName.indexOf('‡')); alert(strName.indexOf('¦'));
                        ...
                        document.getElementById("CustName").innerHTML = "Customer Name: " + strName;
                        if (mode == 0) {
                            var FromAge = document.getElementById("cphMain_txtFromAgeing").value;
                            var ToAge = document.getElementById("cphMain_txtToAgeing").value;
                            if (FromAge != "" && ToAge != "") {

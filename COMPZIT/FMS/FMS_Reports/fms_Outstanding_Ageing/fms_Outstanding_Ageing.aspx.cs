...
public partial class FMS_FMS_Reports_fms_Outstanding_Ageing_fms_Outstanding_Ageing : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      HiddenFieldSearchDate.Value=txtTodate.Value;
            ...
            DataTable dtCategory = objBussiness.Ageing_List(ObjEntityRequest);
            string Printsts = "0";
            ...
            {
                dtCategory = objBussiness.Ageing_ListCrdtPrd (ObjEntityRequest);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dtCategory = objBussiness.Ageing_List(ObjEntityRequest);
        if (radioCredit.Checked == true)
        {
            dtCategory = objBussiness.Ageing_ListCrdtPrd (ObjEntityRequest);
            string Printsts = "0";
    ...
    public string PrintCaption(clsEntityOutstandingAgeing ObjEntityRequest,string strName)
    {
        ...
        clsBusinessLayer objBusiness = new clsBusinessLayer();
        string strTitle = "";
        strTitle = "OUTSTANDING AGEING REPORT";
        ...
        if (strName != "")
        {
            GuaranteDnaM = "<B>CUSTOMER NAME: </B>" + strName;
        }
    ...
    //main list table based on sales date
    public string LoadConvertToTable(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts)
    {
        ...
        if (Printsts == "0")
        {
            ...
            strHtml += "<tr >";
            strHtml += "<th class=\"col-md-3 tr_l\" >CUSTOMER NAME ";
            strHtml += "  <i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in\" placeholder=\"CUSTOMER NAME \"  type=\"text\" onkeypress=\"return DisableEnter(event)\">";
        ...
        else
        {
            ...
            //strHtml += "</th >";
            strHtml += "<th class=\"thT\" style=\"width:60%;text-align:left;\">CUSTOMER NAME ";
            strHtml += "</th >";
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dtCategory1.Rows.Count; intRowBodyCount++)
        {
            ...
            //pending receipts
            DataTable dt = objBussinessAging.ReadPendingReceipts(ObjEntityRequest1);
            if (dt.Rows.Count > 0)
            {
                strHtml += "<span href=\"javascript:;\" class=\"pull-right spn_rc pst_dt_bx\" title=\"Pending Receipt Details\" onclick=\"return PendingReceiptsDisplay('" + Id + "');\" data-toggle=\"modal\" data-target=\"#ModalPendingReceipt\" > <i class=\"fa fa-clipboard\"></i></span>";
            }
        ...
        if (dtCategory1.Rows.Count > 0)
        {
            ...
            strHtml += "<th class=\"tr_r bg1 txt_rd\"  style=\"text-align:right;\"> " + objBusiness.AddCommasForNumberSeperation(sum_debt.ToString(), objEntityCommon) + "</th>";
            strHtml += "</tr></tfoot>";
        }
        strHtml += "</table>";
        sb.Append(strHtml);
    ...
    //main list table based on credit period evm 0044
    public string LoadConvertToTableCreditPeriod(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts)
    {
        ...
        if (Printsts == "0")
        {
            ...
            strHtml += " <i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"AMOUNT WITHOUT DUE\" type=\"text\" onkeypress=\"return DisableEnter(event)\">";
            strHtml += "</th >";
            strHtml += "<th class=\"col-md-2 tr_r\" >AMOUNT WITH DUE";
            strHtml += " <i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"AMOUNT WITH DUE\" type=\"text\" onkeypress=\"return DisableEnter(event)\">";
            strHtml += "</th >";
            strHtml += "</tr>";
            strHtml += "</thead>";
        }
        else
        {
            ...
            strHtml += "<th class=\"thT\" style=\"width:60%;text-align:left;\">CUSTOMER NAME ";
            strHtml += "</th >";
            strHtml += "<th class=\"thT\" style=\"width:20%;text-align:right;\">AMOUNT WITHOUT DUE";
            strHtml += "</th >";
            strHtml += "<th class=\"thT\" style=\"width:20%;text-align:right;\">AMOUNT WITH DUE";
            strHtml += "</th >";
            strHtml += "</tr>";
            strHtml += "</thead>";
        }
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dtCategory1.Rows.Count; intRowBodyCount++)
        {
            ...
            strHtml += "<td class=\"tr_l\" style=\"text-align:left;\"> <a  title=\"View\"  onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + ObjEntityRequest.FromAgeing + "','" + 2 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + dtCategory1.Rows[intRowBodyCount]["CSTMR_NAME"].ToString() + "</a>";
        ...
        if (dtCategory1.Rows.Count > 0)
        {
            ...
            strHtml += "<th class=\"tr_r bg1 txt_rd\" style=\"text-align:left !important;\" >TOTAL </th>";
            strHtml += "<th class=\"tr_r bg1 txt_rd\"  style=\"text-align:right;\"> " + objBusiness.AddCommasForNumberSeperation(sum_debt.ToString(), objEntityCommon) + "</th>";
            strHtml += "<th class=\"tr_r bg1 txt_rd\"  style=\"text-align:right;\"> " + objBusiness.AddCommasForNumberSeperation(sum_debt1.ToString(), objEntityCommon) + "</th>";
            strHtml += "</tr></tfoot>";
        }
        strHtml += "</table>";
        sb.Append(strHtml);
    ...
    public string LoadConvertToTable_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        string strRandom = objCommon.Random_Number();
        string strRet = "";
        string strImagePath = objCommon.GetImagePath(clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTANDING_AGING_PDF);
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTANDING_AGING_PDF);
        ...
        string strImageName = "Cust_AgeingList_" + strNextNumber + ".pdf";
    ...
    public string LoadConvertToTableCreditPeriod_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        objEntityCommon.Organisation_Id = ObjEntityRequest.Organisation_id;
        string strNextNumber = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string strImageName = "Cust_AgeingListCrdtPeriod_" + strNextNumber + ".pdf";
    ...
    public string LoadConvertToTable_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingList_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingList_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
  ...
  //----evm 0044
    public string LoadConvertToTableCreditPeriod_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingListCrdtPeriod_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingListCrdtPeriod_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
        return strImagePath + filepath;
    }
    //---evm 0044
    public DataTable GetTable_CreditPeriod(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        try
        {
            table.Columns.Add("CUSTOMER OUTSTANDING AGEING REPORT ", typeof(string));
            ...
            table.Rows.Add('"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"');
            table.Rows.Add("CUSTOMER NAME", "AMOUNT WITHOUT DUE","AMOUNT WITH DUE");
    ...
    public DataTable GetTable_1(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        try
        {
            ...
            table.Rows.Add('"' + FORNULL + '"', '"' + FORNULL + '"');
            table.Rows.Add("CUSTOMER NAME", "OUTSTANDING AMOUNT");
    ...
    public static string[] LoadConvertToTable_Print(string intuserid, string intorgid, string intcorpid, string intdatefrom, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string FinYearFromDate, string FinYearToDate, string individual, string strPrintMode)
    {
        ...
        FMS_FMS_Reports_fms_Outstanding_Ageing_fms_Outstanding_Ageing OBJ = new FMS_FMS_Reports_fms_Outstanding_Ageing_fms_Outstanding_Ageing();
        if (intdateto != "")
        {
    ...
    public static string[] TrailBalance_Lists_ById(string intAccntId, string intuserid, string intorgid, string intcorpid, string intdatefrom, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3,string strName,string FinYearFromDate,string FinYearToDate)
    {
        ...
        StringBuilder sb = new StringBuilder();
        DataTable dtList = objBussiness.Ageing_List_ById(objEntity);
        ...
        else if (objEntity.Mode == 3)
        {
            ...
            dtList = objBussiness.Ageing_List_ByIdCrdPrd (objEntity);
             string Printsts = "0";
            result[1] = obj.LoadConvertToTableCreditPopup (dtList, objEntity, strId, Printsts);
            Printsts = "1";
            result[4] = obj.LoadConvertToTableCreditPopup(dtList, objEntity, strId, Printsts);
            result[0] = dtList.Rows.Count.ToString();
            result[2] = strId;
            result[3] = obj.PrintCaption(objEntity, strName);
        }
    ...
    public string LoadConvertToTableLed(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts)
    {
        ...
        //clsEntityPaymentAccount ObjEntityRequest1 = new clsEntityPaymentAccount();
        ...
        if (Printsts == "0")
        {
            ...
            strHtml += " <i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_l\" placeholder=\"INVOICE NO \" type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"th_b7\" >INVOICE DATE ";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\"INVOICE DATE\" type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"th_b6 tr_r\" >INVOICE AMOUNT ";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"INVOICE AMOUNT \"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"th_b6 tr_r\" >PAID AMOUNT ";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"PAID AMOUNT\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"th_b6 tr_r\">RETURN AMOUNT";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"CREDIT AMOUNT\"  type=\"text\">";
            strHtml += "</th>";
            strHtml += "<th class=\"th_b6 tr_r\" >BALANCE AMOUNT ";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"BALANCE AMOUNT\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"th_b7\" >AGEING ";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\"AGEING\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "</tr>";
            strHtml += "</thead>";
        ...
        {
            strHtml += "<tr class=\"tr_opn\"><td class=\"tr_l\">OPENING BALANCE</td><td></td><td></td><td></td><td></td><td class=\"tr_r\" >" + objBusiness.AddCommasForNumberSeperation(dtForOB.Rows[0]["VOCHR_OB"].ToString(), objEntityCommon) + "</td><td></td>";
            strHtml += "</tr>";
        }
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dtCategory.Rows.Count; intRowBodyCount++)
        {
            ...
            strHtml += "<td class=\"tr_l\"  >" + dtCategory.Rows[intRowBodyCount]["SALES_REF"].ToString() + "</td>";
            strHtml += "<td class=\"tr_c\" style=\"text-align:center !important;\">" + dtCategory.Rows[intRowBodyCount]["SALES_DATE"].ToString() + "</td>";
            ...
            strHtml += "<td class=\"tr_r\" style=\"text-align:right;\" > " + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["BALNC_AMT"].ToString(), objEntityCommon) + "</td>";
            strHtml += "<td class=\"tr_c\" style=\"text-align:center !important;\"> " + dtCategory.Rows[intRowBodyCount]["DAYS"].ToString() + "</td>";
            strHtml += "</tr>";
        }
        strHtml += "</tbody>";
    ...
    public string LoadConvertToTableLed_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.Organisation_Id = ObjEntityRequest.Organisation_id;
        string strNextNumber = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string strImageName = "Cust_AgeingTableLed_" + strNextNumber + ".pdf";
    ...
    public string LoadConvertToTableLed_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingTableLed_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingTableLed_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
        return strImagePath + filepath;
    }
    public DataTable GetTable_3(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        try
        {
            ...
            table.Rows.Add("CUSTOMER :", '"' + strName + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"');
            ...
            {
                COUNT++;
                table.Rows.Add('"' + dtCategory.Rows[intRowBodyCount]["SALES_REF"].ToString() + '"', '"' + dtCategory.Rows[intRowBodyCount]["SALES_DATE"].ToString() + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["INVOICE_AMT"].ToString(), objEntityCommon) + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["PAID_AMT"].ToString(), objEntityCommon) + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["SALES_RETURN_AMNT"].ToString(), objEntityCommon) + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["BALNC_AMT"].ToString(), objEntityCommon) + '"', '"' + dtCategory.Rows[intRowBodyCount]["DAYS"].ToString() + '"');
            }
    ...
    public string LoadConvertToTableCreditPopup(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts)
    {
        ...
        if (Printsts == "0")
        {
            ...
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\"DUE DAYS\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "</tr>";
            strHtml += "</thead>";
    ...
    public string LoadConvertToTableCreditPopup_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.Organisation_Id = ObjEntityRequest.Organisation_id;
        string strNextNumber = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string strImageName = "Cust_AgeingTableCredit_" + strNextNumber + ".pdf";
    ...
    public string LoadConvertToTableCreditPopup_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId1, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingTableCreditPeriod_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingTableCreditPeriod_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
        return strImagePath + filepath;
    }
    ...
    public string LoadConvertToTableLedCons(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId, string Printsts)
    {
        ...
        if (Printsts == "0")
        {
            ...
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in\" placeholder=\"INVOICE DATE\"  type=\"text\">";
            strHtml += "</th >";
            ...
            //strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_r\" placeholder=\"NO DUE\" type=\"text\">";
            //strHtml += "</th >";
            strHtml += "<th class=\"col-md-1 tr_c\" >0-" + ObjEntityRequest.Split1 + "";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c \" placeholder=\"0-" + ObjEntityRequest.Split1 + "\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"col-md-1 tr_c\" >" + (ObjEntityRequest.Split1 + 1) + "-" + ObjEntityRequest.Split2 + "";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\"" + (ObjEntityRequest.Split1 + 1) + " - " + ObjEntityRequest.Split2 + "\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"col-md-1 tr_c\" >" + (ObjEntityRequest.Split2 + 1) + "-" + ObjEntityRequest.Split3 + "";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\"" + (ObjEntityRequest.Split2 + 1) + " - " + ObjEntityRequest.Split3 + "\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "<th class=\"col-md-1 tr_c\" >>" + ObjEntityRequest.Split3 + "";
            strHtml += "<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input class=\"tb_inp_1 tb_in tr_c\" placeholder=\">" + ObjEntityRequest.Split3 + "\"  type=\"text\">";
            strHtml += "</th >";
            strHtml += "</tr>";
            strHtml += "</thead>";
        }
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dtCategory.Rows.Count; intRowBodyCount++)
        {
         ...
         //   strHtml += "<td class=\"tdT\" style=\" width:5%;text-align: left;\" >" + COUNT + "</td>";
            strHtml += "<td class=\"tr_l\" >" + dtCategory.Rows[intRowBodyCount]["SALES_REF"].ToString() + "</td>";
            strHtml += "<td  style=\"text-align:center !important;\">" + dtCategory.Rows[intRowBodyCount]["SALES_DATE"].ToString() + "</td>";
            strHtml += "<td  class=\"tr_r\" style=\"text-align:right;\">" + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["INVOICE_AMT"].ToString(), objEntityCommon) + "</td>";
            strHtml += "<td class=\"tr_r\"  style=\"text-align:right;\">" + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["PAID_AMT"].ToString(), objEntityCommon) + "</td>";
            strHtml += "<td class=\"tr_r\"  style=\"text-align:right;\">" + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["SALES_RETURN_AMNT"].ToString(), objEntityCommon) + "</td>";
    ...
    public string LoadConvertToTableLedCons_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.Organisation_Id = ObjEntityRequest.Organisation_id;
        string strNextNumber = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string strImageName = "Cust_AgeingTableLedCons_" + strNextNumber + ".pdf";
        ...
        try
        {
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                float[] footrsBody = { 10, 10, 10, 15,  15, 10, 10, 10, 10 };
                TBCustomer.SetWidths(footrsBody);
                TBCustomer.WidthPercentage = 100;
                TBCustomer.HeaderRows = 1;//get header column in all pages
    ...
    public string LoadConvertToTableLedCons_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingTableLedCons_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingTableLedCons_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
        return strImagePath + filepath;
    }
    public DataTable GetTable_4(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string strId, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3, string strName, string individual)
    {
        ...
        try
        {
            ...
            table.Rows.Add("CUSTOMER : ", '"' + strName + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"', '"' + FORNULL + '"');
            ...
            for (int intRowBodyCount = 0; intRowBodyCount < dtCategory.Rows.Count; intRowBodyCount++)
            {
                ...
                table.Rows.Add('"' + dtCategory.Rows[intRowBodyCount]["SALES_REF"].ToString() + '"', '"' + dtCategory.Rows[intRowBodyCount]["SALES_DATE"].ToString() + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["INVOICE_AMT"].ToString(), objEntityCommon) + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["PAID_AMT"].ToString(), objEntityCommon) + '"', '"' + objBusiness.AddCommasForNumberSeperation(dtCategory.Rows[intRowBodyCount]["SALES_RETURN_AMNT"].ToString(), objEntityCommon) + '"',  '"' + strsum2 + '"', '"' + strsum3 + '"', '"' + strsum4 + '"', '"' + strsum5 + '"');
    ...
    public string LoadConvertToTableIndvl(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts)
    {
        ...
        if (Printsts == "0")
        {
            ...
            //strHtml += "<th class=\"hasinput\" style=\"text-align:left;width:5%;\">SL NO ";
            //strHtml += "</th >";
            strHtml += "<th class=\"col-md-3 td1 tr_l\" >CUSTOMER NAME ";
            strHtml += "<input class=\"tb_inp_1 tb_in tr_l\" placeholder=\"CUSTOMER NAME \"  type=\"text\">";
            strHtml += "</th >";
        ...
        else
        {
            ...
            //strHtml += "<th class=\"thT\" style=\"width:5%;text-align:left;\">SL NO";
            //strHtml += "</th >";
            strHtml += "<th class=\"thT\" style=\"width:38%;text-align:left;\">CUSTOMER NAME ";
            strHtml += "</th >";
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dtCategory1.Rows.Count; intRowBodyCount++)
        {
            ...
            DataTable dt = objBussinessAging.ReadPendingReceipts(ObjEntityRequest1);//pending receipts
            if (dt.Rows.Count > 0)
            {
                strHtml += "<span href=\"javascript:;\" class=\"pull-right spn_rc pst_dt_bx\" title=\"Pending Receipt Details\" onclick=\"return PendingReceiptsDisplay('" + Id + "');\" data-toggle=\"modal\" data-target=\"#ModalPendingReceipt\" > <i class=\"fa fa-clipboard\"></i></span>";
            }
            ...
            //strHtml += "<td class=\"tr_r\" style=\"text-align:right;\"><a  title=\"View\" onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + ObjEntityRequest.FromAgeing + "','" + -1 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + strsum1 + "</td>";
            strHtml += "<td class=\"tr_r\" style=\"text-align:right;\"><a  title=\"View\"  onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + 1 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + strsum2 + "</td>";
            strHtml += "<td class=\"tr_r\" style=\"text-align:right;\"><a  title=\"View\"  onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + (ObjEntityRequest.Split1 + 1) + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + strsum3 + "</td>";
            strHtml += "<td class=\"tr_r\" style=\"text-align:right;\"><a  title=\"View\"  onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + (ObjEntityRequest.Split2 + 1) + "','" + ObjEntityRequest.Split3 + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + strsum4 + "</td>";
            strHtml += "<td class=\"tr_r\" style=\"text-align:right;\"><a  title=\"View\"  onclick=\"return OpenReconView('" + Id + "','" + CustomerName + "','" + ObjEntityRequest.Mode + "','" + (ObjEntityRequest.Split3 + 1) + "','" + ObjEntityRequest.ToAgeing + "','" + ObjEntityRequest.Split1 + "','" + ObjEntityRequest.Split2 + "','" + ObjEntityRequest.Split3 + "');\" href=\"javascript:;\">" + strsum5 + "</td>";
            strHtml += "</tr>";
        }
        strHtml += "</tbody>";
    ...
    public string LoadConvertToTableIndvl_PDF(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        objEntityCommon.Organisation_Id = ObjEntityRequest.Organisation_id;
        string strNextNumber = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string strImageName = "Cust_AgeingTableIndvl_" + strNextNumber + ".pdf";
        ...
        try
        {
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                if (dtCategory1.Rows.Count > 0)
                {
                    ...
                    TBCustomer.AddCell(new PdfPCell(new Phrase("TOTAL", FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_LEFT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
                    TBCustomer.AddCell(new PdfPCell(new Phrase(strTotsum, FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_RIGHT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
                    //TBCustomer.AddCell(new PdfPCell(new Phrase(strsum1, FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_RIGHT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
                    TBCustomer.AddCell(new PdfPCell(new Phrase(strsum2, FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_RIGHT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
                    TBCustomer.AddCell(new PdfPCell(new Phrase(strsum3, FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_RIGHT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
                    TBCustomer.AddCell(new PdfPCell(new Phrase(strsum4, FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_RIGHT, Padding = 2, BackgroundColor = FontSmallGray, BorderColor = FontGray });
    ...
    public string LoadConvertToTableIndvl_CSV(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string Printsts, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.CUSTOMER_OUTSTNDG_AGEING_CSV);
        string strNextId = objBusiness.ReadNextNumberSequanceForUI(objEntityCommon);
        string newFilePath = Server.MapPath("/CustomFiles/FMS CSV/Customer Outstanding Ageing/Cust_AgeingTableIndvl_" + strNextId + ".csv");
        System.IO.File.WriteAllText(newFilePath, strResult);
        filepath = "Cust_AgeingTableIndvl_" + strNextId + ".csv";
        strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.CUSTOMER_OUTSTNDG_AGEING_CSV);
        return strImagePath + filepath;
    }
    public DataTable GetTable_2(DataTable dtCategory, clsEntityOutstandingAgeing ObjEntityRequest, string intdateto, string mode, string AgeingFrom, string AgeingTo, string Split1, string Split2, string Split3)
    {
        ...
        try
        {
            ...
            //Head section
            table.Rows.Add("CUSTOMER NAME", "TOTAL AMOUNT",  '"' + AgeingSec_1 + '"', '"' + AgeingSec_2 + '"', '"' + AgeingSec_3 + '"', '"' + AgeingSec_4 + '"');
            ...
            for (int intRowBodyCount = 0; intRowBodyCount < dtCategory1.Rows.Count; intRowBodyCount++)
            {
                ...
                table.Rows.Add('"' + dtCategory1.Rows[intRowBodyCount]["CSTMR_NAME"].ToString() + '"', '"' + strTotsum + '"',  '"' + strsum2 + '"', '"' + strsum3 + '"', '"' + strsum4 + '"', '"' + strsum5 + '"');
            }
    ...
    public class PDFHeader : PdfPageEventHelper
    {
        ...
        public override void OnStartPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            headtable.AddCell(new PdfPCell(new Phrase("CUSTOMER OUTSTANDING AGEING REPORT ", new Font(FontFactory.GetFont("Calibri", 9, Font.BOLD, BaseColor.BLACK)))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT });
            if (strImageLogo != "")
            {
    ...
    public static string LoadPendingReceipts(string OrgId, string CorpId, string LdgrId)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                string strRcptId = dt.Rows[intCount]["RECPT_ID"].ToString();
                int intIdLength = dt.Rows[intCount]["RECPT_ID"].ToString().Length;
                string stridLength = intIdLength.ToString("00");
                string Id = stridLength + strRcptId + strRandom;

                sbPop.Append("<tr>");
                sbPop.Append("<td class=\"tr_l\" ><a href=\"/FMS/FMS_Master/fms_Receipt_Account/fms_Receipt_Account.aspx?ViewId=" + Id + "&VId=1\" >" + dt.Rows[intCount]["RECPT_REF"].ToString() + "</a></td>");
                sbPop.Append("<td class=\"tr_c\" >" + dt.Rows[intCount]["RECPT_DATE"].ToString() + "</td>");
                sbPop.Append("<td class=\"tr_r\" >" + dt.Rows[intCount]["RECPT_LD_AMT"].ToString() + "</td>");
                sbPop.Append("</tr>");

                decTotal = decTotal + Convert.ToDecimal(dt.Rows[intCount]["RECPT_LD_AMT"].ToString());
            }

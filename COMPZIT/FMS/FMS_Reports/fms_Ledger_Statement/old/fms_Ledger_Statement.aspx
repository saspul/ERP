...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function PrintClick() {
            window.open("/FMS/Print/Common_print.htm");
            return false;
        }

        function DivDisplay(Row, LdgrId,VochrAcntId) {
            ...
            if ($("#divAsPerDtls" + Id).hasClass('collapse in') == true) {
                ...
                if (LdgrId != "") {
                    $noCon.ajax({
                        ...
                        data: '{OrgId:"' + OrgId + '" ,CorpId:"' + CorpId + '",LdgrId:"' + LdgrId + '",Row:"' + Row + '",FrmDate:"' + FrmDate + '",ToDate:"' + ToDate + '",VochrAcntId:"' + VochrAcntId + '"}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
            ...
            <div class="">
              <label class="switch">
                ...
                <div id="divReport" runat="server">
                  ...
                  <button id="print" onclick="return PrintClick();" class="print_o"><i class="fa fa-print"></i></button>
    ...
    <div class="modal fade" id="dialog_simple" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog3 mod2" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title tr_c" id="hStatementType">Cost Centre</h4>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="fms_Cost_Group_List.aspx.cs" Inherits="FMS_FMS_Master_fms_Cost_Group_fms_Cost_Group_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function OpenCancelBlock() {
            $noCon("#success-alert").html("Sorry, cancellation denied. This cost group is already selected somewhere!.");
        ...
        function OpenCancelView(StrId) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to delete this cost group?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
        ...
        function SuccessCancelation() {
            ...
            $noCon("#success-alert").html("Cost group details cancelled successfully.");
            $noCon("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        ...
        function ErrorCancelation() {
            document.getElementById("<%=ddlStatus.ClientID%>").focus();
                $noCon("#divWarning").html(" Sorry, cancellation denied. This cost group is already selected somewhere or it is a confirmed cost group!");
       ...
       <div class="content_sec2 cont_contr">
        <div class="content_area_container cont_contr">
            <div class="content_box1 cont_contr">
                ...
                <div onclick="location.href='fms_Cost_Group.aspx'" id="divAdd" class="add" runat="server">
                    <a href="fms_Cost_Group.aspx" type="button" onclick="topFunction()" id="myBtn" title="Add New">
                   ...
                   if (strId != "" && strUserID != '') {
                       ...
                       var Details = PageMethods.CancelMemoReason(strId, strCancelMust, strUserID, strCancelReason, strOrgIdID, strCorpID, function (response) {
                           ...
                           if (SucessDetails == "successcncl") {
                               ...
                               window.location = 'fms_Cost_Group_List.aspx?InsUpd=Cncl';
                           }
                           else {
                               window.location = 'fms_Cost_Group_List.aspx?InsUpd=Error';
                           }
                       });
                   }
               ...
               function CloseCancelView() {
                   ...
                   if (document.getElementById("<%=Hiddencnclsts.ClientID%>").value == "") {
                      // $('#dialog_simple').modal('hide');
                       ...
                       document.getElementById("ezok-btn").focus();
                       return false;
                   }
               }
               //END

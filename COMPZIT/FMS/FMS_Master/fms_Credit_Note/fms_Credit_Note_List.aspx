<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="fms_Credit_Note_List.aspx.cs" Inherits="FMS_FMS_Master_fms_Credit_Note_fms_Credit_Note_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function SuccessConfirmMsg() {
       
            var ret = false;
            $noCon("#success-alert").html("Credit note confirmed successfully.");
        ...
        function OpenCancelView(StrId) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to delete this credit note?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
        ...
        function OpenCancelBlock() {
            $noCon("#success-alert").html("Sorry, cancellation denied. This credit note is already selected somewhere or it is a confirmed credit note!");
            $noCon("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        }
        function DeleteByID(strmemotId, cnclRsn, reasonmust) {
            ...
            if (strmemotId != "" && usrId != '') {
                ...
                $.ajax({
                    ...
                    url: "fms_Credit_Note_List.aspx/CancelMemoReason",
        ...
        function CanclCnfMsg() {
            $noCon("#divWarning").html("This action is  denied! This credit note is already confirmed .");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
        function SuccessClose() {
            $noCon("#success-alert").html("Credit note deleted successfully.");
            $noCon("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        ...
        function Alreadycanceled() {
            $noCon("#divWarning").html("This Credit note already deleted");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
        ...
        function SuccessDeleted() {
            $noCon("#divWarning").html("This action is  denied! This credit note is already deleted .");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function CheckSaleSettlements(strPayemntId) {//EVM-0020
            ...
            $.ajax({
                ...
                async: false,
                contentType: "application/json; charset=utf-8",
                url: "fms_Credit_Note_List.aspx/CheckSaleSettlement",
        ...
        function Confirm(strPayemntId) {//EVM-0020
            ...
            if (strPayemntId != "" && strUserID != '') {
                ...
                $.ajax({
                    ...
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    url: "fms_Credit_Note_List.aspx/ConfirmReceiptDetails",
                ...
                if (e == true) {
                    if (strPayemntId != "" && strUserID != '') {
                        ...
                        $.ajax({
                            ...
                            async: false,
                            contentType: "application/json; charset=utf-8",
                            url: "fms_Credit_Note_List.aspx/ReopenReceiptDetails",
        ...
        function PrintClick(PrintMode) {
            ...
            if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                ...
                $.ajax({
                    ...
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    url: "fms_Credit_Note_List.aspx/ListPrint_PDF",
                    data: '{FINCYRID: "' + FINCYRID + '",orgID: "' + orgID + '",corptID: "' + corptID + '",DecCnt: "' + DecCnt + '",CnclSts: "' + CnclSts + '",fromDate: "' + fromDate + '",toDate: "' + toDate + '",Status: "' + Status + '",strPrintMode: "' + strPrintMode + '"}',
                    dataType: "json",
                    success: function (data) {
                        if (data.d != "") {
                            if (data.d != "") {
        ...
        function OpenPrint(StrId) {
            ...
            if (corptID != "" && corptID != null && orgID != "" && orgID != null && UsrName != null && UsrName != "" && Id != "") {
                $.ajax({
                    ...
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    url: "fms_Credit_Note_List.aspx/PrintPDF",
...
<!----alert_message_section_closed---->
    ...
    <div class="content_area_container cont_contr">
        <div class="content_box1 cont_contr">
            ...
            <div class="form-group fg5">
                <label for="email" class="fg2_la1">Credit Note Status:<span class="spn1"></span></label>
            ...
            <div class="fg5">
                ...
                <asp:Button ID="btnCnclSearch" runat="server" class="submit_ser" OnClientClick="return SearchValidate();" OnClick="btnCnclSearch_Click" />
            </div>
            ...
            <div id="divAdd" onclick="location.href='fms_Credit_Note.aspx'" class="add" runat="server">
                <a href="fms_Credit_Note.aspx" type="button" onclick="topFunction()" id="myBtn" title="Add New">

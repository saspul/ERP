...
public partial class FMS_FMS_Master_fms_Credit_Note_fms_Credit_Note : System.Web.UI.Page
{
    ...
    public class clsSaleData
    {
        ...
        public string SALES_SETTLEAMNT { get; set; }
        public string SALES_SETTLE_BALAMNT { get; set; }
    ...
    protected void bttnsave_Click(object sender, EventArgs e)
    {
        ...
        if (HiddenSaleDtls.Value != "" && HiddenSaleDtls.Value != null)
        {
            ...
            {
                if ((objclsTVData.SALEAMNT != "" || objclsTVData.SALES_SETTLEAMNT != "") && objclsTVData.SALEID != "")
                {
                    ...
                    if (objclsTVData.SALES_SETTLEAMNT != "")
                    {
                        objEntitySaleDtl.SalesRefSettleAmnt = Convert.ToDecimal(objclsTVData.SALES_SETTLEAMNT);
                    }
                    if (objclsTVData.SALES_SETTLE_BALAMNT != "")
                    {
                        objEntitySaleDtl.BeforeSalesRefAmt = Convert.ToDecimal(objclsTVData.SALES_SETTLE_BALAMNT);
                    }
                    ...
                    if (dtLDGRdTLS.Rows[intCount]["LDGR_ID"].ToString() == dtLDGRdTLS.Rows[intCountinn]["LDGR_ID"].ToString())
                    {
                        if (first == 1)
                        {
                            ...
                            if (dtLDGRdTLS.Rows[intCountinn]["SALES_ID"].ToString() != "" && dtLDGRdTLS.Rows[intCountinn]["CST_CNTR_CR_AMOUNT"].ToString() != "")
                            {
                                ...
                                {
                                    drDtl["SALES_ID"] = dtLDGRdTLS.Rows[intCountinn]["SALES_ID"].ToString() + "%" + drDtl["CST_CNTR_CR_AMOUNT"] + "%" + dtLDGRdTLS.Rows[intCountinn]["BALNC_AMT"].ToString() + "%" + dtLDGRdTLS.Rows[intCountinn]["CST_CNTR_SALES_SETTLE_AMNT"].ToString() + "%" + dtLDGRdTLS.Rows[intCountinn]["SALES_BALNC"].ToString();
                                }
                        ...
                        else
                        {
                            ...
                            if (dtLDGRdTLS.Rows[intCountinn]["SALES_ID"].ToString() != "")
                            {
                                drDtl["SALES_ID"] = drDtl["SALES_ID"] + "$" + dtLDGRdTLS.Rows[intCountinn]["SALES_ID"].ToString() + "%" + drDtl["CST_CNTR_CR_AMOUNT"] + "%" + dtLDGRdTLS.Rows[intCountinn]["BALNC_AMT"].ToString() + "%" + dtLDGRdTLS.Rows[intCountinn]["CST_CNTR_SALES_SETTLE_AMNT"].ToString() + "%" + dtLDGRdTLS.Rows[intCountinn]["SALES_BALNC"].ToString();
                            }
                        }
                    }
                }
    ...
    public static string[] LoadSalesForLedger(string intLedgerId, string intorgid, string intcorpid, string strCedtOrDbt, string strCurrencyId, string x, string strCrncyAbrv, string CreditID, string View)
    {
        ...
        if (dtSales.Rows.Count > 0)
        {
            ...
            sb.Append("</th>");
            sb.Append(" <th class=\"th_b3 tr_l\">Settlement");
            sb.Append(" </th>");
            sb.Append(" <th class=\"th_b3 tr_l\">Sales Settlement");
            sb.Append(" </th>");
            sb.Append(" </tr>");
            sb.Append(" </thead>");
            sb.Append(" <tbody>");
            ...
            {
                if (PrchsIdDup != dtSales.Rows[row1]["SALES_ID"].ToString())
                {
                    decimal decTotal = 0;
                    ...
                    string PrchsBalnc = dtSales.Rows[row1]["SALES_BALNC"].ToString();
                    ...
                    if (decTotal == 0)//EVM-0020
                    {
                        ...
                        sb.Append("</td>");
                        sb.Append("<input type=\"text\" id=\"tdCreditBalance" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" name=\"tdCreditBalance" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" style=\"display: none;\" value=\"" + decRemain + "\" />");
                    ...
                    if (decTotal == 0)
                    {
                        sb.Append("<input disabled autocomplete=\"off\"  type=\"text\" maxlength=\"10\" class=\"form-control fg2_inp2 tr_r\" onkeydown=\"return isDecimalNumber(event,'txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "')\"  onkeypress=\"return isDecimalNumber(event,'txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "')\"  onblur=\"return AmountCalculation(" + dtSales.Rows[row1]["SALES_ID"].ToString() + ");\"  id=\"txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" /></div>");
                    }
                    else
                    {
                        sb.Append("<input autocomplete=\"off\"  type=\"text\" maxlength=\"10\" class=\"form-control fg2_inp2 tr_r\" onkeydown=\"return isDecimalNumber(event,'txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "')\"  onkeypress=\"return isDecimalNumber(event,'txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "')\"  onblur=\"return AmountCalculation(" + dtSales.Rows[row1]["SALES_ID"].ToString() + ");\"  id=\"txtPurchaseRefSettleAmt" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" /></div>");
                    }
                    sb.Append("<span class=\"input-group-addon cur2 c1h flt_r\"><i class=\"fa fa-money\"></i>" + dtSales.Rows[row1]["SALES_BALNC"].ToString() + "</span>");
                    sb.Append("<input type=\"text\" id=\"tdSalesBalance" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" name=\"tdSalesBalance" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" style=\"display: none;\" value=\"" + PrchsBalnc + "\" />");
                    sb.Append("</td>");
                    ...
                    PrchsIdDup = dtSales.Rows[row1]["SALES_ID"].ToString();
                }
            }
            sb.Append("</tbody>");
            sb.Append("</table>");
    ...
    protected void ButtReopn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Request.QueryString["Id"] != null)
            {
                ...
                else if (dtLDGRdTLS.Rows[0]["CR_NOTE_REOPEN_USRID"].ToString() != "" && dtLDGRdTLS.Rows[0]["CR_NOTE_CONFIRM_STATUS"].ToString() == "0")
                {
                    Response.Redirect("fms_Credit_Note.aspx?Id=" + Request.QueryString["Id"] + "&InsUpd=alrdyreopened");

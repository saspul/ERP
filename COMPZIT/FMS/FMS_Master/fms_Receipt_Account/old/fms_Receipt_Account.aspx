...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
        ...
        $noCon(window).load(function () {
            ...
            if (EditVal != "") {
                ...
                for (var key in json) {
                    if (json.hasOwnProperty(key)) {
                        if (json[key].LDGR_ID != "") {
                            ViewListRows(json[key].RCPT_ID, json[key].RCPT_LDGR_ID, json[key].LDGR_ID, json[key].LDGR_AMT, json[key].LDGR_NAME, json[key].ROW_COUNT, json[key].PYMNT_CST_ID, json[key].COSTCNTR_ID, json[key].PYMNT_CST_AMT, json[key].PURCHS_ID, json[key].RECPT_PURCHS_REF, json[key].COST_LD, json[key].LDGR_REMARKS, json[key].OB_PAID);
                        }
                    }
                }
                var x = 0;
    ...
    <script>
        ...
        function ViewListRows(RCPT_ID, RCPT_LDGR_ID, LDGR_ID, LDGR_AMT, LDGR_NAME, ROW_COUNT, PYMNT_CST_ID, COSTCNTR_ID, PYMNT_CST_AMT, PURCHS_ID, RECPT_PURCHS_REF, COST_LD, LDGR_REMARKS, OB_PAID) {
    ...
    function calculateTotal() {
        ...
        function ddlLedOnchange(x, y) {
            ...
            if ((document.getElementById("ddlRecptLedger" + x).value != "" && document.getElementById("ddlRecptLedger" + x).value != 0) && TxtCstctrAmount != "") {
                ...
                document.getElementById("lblLdgrAmt").innerText = TxtCstctrAmount;
    ...
    <div class="modal-dialog mod2 mo3" role="document">
      ...
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h2 class="modal-title mod1 flt_l"><i class="fa fa-balance-scale"></i>Sales/Creditnote Settlement
</h2>
          </div>
            ...
            <thead class="thead1">
              <tr>
               ...
               <th class="th_b8 td1">Bill#
                ...
                <th class="th_b9 tr_l">Creditnote <span class="cur_ic"></span>
                </th>
                <th class="th_b11">Settlement Amount <span class="cur_ic"></span>
                </th>
              </tr>
        ...
        if (CreNoteid != "") {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("creNoteBalaF" + x).innerHTML = data.d;
                    document.getElementById("tdCredNoteAmnt" + x).innerHTML = data.d;
                }
            });
        }
        if (CreNoteid != "0") {

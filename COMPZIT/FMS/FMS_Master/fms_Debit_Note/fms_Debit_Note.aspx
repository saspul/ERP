   ...
   <script src="/css/New%20Plugins/libs/jquery-2.1.1.min.js"></script>
    ...
    <script>
        ...
        function ddlLedOnchange(x, CedtOrDbt, mode) {
            ...
            if (settle == "0") {
                setTimeout(function () { loadSettleAmount(x) }, 350);//evm 0044
            }
        ...
        function Alreadyreopen() {
            var ret = false;
            $noCon("#divWarning").html("Debit note already reopened.");
                        ...
                        for (var Cst = 0; Cst < splitrow.length; Cst++) {
                            ...
                            if (splitEach[0] != "") {
                                ...
                                var client = JSON.stringify({
                                    ...
                                    PURCHASE_SETTLEAMNT: "" + splitEach[3] + "",
                                    PURCHASE_SETTLE_BALAMNT: "" + splitEach[4] + "",
                                });
...
<button id="BtnPopupCstCntr" type="button" style="display:none" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalCstCntr">Open Modal</button>
    ...
    <div class="modal fade" id="myModal" tabindex="-1"  data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-2"><span class="tt_am am1_n tr_r"  id="LedgerAmtInModalPurchse"></span></div>
      </div>
      ...
      <div class="devider"></div>
                    ...
                    <button id="BttnTemp" type="button" style="display: none" class="btn btn-danger" data-dismiss="modal" onclick ="clearData();"></button><%--evm 0044 onclick added--%>

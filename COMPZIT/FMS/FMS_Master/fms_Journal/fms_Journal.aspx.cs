...
public partial class FMS_FMS_Master_fms_Journal_fms_Journal : System.Web.UI.Page
{
    ...
    public static int ExpenseAmountEnable;
        ...
        if (!IsPostBack)
        {
            ...
            clsCommonLibrary.CORP_GLOBAL[] arrEnumer = {  clsCommonLibrary.CORP_GLOBAL.GN_MNEY_DECIMAL_CNT,
                                                           ...
                                                           clsCommonLibrary.CORP_GLOBAL.FMS_SALE_PRCHS_VISBLE_STATUS,
                                                             ...
                                                             clsCommonLibrary.CORP_GLOBAL.FMS_EXPBOOK_DISPLAY_STS, //040 new
                                                              };
            ...
            if (dtCorpDetail.Rows.Count > 0)
            {
                ...
                ExpenseAmountEnable = Convert.ToInt32(dtCorpDetail.Rows[0]["FMS_EXPBOOK_DISPLAY_STS"].ToString());
            }
            ...
            if (Request.QueryString["InsUpd"] != null)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "Alreadyreopen", "Alreadyreopen();", true);
                }
        ...
        try
        {
            if (Request.QueryString["ViewId"] != null)
            {
                ...
                if (HiddenFieldJornlDataCostCentr.Value != "" && HiddenFieldJornlDataCostCentr.Value != null)
                {
                    ...
                    {
                        if ((objclsTVData.COSTCENTRAMNT != "" && objclsTVData.COSTCENTRID != "" && objclsTVData.COSTCENTRID != "-Select Cost Center-") || (objclsTVData.EXPENSEID != "0"))
                        {
                            ...
                            //040
                            if (objclsTVData.EXPENSEID != "")
                            {
                                objEntityDtl.Expense_Id = Convert.ToInt32(objclsTVData.EXPENSEID);
                                objEntityDtl.Expense_Amount = Convert.ToDecimal(objclsTVData.EXPENSEAMNT);
                                objEntityDtl.BalAmount = Convert.ToDecimal(objclsTVData.EXPENSEBALAMNT);
                            }
           ...
           //     objEntityJrnlLedgrList.Reverse();
            //    objEntityJrnlCostcentrList.Reverse();
                ...
                else if (dt.Rows[0]["JURNL_REOPEN_USRID"].ToString() != "" && dt.Rows[0]["JURNL_CNFRM_STS"].ToString() == "0")
                {
                    Response.Redirect("fms_Journal.aspx?Id=" + Request.QueryString["ViewId"] + "&InsUpd=alrdyreopened");
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (CnfrmFlg == 0)
            {
                ...
                for (int i = 0; i < dtLedgrdDebDtl.Rows.Count; i++)
                {
                    ...
                    string strCostDtl = "", strPurchaseDtl = "", strExpenseDtl = "";
                    string sale = "";
                    string purchase = "";
                    for (int j = 0; j < dtCostCntrDebDtl.Rows.Count; j++)
                    {
                        ...
                        else if (dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() != "")
                        {
                            ...
                            if (strPurchaseDtl == "")
                            {
                                strPurchaseDtl = dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() + "%" + valuestringCost + "%" + dtCostCntrDebDtl.Rows[j]["PURCHS_BAL_AMT"].ToString() + "%0%";
                            }
                            else
                            {
                                strPurchaseDtl = strPurchaseDtl + "$" + dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() + "%" + valuestringCost + "%" + dtCostCntrDebDtl.Rows[j]["PURCHS_BAL_AMT"].ToString() + "%0%";
                            }
                        }
                        else if (dtCostCntrDebDtl.Rows[j]["EXPENSE_ID"].ToString() != "")//040
                        {
                            if (strPurchaseDtl == "")
                            {
                                strPurchaseDtl = dtCostCntrDebDtl.Rows[j]["EXPENSE_ID"].ToString() + "%" + dtCostCntrDebDtl.Rows[j]["EXPENSE_AMT"].ToString() + "%" + dtCostCntrDebDtl.Rows[j]["EXPENSE_DTL_BALNC_AMT"].ToString() + "%1%";
                            }
                            else
                            {
                                strPurchaseDtl = strPurchaseDtl + "$" + dtCostCntrDebDtl.Rows[j]["EXPENSE_ID"].ToString() + "%" + dtCostCntrDebDtl.Rows[j]["EXPENSE_AMT"].ToString() + "%" + dtCostCntrDebDtl.Rows[j]["EXPENSE_DTL_BALNC_AMT"].ToString() + "%1%";
                            }
                        }
                    }
                    string PurOrsale = "";
                    ...
                    sb.Append("<td  style=\"display:none;\"><input type=\"text\" class=\"form-control\" style=\"display:none;\" id=\"tdExpenseDtls" + i + "\" name=\"tdExpenseDtls" + i + "\" value='" + strExpenseDtl + "'/></td>");
                ...
                for (int i = 0; i < dtLedgrdDebDtl.Rows.Count; i++)
                {
                    ...
                    for (int j = 0; j < dtCostCntrDebDtl.Rows.Count; j++)
                    {
                        ...
                        else if (dtCostCntrDebDtl.Rows[j]["SALES_ID"].ToString() != "")
                        {
                            if (strPurchaseDtl == "")
                            {
                                strPurchaseDtl = dtCostCntrDebDtl.Rows[j]["SALES_ID"].ToString() + "%" + valuestringCost + "%0%" + "%0%";
                            }
                            else
                            {
                                strPurchaseDtl = strPurchaseDtl + "$" + dtCostCntrDebDtl.Rows[j]["SALES_ID"].ToString() + "%" + valuestringCost + "%0%" + "%0%";
                            }
                        }
                        else if (dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() != "")
                        {
                            if (strPurchaseDtl == "")
                            {
                                strPurchaseDtl = dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() + "%" + valuestringCost + "%0%" + "%0%";
                            }
                            else
                            {
                                strPurchaseDtl = strPurchaseDtl + "$" + dtCostCntrDebDtl.Rows[j]["PURCHS_ID"].ToString() + "%" + valuestringCost + "%0%" + "%0%";
                            }
                        }
                        else if (dtCostCntrDebDtl.Rows[j]["EXPENSE_ID"].ToString() != "")//040
                        {
    ...
    public class clsCostCntrData
    {
        ...
        public string EXPENSEAMNT { get; set; }
        public string EXPENSEBALAMNT { get; set; }
    }
    ...
    protected void bttnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["FINCYRID"] != null)
            {
                objEntityLayerStock.FinancialYrId = Convert.ToInt32(Session["FINCYRID"]);
            }
            else
            {
                Response.Redirect("/Default.aspx");
            ...
            if (HiddenFieldJornlDataCostCentr.Value != "" && HiddenFieldJornlDataCostCentr.Value != null)
            {
                foreach (clsCostCntrData objclsTVData in objTVDataList6)
                {
                    if ((objclsTVData.COSTCENTRAMNT != "" && objclsTVData.COSTCENTRID != "" && objclsTVData.COSTCENTRID != "-Select Cost Center-") || (objclsTVData.EXPENSEID != "0"))
                    {
                        ...
                        objEntityDtl.TabMode = Convert.ToInt32(objclsTVData.TABMODE);//Debit(0)/Credit(1)
                        objEntityDtl.MainTabId = Convert.ToInt32(objclsTVData.MAINTABID);//RowId
                        objEntityDtl.JournalId = objEntityLayerStock.JournalId;
                        objEntityDtl.PurSaleRefNum = objclsTVData.PURSALESTS;//Purchase(Deb)/Sale(Cre)/Costcntr("")

                        if (objclsTVData.COSTCENTRID != "")
                        {
                            objEntityDtl.CostCenterId = Convert.ToInt32(objclsTVData.COSTCENTRID);//PurchaseId/SalesId/CostcntrId
                            objEntityDtl.CostCntrAmnt = Convert.ToDecimal(objclsTVData.COSTCENTRAMNT);
        ...
        try
        {
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                if (HiddenFieldJornlDataCostCentr.Value != "" && HiddenFieldJornlDataCostCentr.Value != null)
                {
                    foreach (clsCostCntrData objclsTVData in objTVDataList6)
                    {
                        if ((objclsTVData.COSTCENTRAMNT != "" && objclsTVData.COSTCENTRID != "" && objclsTVData.COSTCENTRID != "-Select Cost Center-") || (objclsTVData.EXPENSEID != ""))
                        {
                            clsEntityJournalCostCntrDtl objEntityDtl = new clsEntityJournalCostCntrDtl();
        ...
        try
        {
            if (Request.QueryString["Id"] != null)
            {
               ...
               // objEntityLayerStock.CurrencyId = Convert.ToInt32(hiddenDfltCurrencyMstrId.Value);
                ...
                for (int p = 0; p < dtLedgrdDebDtl.Rows.Count; p++)
                {

                    objEntityLayerStock.JournalId = Convert.ToInt32(dtLedgrdDebDtl.Rows[p]["LD_JURNL_ID"].ToString());

                    DataTable dtCostCntrDebDtl = objBusinessLayerStock.ReadJrnlCostCntrDtlsById(objEntityLayerStock);

                    for (int m = 0; m < dtCostCntrDebDtl.Rows.Count; m++) {



                        if (dtCostCntrDebDtl.Rows[m]["EXPENSE_ID"].ToString() != "") //040 new
                        {
                            int Expense_Id = Convert.ToInt32(dtCostCntrDebDtl.Rows[m]["EXPENSE_ID"].ToString());
                            decimal Expense_Amount = Convert.ToDecimal(dtCostCntrDebDtl.Rows[m]["EXPENSE_AMT"].ToString());
                            decimal BalAmount = Convert.ToDecimal(dtCostCntrDebDtl.Rows[m]["EXPENSE_DTL_BALNC_AMT"].ToString());


                            if (Expense_Amount >BalAmount)
                            {

                               //kik
                                Response.Redirect("fms_Journal.aspx?InsUpd=SalesAmountExceeded&Id=" + Request.QueryString["Id"].ToString());
                            }
                        }
    ...
    [WebMethod]
    public static string[] LoadSalesForLedger(string intLedgerId, string intuserid, string intorgid, string intcorpid, string mode, string x, string strCedtOrDbt, string strCurrencyId, string strViewSts, string strCrncyAbrv, string jrnlId, string LdgrId, string expenceID)
    {
        ...
        if (expenceID != "")
        {
            ObjEntityRequest.Expense_Id = Convert.ToInt32(expenceID);
        }
        ...
        if (strCedtOrDbt == "CDT")
        {
             dtExpense = objBussiness.ReadSalesExpense(ObjEntityRequest);//Expense
        }
        if (strCedtOrDbt == "CDT")
        {
            ObjEntityRequest.ConfirmSts = 0;
        ...
        if (dtSales.Rows.Count > 0)
        {
            for (int row1 = 0; row1 < dtSales.Rows.Count; row1++)
            {
                ...
                {//
                    if (row1 % 2 == 1)
                    {
                        sb.Append("<tr class=\"tr\" id=\"SelectRow" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" >");
                    }
                    else
                    {
                    ...
                    sb.Append("<td class=\"th_b2 td1\" id=\"tdSaleRef" + dtSales.Rows[row1]["SALES_ID"].ToString() + "\" style=\"\">" + dtSales.Rows[row1]["SALES_REF"].ToString() + "</td>");
                    ...
                    sb.Append("<td class=\"col-md-3 tr_r\">" + decSettleAmt + " " + strCrncyAbrv + "</td>");
        ...
        {
            //sb.Append("<table class=\"table table-bordered\"  id=\"TableAddQstn\" style=\"margin-bottom:0px;\">");
            //sb.Append("<thead class=\"thead1\" style=\"display:none\">");
            //sb.Append("<tr>");
            //sb.Append("<th class=\"th_b8 td1\">Bill#/Sales Ref#");
            //sb.Append("</th>");
            //sb.Append("<th class=\"th_b6\">Bill/Sales Date");
            //sb.Append("</th>");
            //sb.Append("<th class=\"th_b6\">Expense Ref#");
            //sb.Append("</th>");
            ...
            {
                decimal decTotal = 0;
                decimal decSettleAmt1 = 0;
                if (dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString() != "")
                {
                    decTotal = Convert.ToDecimal(dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString());
                }
                if (strViewSts == "1")
                {
                    if (dtExpense.Rows[i]["VOCHR_BFR_SETL_AMT"].ToString() != "")
                    {
                        decSettleAmt1 = Convert.ToDecimal(dtExpense.Rows[i]["VOCHR_BFR_SETL_AMT"].ToString());

                    }
                    else
                    {
                        //decSettleAmt1 = Convert.ToDecimal(dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString());
                ...
                flag++;
                if ((LdgrId == dtExpense.Rows[i]["LD_JURNL_ID"].ToString()) || (LdgrId == "") || (dtExpense.Rows[i]["LD_JURNL_ID"].ToString() == ""))
                {
                    if(i%2==1){
                    sb.Append("<tr class=\"tr1\" id=\"SelectRow1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" >");
                    }
                    else{

                         sb.Append("<tr class=\"tr\" id=\"SelectRow1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" >");
                    }
                        sb.Append("<td  id=\"tdSaleID" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "</td>");

                    //sb.Append("<td class=\"td1 tr_l\" id=\"ExpRef" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\">" + dtExpense.Rows[i]["EXPENSE_REF"].ToString() + "</td>");
                    sb.Append("<td class=\"th_b8 td1\" id=\"SaleRef" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\">" + dtExpense.Rows[i]["SALES_REF"].ToString() + "</td>");
                    //sb.Append("<td  id=\"tdDate" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["SALES_DATE"].ToString() + "</td>");

                    sb.Append("<td>" + dtExpense.Rows[i]["SALES_DATE"].ToString() + "</td>");
                    sb.Append("<td class=\"th_b2\" id=\"ExpRef" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\">" + dtExpense.Rows[i]["EXPENSE_REF"].ToString() + "</td>");

                    sb.Append("<td class=\"col-md-3 tr_r\">" + decSettleAmt1 + " " + strCrncyAbrv + " </td>");
                    sb.Append("<td class=\"tr_r\" id=\"tdAmnt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString() + "</td>");
                    sb.Append("<td  id=\"tdLedgerRow" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + x + "</td>");
                    sb.Append("<td  id=\"tdStatus" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + 1 + "</td>");

                    sb.Append("<td class=\"td1 tr_r\" id=\"tdsettlmntAmnt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString() + "</td>");

                    sb.Append("<td class=\"td1 tr_r\"  id=\" " + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\"> ");
                    sb.Append("<div class=\"input-group \"><div class=\"input-group ma_at flt_l\"><span class=\"input-group-addon cur1\">" + strCrncyAbrv + "</span><input  type=\"text\" autocomplete=\"off\" maxlength=10 class=\"form-control fg2_inp2 tr_r\" name=\"email\"  onkeydown=\"return isDecimalNumber(event,'txtPurchaseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "')\"  onkeypress=\"return isDecimalNumber(event,'txtPurchaseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "')\"  onblur=\"return AmountCalculation(" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + ");\"  id=\"txtPurchaseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" /></div>");
                    sb.Append("<span id=\"AccntBalancePrchs" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\"  class=\"input-group-addon cur2\" ></span></div>");                       
                    sb.Append("</td>");
                    sb.Append("<td style=\"display: none;\"><input type=\"text\" style=\"display: none;\" name=\"tdSettld" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" id=\"tdSettld" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" value=\"" + dtExpense.Rows[i]["CST_JURNL_ID"].ToString() + "\" /></td>");
                    SettledCnt++;
                    sb.Append("</tr>");

                    if (i == 0)
                    {
                        Groupid = dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString();
                    }
                }
            }
            sb.Append("</tbody></table>");

            if (SettledCnt == dtExpense.Rows.Count)
            {
                SettldFully = "1";
            }
        }
    ...
    public static string CheckSaleSettlement(string strSalePurchaseDtls, string strOrgIdID, string strCorpID, string strCrdtDbt)
    {
        ...
        //objEntityLayerStock.JournalId = Convert.ToInt32(strSalePurchaseDtls);
        //objEntityLayerStock.ConfirmSts = 1;
    ...
    //START EVM040
    [WebMethod]
    public static string[] LoadSalesExpense(string intLedgerId, string intuserid, string intorgid, string intcorpid, string mode, string x, string strCedtOrDbt, string strCurrencyId, string strViewSts, string strCrncyAbrv, string jrnlId, string LdgrId, string intExpnseId)
    {
        string[] result = new string[8];
        ...
        if (intExpnseId != "")
        {
            ObjEntityRequest.Expense_Id = Convert.ToInt32(intExpnseId);
        }
        ...
        DataTable dtExpense = objBussiness.ReadSalesExpense(ObjEntityRequest);
        StringBuilder sb = new StringBuilder();
        StringBuilder sbGrp = new StringBuilder();
        ...
        if (dtExpense.Rows.Count > 0)
        {
            for (int i = 0; i < dtExpense.Rows.Count; i++)
            {
                ...
                if ((LdgrId == dtExpense.Rows[i]["LD_JURNL_ID"].ToString()) || (LdgrId == "") || (dtExpense.Rows[i]["LD_JURNL_ID"].ToString() == ""))
                {
                    ...
                    sb.Append("<td  id=\"tdExpenseID" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "</td>");

                    sb.Append("<td class=\"td1 tr_l\" id=\"ExpRef" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\">" + dtExpense.Rows[i]["EXPENSE_REF"].ToString() + "</td>");
                    sb.Append("<td class=\"td1 tr_l\" id=\"SaleRef" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\">" + dtExpense.Rows[i]["SALES_REF"].ToString() + "</td>");
                    //sb.Append("<td  id=\"tdDate" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["SALES_DATE"].ToString() + "</td>");
                    sb.Append("<td>" + dtExpense.Rows[i]["SALES_DATE"].ToString() + "</td>");

                    sb.Append("<td class=\"tr_r\">" + decSettleAmt1 + " </td>");
                    sb.Append("<td class=\"tr_r\" id=\"tdAmnt1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString() + "</td>");
                    sb.Append("<td  id=\"tdLedgerRow1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + x + "</td>");
                    sb.Append("<td class=\"td1 tr_r\" id=\"tdsettlmntAmnt1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"display:none;\">" + dtExpense.Rows[i]["EXPENSE_BALANCE_AMOUNT"].ToString() + "</td>");

                    sb.Append("<td class=\"td1 tr_r\"  id=\"tdtxtAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" style=\"\"> ");
                    sb.Append("<div class=\"input-group in1\"><span class=\"input-group-addon cur1\">" + strCrncyAbrv + "</span><input  type=\"text\" autocomplete=\"off\" maxlength=10 class=\"form-control fg2_inp2 tr_r\" name=\"email\" placeholder=\"0.00\" onkeydown=\"return isDecimalNumber(event,'txtExpenseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "')\"  onkeypress=\"return isDecimalNumber(event,'txtExpenseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "')\"  onblur=\"return ExpenseCalculation(" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + ");\"  id=\"txtExpenseAmt" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" /></div>");
                    sb.Append("<span id=\"AccntBalanceExpns" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\"  class=\"input-group-addon cur2\" ></span>");                       
                    sb.Append("</td>");
                    sb.Append("<td style=\"display: none;\"><input type=\"text\" style=\"display: none;\" name=\"tdSettld1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" id=\"tdSettld1" + dtExpense.Rows[i]["EXPENSE_DTL_ID"].ToString() + "\" value=\"" + dtExpense.Rows[i]["CST_JURNL_ID"].ToString() + "\" /></td>");
                    SettledCnt++;
                    sb.Append("</tr>");

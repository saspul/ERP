...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    font-size: 10px!important;
     ...
     <script>
         ...
         function Alreadyreopen() {

             $noCon("#divWarning").html("Journal details already reopened");
        ...
        $noCon(window).load(function () {
          ...
          //  document.getElementById("<%=txtGrantTotal.ClientID%>").disabled = true;
            ...
            if (document.getElementById("<%=HiddenRowCount.ClientID%>").value != "0") {
                ...
                var RowCnt = document.getElementById("<%=HiddenRowCount.ClientID%>").value;

                $("#divLedger" + RowCnt + "> input").focus();
                $("#divLedger" + RowCnt + "> input").select();
            }
        });
    ...
    <script>
       ...
       // var EditAllPurchase = "";
        ...
        function AddNewGroup(ledgerid) {
            ...
            //040
            FrecRow += '<td  style="display: none;"><input type="text" class="form-control" style="display:none;"  id="tdExpenseDtls' + RowIndex1 + '" name="tdExpenseDtls' + RowIndex1 + '" placeholder=""/></td>'; 
            ...
            if (Purchase_ret == true && ret == true) {
                if (LedgerDuplication(x) == true) {
                    ...
                    if (document.getElementById("ddlRecptLedger" + x).value != "") {
                        ...
                        var ExpenseId = document.getElementById("<%=HiddenFieldExpenseID.ClientID%>").value;
                        ...
                        $noCon.ajax({
                           // async:false,
                            ...
                            data: '{intLedgerId:"' + LedgerId + '",intuserid:"' + userid + '",intorgid:"' + orgid + '" ,intcorpid:"' + corpid + '" ,mode:"' + mode + '",x:"' + x + '",strCedtOrDbt:"' + CedtOrDbt + '",strCurrencyId:"' + CurrencyId + '",strViewSts:"' + ViewSts + '" ,strCrncyAbrv:"' + CrncyAbrv + '",jrnlId:"' + jrnlId + '",LdgrId:"' + LdgrId + '",expenceID:"' + ExpenseId + '"}',
        ...
        function ddlLedOnchange(x, mode, CedtOrDbt) {
            ...
            if (CedtOrDbt == "CDT") {
                ...
                tabldata +="<table id='TableAddQstn' class='table table-bordered' >";
                tabldata +=" <thead  class='thead1'>";
                tabldata +=" <tr>";
                tabldata += "<th class='th_b6'>Bill#/Sales Ref# </th>";
                tabldata += "<th class='th_b6'>Bill/Sales <br>Date</th>";
                tabldata += "<th class='th_b8 td1'>Expense Ref#</th>";
                tabldata += "<th class='col-md-3 tr_r'>Bill Amount </th>";
                tabldata +="<th class='col-md-3 tr_r'>Settlement </th>" ;                               
                tabldata += " </tr>";
                tabldata +="</thead>";
                tabldata +="<tbody id='DivPopUpSales'> ";                              
                tabldata +="</tbody>";
                tabldata +="</table>";
            ...
            if (CedtOrDbt == "DBT") {
                ...
                tabldata += " <thead  class='thead1'>";
                tabldata += " <tr>";
                tabldata += "<th class='th_b6'>Purchase Ref#</th>";
                tabldata += "<th class='th_b6'>purchase Date</th>";
                //tabldata += "<th class='th_b8 td1'>Expense Ref#</th>";
                tabldata += "<th class='col-md-3 tr_r'>Amount </th>";
                tabldata += "<th class='col-md-3 tr_r'>Settlement Amount</th>";
                tabldata += " </tr>";
                tabldata += "</thead>";
                tabldata += "<tbody id='DivPopUpSales'> ";
                tabldata += "</tbody>";
            ...
            document.getElementById("tabledat").innerHTML = tabldata;
            ...
            if (Purchase_ret == true) {
                if (LedgerDuplication(x) == true) {
                    ...
                    if (document.getElementById("ddlRecptLedger" + x).value != "0") {
                        ...
                        //040
                        //var ExpenseId = document.getElementById("<%=HiddenFieldExpenseID.ClientID%>").value;//040

                        //document.getElementById("TableExp").innerHTML = "";

                        //$noCon.ajax({
                        //    type: "POST",
                        //    async: false,
                        //    url: "fms_Journal.aspx/LoadSalesExpense",
                        //    data: '{intLedgerId:"' + LedgerId + '",intuserid:"' + userid + '",intorgid:"' + orgid + '" ,intcorpid:"' + corpid + '" ,mode:"' + mode + '",x:"' + x + '",strCedtOrDbt:"' + CedtOrDbt + '",strCurrencyId:"' + CurrencyId + '",strViewSts:"' + ViewSts + '" ,strCrncyAbrv:"' + CrncyAbrv + '",jrnlId:"' + jrnlId + '",LdgrId:"' + LdgrId + '",intExpnseId:"' + ExpenseId + '"}',
                        //    contentType: "application/json; charset=utf-8",
                        //    dataType: "json",
                        //    success: function (response) {
                        ...
                        //            document.getElementById("TableExp").innerHTML = response.d[0]; //qaz TableExp
                        //            document.getElementById("btnImportSales").style.display = "";
                        //            //document.getElementById("BtnPopup").click();

                        //            var addexpenseTable = document.getElementById("TableExp");
                        //            var E_Id = 0; //040
                        ...
                        //                for (var Cst = 0; Cst < splitrow.length; Cst++) {
                        //                    var splitEach = splitrow[Cst].split("%");
                        //                    for (var i = 0; i < addexpenseTable.rows.length; i++) {
                        //                        var E_Id = (addexpenseTable.rows[i].cells[0].innerHTML);
                        ...
                        //                }
                        //                settle = 1;
                        //                loadSettleAmount(E_Id);//evm 0044
                        //            }

                        //          if (document.getElementById("<%=HiddenView.ClientID%>").value == "1") {
                        //        $("#TableExp").find("input").attr("disabled", "disabled");
                        //        document.getElementById("btnImportSales").disabled = true;
                        //    }
                        //}
                        //if (response.d[1] != "") {
            ...
            if (settle == "0") {
                setTimeout(function () { loadSettleAmount(x); }, 300);
            }
        ...
        function AmountCalculation(PurchaseId) {
            ...
            if (ret == true) {
                ...
                //    expenseAmt = document.getElementById("txtPurchaseAmt" + E_Id).value;
                //    TotalPurchaseAmnt = parseFloat(TotalPurchaseAmnt) + parseFloat(expenseAmt);
                //}
        ...
        function ButtnFillClickSales() {
            ...
            for (var i = 1; i < addRowtable.rows.length; i++) {
                ...
                if (ret == true) {
                   ...
                   // document.getElementById("<%=Hiddenamtdata.ClientID%>").value = document.getElementById("txtPurchaseAmt" + P_Id).value;
                   // document.getElementById("<%=Hiddenamtdata.ClientID%>").value += "/";
                   // document.getElementById("<%=Hiddenamtdata.ClientID%>").value += document.getElementById("ddlRecptLedger" + tdLedgerRow).value; 
                }
            ...
            //for (var i = 1; i < addexpenseTable.rows.length; i++) {
            //    var E_Id = (addexpenseTable.rows[i].cells[0].innerHTML);
            //    tdLedgerRow = document.getElementById("tdLedgerRow" + E_Id).innerHTML;
                    ...
                    if (ret == true) {
                        if (document.getElementById("tdSaleID" + P_Id).innerHTML != "" && document.getElementById("txtPurchaseAmt" + P_Id).value != "") {
                            if (document.getElementById("tdPurchaseDtls" + tdLedgerRow).value == "") {
                                document.getElementById("tdPurchaseDtls" + tdLedgerRow).value = document.getElementById("tdSaleID" + P_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + P_Id).value + "%" + document.getElementById("tdsettlmntAmnt" + P_Id).innerHTML + "%" + document.getElementById("tdStatus" + P_Id).innerHTML;
                            }
                            else {
                                document.getElementById("tdPurchaseDtls" + tdLedgerRow).value = document.getElementById("tdPurchaseDtls" + tdLedgerRow).value + "$" + document.getElementById("tdSaleID" + P_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + P_Id).value + "%" + document.getElementById("tdsettlmntAmnt" + P_Id).innerHTML + "%" + document.getElementById("tdStatus" + P_Id).innerHTML;
                            }
                        }
            ...
            //if (document.getElementById("tdExpenseID" + E_Id).innerHTML != "" && document.getElementById("txtPurchaseAmt" + E_Id).value != "") {

            //
            //    if (document.getElementById("tdExpenseDtls" + tdLedgerRow).value == "") {
            //          document.getElementById("tdExpenseDtls" + tdLedgerRow).value = document.getElementById("tdExpenseID" + E_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + E_Id).value + "%" + document.getElementById("tdsettlmntAmnt" + E_Id).innerHTML;
            // }
            //  else {
            //document.getElementById("tdExpenseDtls" + tdLedgerRow).value = document.getElementById("tdExpenseDtls" + tdLedgerRow).value + "$" + document.getElementById("tdExpenseID" + E_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + E_Id).value + "%" + document.getElementById("tdsettlmntAmnt" + E_Id).innerHTML;
            //  }
            //
            //   }
    ...
    <script>
        ...
        function DuplicateSettlementChange(P_Id, RowId) {//evm-0020
            ...
            //alert(document.getElementById("<%=Hiddenamtdata.ClientID%>").value);
        ...
        function validateTable(retchk) {
            ...
            for (var i = 0; i < tableOtherItem.rows.length; i++) {
                ...
                if (Ledgr != 0) {
                            ...
                            if (splitEach[0] != "") {
                                ...
                                if (splitEach[3] == "0") {
                                    ...
                                    var client = JSON.stringify({
                                        ...
                                        PURSALESTS: "" + varPurSts + "",
                                        SETTLMNT_AMT: "",
                                        EXPENSEID: "" + splitEach[0] + "",
                                        EXPENSEAMNT: "" + splitEach[1] + "",
                                        EXPENSEBALAMNT: "" + splitEach[2] + "",
                                    });
                    ...
                    //var DtlExpense = document.getElementById("tdExpenseDtls" + validRowID).value;

                    //if (DtlExpense != "") {
                    //    var splitrow = DtlExpense.split("$");
                    //    for (var Cst = 0; Cst < splitrow.length; Cst++) {
                    //        var splitEach = splitrow[Cst].split("%");
                    //        if (splitEach[0] != "") {
                    //            var $add = jQuery.noConflict();
        ...
        function loadSettleAmount(x) {
            ...
            ////040
            //var addexpenseTable = document.getElementById("TableExp");//040
            //var expnsAmt = 0;
            //for (var i = 0; i < addexpenseTable.rows.length; i++) {//2nd row onwards
            //    P_Id = (addexpenseTable.rows[i].cells[0].innerHTML);

            //    var SalesAmtd = 0;
            //    var rcptAmt = document.getElementById("txtExpenseAmt" + P_Id).value.replace(/,/g, "");
            //    if (rcptAmt == "") {
            //        rcptAmt = "0";
            //    }
            ...
            //if (FloatingValue != "") {
            //    expnsAmt = expnsAmt.toFixed(FloatingValue);
            //}
            //document.getElementById("lblExpenc").innerText = expnsAmt.replace(/,/g, "");

            //var expnsSettleAmt = document.getElementById("lblExpenc").innerText.replace(/\,/g, ''); //040
            /////040 end
            ...
            var ldgramt = document.getElementById("LedgerAmtInModalPurchse").innerText;
            ldgramt = ldgramt.split(" ");
            ldgramt = ldgramt[0].replace(/,/g, "");
            var totalamt = 0;
            totalamt = Number(opBalance) + Number(settleamt);//+ Number(expnsSettleAmt);
        ...
        //START EVM 040
        function ExpenseCalculation(ExpenseIdd) {

            var ret = true;

            var tdAmnt1 = document.getElementById("tdAmnt1" + ExpenseIdd).innerHTML;
            //alert(tdAmnt1);
            var tdLedgerRow = document.getElementById("tdLedgerRow1" + ExpenseIdd).innerHTML;
            tdAmnt1 = tdAmnt1.replace(/\,/g, '');
            var expenseAmt = document.getElementById("txtExpenseAmt" + ExpenseIdd).value;

            expenseAmt = expenseAmt.replace(/\,/g, '');
            if (parseFloat(expenseAmt) > parseFloat(tdAmnt1)) {
                document.getElementById("lblErrMsgCancelReason").innerHTML = "Expense total amount should be less than the payment amount";
                $("div.war").fadeIn(200).delay(500).fadeOut(400);
            }
            ...
            if (tdAmnt1 != "" && expenseAmt != "") {
                PymntExpnsDiif = parseFloat(tdAmnt1) - parseFloat(expenseAmt);
                addCommasSummry(PymntExpnsDiif);
                document.getElementById("AccntBalanceExpns" + ExpenseIdd).innerHTML = "<i  class=\"fa fa-money\"></i>  " + document.getElementById("<%=Hiddenreturnfun.ClientID%>").value;
            }
            else {
                document.getElementById("AccntBalanceExpns" + ExpenseIdd).innerHTML = "";
            }
            ...
            if (ret == true) {
                ...
                for (var i = 1; i < addRowTable.rows.length; i++) {
                    ...
                    if (document.getElementById("txtPurchaseAmt" + P_Id).value != "") {
                        Amt = document.getElementById("txtPurchaseAmt" + P_Id).value;
                    }
                    TotalAmnt = parseFloat(TotalAmnt) + parseFloat(Amt);
                    loadSettleAmount(P_Id);
                ...
                //    }
                //    TotalAmnt = parseFloat(TotalAmnt) + parseFloat(expenseAmt);
                //    //alert(expenseAmt);
                //    loadSettleAmount(E_Id);

                //}
            }
            var LedgerAmnt = 0;
            if (document.getElementById("TxtAmount_" + tdLedgerRow).value != "") {
                LedgerAmnt = document.getElementById("TxtAmount_" + tdLedgerRow).value;
            }
            else if (document.getElementById("TxtAmountCrdt" + tdLedgerRow).value != "") {
                LedgerAmnt = document.getElementById("TxtAmountCrdt" + tdLedgerRow).value;
            }

            if (parseFloat(TotalAmnt) > parseFloat(LedgerAmnt)) {
                document.getElementById("lblErrMsgCancelReason").innerHTML = "Total amount should be less than the ledger amount";
                $("div.war").fadeIn(200).delay(500).fadeOut(400);
            }
            addCommas("txtExpenseAmt" + ExpenseIdd);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:HiddenField ID="HiddenFieldExpenseID" runat="server" />
    <asp:HiddenField ID="HiddenFieldExpenseAmount" runat="server" />
    <asp:HiddenField ID="Hiddenamtdata" runat="server" />
              ...
              function updDebitColor() {
                  $('#tableGrp td:first-child').each(function () {
                    ...
                    <div class="modal fade" id="myModal" role="dialog" data-backdrop="static" tabindex="-1">
                        <div class="modal-dialog mod2 mo3">
                            <!-- Modal content-->
...
<%-- evm 040 start--%> 
    ...
    <div class="modal-body0 md_bd1 dbt_nte" id="tabledat">                                
       <%--<table id="TableAddQstn" class="table table-bordered ">
            <thead  class="thead1">
              <tr>
                <th class="th_b6">Sales Ref#</th>
                <th class="th_b6">Sales Date</th>
                <th class="th_b8 td1">Expense Ref#</th>
                <th class="col-md-3 tr_r">Amount 
                </th>
                <th class="col-md-3 tr_r">Settlement Amount
                </th>                                 
              </tr>
            </thead>
...
<%--        <table id="" class="table table-bordered ">
 ...
 <div class="modal-footer">
        ...
        <label class="fg2_la1 tt_am am1 tr_r">Ledger Amount<span class="spn1"></span>:</label></div>
            <div class="col-md-1"  style="width: auto;"><span id="LedgerAmtInModalPurchse"  class="tt_am am1_n tr_r"></span></div>
        </div>
       ...
       <%-- <div class="col-md-1"><span class="tt_am am1_n tr_r" id="LedgerAmtInModalPurchse"> </span></div>
      </div>--%>
       ...
       <div class="col-md-12">
        ...
        <div class="col-md-1" style="width: auto;"><span  id="lblSetleAmt" class="tt_am am1_n tr_r"></span></div>
      </div>

       <div class="col-md-12">
        <div class="col-md-10">
        <label class="fg2_la1 tt_am am1 tr_r">Balance<span class="spn1"></span>:</label></div>
        <div class="col-md-1" style="width: auto;"><span  id="lblBlncAmt" class="tt_am am1_n tr_r"></span></div>
      </div>
      </div>

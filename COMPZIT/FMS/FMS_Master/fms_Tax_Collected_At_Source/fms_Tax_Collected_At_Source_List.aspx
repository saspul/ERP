<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="fms_Tax_Collected_At_Source_List.aspx.cs" Inherits="FMS_FMS_Master_fms_Tax_Collected_At_Source_fms_Tax_Collected_At_Source_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:HiddenField ID="HiddenSuccessMsgType" runat="server" />
      <ol class="breadcrumb sticky1">
        ...
        <li class="active">Tax Collected at Source (TCS) </li>
    </ol>
...
<!----alert_message_section_closed---->
    <div class="content_sec2 cont_contr">
            ...
            <div class="content_box1 cont_contr">
                <h1 class="h1_con">Tax Collected at Source (TDS) LIST</h1>
                ...
                <div class="fg2">
                    ...
                    <asp:Button ID="btnSearch" runat="server" class="submit_ser"  OnClientClick="return LoadEmpList();" OnClick="btnSearch_Click" />
                </div>
                ...
                <div id="divAdd" onclick="location.href='fms_Tax_Collected_At_Source.aspx'" class="add" runat="server" style="position: fixed; height: 26.5px; right: 0.7%; display: block">
                    <a href="fms_Tax_Collected_At_Source.aspx" type="button" onclick="topFunction()" id="myBtn" title="Add New">

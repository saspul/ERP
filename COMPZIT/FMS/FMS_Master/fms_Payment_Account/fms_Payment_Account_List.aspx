    ...
    <script type="text/javascript">
        ...
        $noCon(window).load(function () {
          ...
          function SuccessConfirmed() {
              var ret = false;
              $noCon("#divWarning").html("Payment details already confirmed.");
          ...
          function AlreadyReopened() {
            var ret = false;
            $noCon("#divWarning").html("Payment details already reopened.");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
        ...
        function Alreadyissuecheck() {
            var ret = false;
            $noCon("#divWarning").html("cheque issued already.");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
...
<script>
            ...
            if (document.getElementById("cphMain_cbxCnclStatus").checked == true) {
                ...
                var otable = $NoConfi3('#datatable_fixed_column').DataTable({
                    ...
                    "fnServerParams": function (aoData) {
                        ...
                        aoData.push({ "name": "FINYRID", "value": strFinYrID });
    ...
    <script>
        ...
        function Alreadydeleted() {
            $noCon("#divWarning").html("Payment details already deleted");
            $noCon("#divWarning").fadeTo(2000, 500).slideUp(500, function () {
            });
        ...
        function SuccessNotConfirmation() {
            $noCon("#divWarning").html("Payment is already confirmed.");
            $noCon("#divWarning").fadeTo(2000, 500).slideUp(500, function () {
            });

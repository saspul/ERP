...
public class data : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        var persons = Person.GetPersons(Corpt_Id, Org_Id, CnclSts, AccountId, LedgerId, fromdt, Todt, EnableAccount, StartDate, EndDate, AcntClsDate, EnableAudit, Confirm, PurchaseStatus, CurencyId, Reccu);

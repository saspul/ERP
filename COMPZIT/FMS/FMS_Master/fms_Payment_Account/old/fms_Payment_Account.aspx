...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
                ...
                for (var key in json) {
                    if (json.hasOwnProperty(key)) {
                        if (json[key].PYMNT_LDGR_ID != "") {
                            EditListRows(json[key].PYMNT_ID, json[key].PYMNT_LDGR_ID, json[key].LDGR_ID, json[key].LDGR_AMT, json[key].LDGR_NAME, json[key].PYMNT_CST_ID, json[key].COSTCNTR_ID, json[key].PYMNT_CST_AMT, json[key].PURCHS_ID, json[key].RECPT_PURCHS_REF, json[key].COST_LD, json[key].CHK_ID, json[key].PAYMNT_LD_REMARK, json[key].OB_PAID);
                        }
                    }
                }
    ...
    <script>
        var yvalue = 0;
        function EditListRows(PYMNT_ID, PYMNT_LDGR_ID, LDGR_ID, LDGR_AMT, LDGR_NAME, PYMNT_CST_ID, COSTCNTR_ID, PYMNT_CST_AMT, PURCHS_ID, RECPT_PURCHS_REF, COST_LD, CHK_ID, PAYMNT_LD_REMARK,OB_PAID) {
            if (LDGR_ID != 0) {
                AddNewGroup(LDGR_ID);
                ...
                if (LedgerDuplication(x) == true) {
                    ...
                    if (document.getElementById("ddlRecptLedger" + x).value != "" && ldgrSts == true) {
                        ...
                        $noCon.ajax({
                            ...
                            data: '{intLedgerId:"' + LedgerId + '",intuserid:"' + userid + '",intorgid:"' + orgid + '" ,intcorpid:"' + corpid + '" ,mode:"' + mode + '",x:"' + x + '",strCrncyAbrv:"' + CrncyAbrv + '",paymentID:"' + paymentID + '",View:"' + View + '",LedgerDtlId:"' + LedgerDtlId + '"}',
                        ...
                        $noCon.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (response.d[0] != "") {
                                    ...
                                    document.getElementById("ModelHeading").innerHTML = "Purchase/Debitnote Settlement " + response.d[3];
                ...
                for (var i = j; i < addRowtable.rows.length; i++) {
                    ...
                    if ((document.getElementById("tdSaleID" + P_Id).innerHTML != "" && document.getElementById("txtPurchaseAmt" + P_Id).value != "") || (document.getElementById("DebitNoteSettle_Status" + P_Id).checked == true)) {
                        ...
                        if (document.getElementById("tdPurchaseDtls" + tdLedgerRow).value == "") {
                            ...
                            document.getElementById("tdPurchaseDtls" + tdLedgerRow).value = document.getElementById("tdSaleID" + P_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + P_Id).value + "%" + document.getElementById("tdAmnt" + P_Id).innerHTML + "%" + settleStatus + "%" + DebitNoteId + "%" + DebitNoteAmount + "%" + DebitNoteBalAmount;
                        }
                        else {
                            document.getElementById("tdPurchaseDtls" + tdLedgerRow).value = document.getElementById("tdPurchaseDtls" + tdLedgerRow).value + "$" + document.getElementById("tdSaleID" + P_Id).innerHTML + "%" + document.getElementById("txtPurchaseAmt" + P_Id).value + "%" + document.getElementById("tdAmnt" + P_Id).innerHTML + "%" + settleStatus + "%" + DebitNoteId + "%" + DebitNoteAmount + "%" + DebitNoteBalAmount;
                        }
                    }
                    ...
                    <table id="TableAddQstn" class="table table-bordered">
                        <thead class="thead1">
                            <tr>
                                ...
                                <th class="th_b8 tr_r">Amount<span class="cur_ic"><label id="lblCurrncy1"></label></span>
                                </th>
                                <th class="th_b11">Settlement Amount<span class="cur_ic"><label id="lblCurrncy2"></label></span>
                                </th>
                                <th  class="th_b6">Settlement
                                </th>
                                <th class="th_b9 tr_l">Debitnote<span class="cur_ic"><label id="lblCurrncy3"></label></span>
                                </th>
                                <th class="th_b11">Debitnote Settlement<span class="cur_ic"><label id="lblCurrncy4"></label></span>
                                </th>
                            </tr>
                        </thead>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzitFinance.master" AutoEventWireup="true" CodeFile="fms_Cheque_Template_List.aspx.cs" Inherits="FMS_FMS_Master_fms_Cheque_Template_fms_Cheque_Template_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:Button ID="btnEdit" runat="server" Text="Button" style="display:none"/>
        ...
        <div class="cont_rght">
            ...
            <div onclick="location.href='fms_Cheque_Template.aspx'" id="divAdd" class="add" runat="server" style="position: fixed; height:26.5px; right:0%;margin-top: 2%; z-index: 1;">
        </div>

        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="/Images/BigIcons/cheque.png" style="vertical-align: middle;" />
          Cheque Template
        </div >
                        
         <%--   <a href="../fms_Account_Closing/fms_Account_Closing.aspx">../fms_Account_Closing/fms_Account_Closing.aspx</a>--%>
         <div style="width: 99%; float: left;  border: 1px solid #c3c3c3;height: 50px; background:#fafafa;margin-bottom: 7px;margin-top: 2%;">
              <div class="eachform" style="width: 22%;margin: 0 0 0px;margin-top: 1%;float: left;margin-left: 3%;display:none;">  <%--emp0025--%>

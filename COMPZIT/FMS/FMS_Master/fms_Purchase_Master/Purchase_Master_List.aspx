...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <link href="/css/Autocomplete/jquery-ui.css" rel="stylesheet" />
              ...
              if (document.getElementById("cphMain_cbxCnclStatus").checked == true)
                  ...
                  if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                      $.ajax({
                          ...
                          data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",Status: "' + Status + '",PurchaseStatus: "' + PurchaseStatus + '",Suplier: "' + Suplier + '",from: "' + from + '",toDt: "' + toDt + '",CnclSts: "' + CnclSts + '",CurrencyId: "' + CurrencyId + '",startDate: "' + startDate + '",EndDate: "' + EndDate + '",SupName: "' + SupName + '",PageMaxSize: "' + PageMaxSize + '",PageNumber: "' + PageNumber + '",strCommonSearchTerm: "' + strCommonSearchTerm + '",OrderColumn: "' + OrderColumn + '",OrderMethod: "' + OrderMethod + '",strInputColumnSearch: "' + strInputColumnSearch + '"}',
                          dataType: "json",
     ...
     <script>
         ...
         var intOrderByPurchaseStatus = 0;
         //end
         ...
         function Load_dt() {
             ...
             var url = "/FMS/FMS_Master/fms_Purchase_Master/Purchase_Master_List.aspx/LoadStaticDatafordt";//path specified
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             if (document.getElementById("cphMain_ddlSupplier").value != "--SELECT CUSTOMER--") {
                 supplier = document.getElementById("<%=ddlSupplier.ClientID%>").value;
             }
             var from = document.getElementById("<%=txtFromdate.ClientID%>").value;
             var toDt = document.getElementById("<%=txtTodate.ClientID%>").value;
             var CnclSts = 0;
             ...
             var url = "/FMS/FMS_Master/fms_Purchase_Master/Purchase_Master_List.aspx/GetData";
             var objData = {};
             objData.CorpId = corptID;
             objData.OrgId = orgID;
             objData.ddlStatus = Status;
             objData.CancelStatus = CnclSts;
             objData.Supplier = supplier;
             objData.From = from;
             objData.ToDt = toDt;
             ...
             objData.PurchsStatus = PurchaseStatus;
             ...
             $.ajax({
                 ...
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
                 url: "/FMS/FMS_Master/fms_Purchase_Master/Purchase_Master_List.aspx/GetData",
                 success: function (result) {
        ...
        <div class="content_area_container cont_contr">
            <div class="content_box1 cont_contr">
                ...
                <div class="fg8">
                    ...
                    <button type="button" id="btnSearch" onclick="return LoadList();" class="submit_ser"></button>
...
<%--        <div id="divReport" class="table-responsive" runat="server" style="display:none;">
    ...
    <script>
        ...
        function AlreadyConfirmed() {
            ...
            $noCon("#divWarning").html("Purchase details confirmed already.");
            $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
        ...
        //0039
            function AlreadyCanceled() {
                $noCon("#divWarning").html("Purchase details already deleted .");
                $noCon("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
                });

  ...
  <%--  Confirmation Alerts--%>
    <script>
       ...
       function OpenSupplier() {
        ...
        function GetValueFromChildSupplier(myVal) {
            //alert(myVal);
                if (myVal != '') {
                ...
                $noCon.ajax({
                    ...
                    success: function (response) {
                        if (response.d != "0") {
                            ...
                            document.getElementById("ddlProduct_" + num).focus();
    ...
    <script>
        ...
        function FillddlTax(rowCount, Tax, RATE, TAXAMNT) {
            var Product = "";
                            ...
                            if (OptionTaxPercentage != "") {
                                if (document.getElementById("<%=HiddenTaxEnable.ClientID%>").value == "1") {
                                    ...
                                    if (TAXAMNT != null && TAXAMNT != "") {
                                        $noCon("#txtTaxAmt" + rowCount).val(TAXAMNT);
            ...
            function PurchaseValidate() {
                ...
                if (document.getElementById("<%=cbxExtngSplr.ClientID%>").checked == true) {
                    ...
                    if (document.getElementById("<%=ddlCustomerLdgr.ClientID%>").value == "--SELECT SUPPLIER --") {
                        ...
                        document.getElementById("<%=Hiddencustldgr.ClientID%>").value = document.getElementById("<%=ddlCustomerLdgr.ClientID%>").value;
                    }
            }
            else {
    ...
    <script>
        ...
        function addMoreRows() {
            ...
            function EditListRows(PURCHSE_ID, PRODUCT_ID, PRODUCTROW, SLNO, QUANTITY, RATE, DISPER, DISAMT, TAX, TAXAMT, PRICE, TAXTEXT, TAXPERCENTAGE, PRODUCT_NAME, PRDCT_CHCK, PURCHS_PRDUCT_REMARK, COSTCENTRE) {
                ...
                ProductsLoad(RowNum);
                if (TAX != "") {
                    FillddlTax(RowNum, TAX, RATE, TAXAMT);
                }
    ...
    <script>
        ...
        function DisplayCredit() {
            ...
            if (document.getElementById("<%=ddlCustomerLdgr.ClientID%>").value != "--SELECT SUPPLIER --") {
                 ...
                 var SupplierId = document.getElementById("<%=ddlCustomerLdgr.ClientID%>").value;
                 ...
                 $.ajax({
                     ...
                     async: false,
                     contentType: "application/json; charset=utf-8",
                     url: "Purchase_master.aspx/DisplayCreditDtls",
                     ...
                     success: function (data) {
                         ...
                         if (data.d != "") {
                             ...
                             document.getElementById("<%=txtcrdtPeriod.ClientID%>").value = data.d;
                          }
                          else {
                              document.getElementById("<%=txtcrdtPeriod.ClientID%>").value = "";
                          }
            ...
            <div class="form-group fg5 fg2_mr">
                ...
                <div id="SupllierAdd">
                    <div id="divddlCustomerLdgr">
                        <asp:DropDownList ID="ddlCustomerLdgr" class="form-control fg2_inp1 inp_mst custom-select grp" runat="server" onkeypress="return DisableEnter(event);" onkeydown="return  DisableEnter(event);" onchange=" DisplayCredit();"></asp:DropDownList>
                    </div>
                </div>
            ...
            <%--evm 0044--%>
             <div class="form-group fg5 fg2_mr">
              <label for="email" class="fg2_la1">Credit Period:<span class="spn1"></span></label>
                 <asp:TextBox ID="txtcrdtPeriod"  class="form-control fg2_inp1" runat="server" MaxLength="20" onchange="IncrmntConfrmCounter();" onkeydown="return isNumber(event)"></asp:TextBox>

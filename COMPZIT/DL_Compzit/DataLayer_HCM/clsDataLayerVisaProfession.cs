...
{
    public class clsDataLayerVisaProfession
    {
        ...
        //Fetch data by Id 
        public DataTable getDetailsById(int id)
        {
            ...
            using (OracleCommand cmdUpdDetail = new OracleCommand())
            {
                ...
                cmdUpdDetail.Parameters.Add("IN_VISA_ID", OracleDbType.Int32).Value = id;
        ...
        //update visa Details 
        public void Update_Visa(clsEntityLayerVisaProfession objEntityVisa)
        {
        ...
        public void Cancel_Visa(clsEntityLayerVisaProfession objEntityVisa)
        {

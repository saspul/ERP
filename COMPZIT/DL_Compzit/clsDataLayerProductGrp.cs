...
{
   public class clsDataLayerProductGrp
    {
       clsDataLayerDateAndTime objDataLayerDate = new clsDataLayerDateAndTime();
        ...
        public void AddItemGrp(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public void ItemGroupStatusChange(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public void UpdateItemGroup(clsEntityProductGrp objEntityItemGrp)
        {
            ...
            using (OracleCommand cmdUpdateItem = new OracleCommand())
            {
                ...
                cmdUpdateItem.Parameters.Add("I_TAXCHANGE", OracleDbType.Int32).Value = objEntityItemGrp.Item_Tax_Update;
        ...
        public void CancelItemGroup(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public string CheckItemGroupName(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public DataTable ReadItemGroupById(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public string CheckItemGroupCode(clsEntityProductGrp objEntityItemGrp)
        {
        ...
        public DataTable ReadProductGrpList(clsEntityProductGrp objEntityItmGrp)
        {
            ...
            cmdReadProductGrpList.Parameters.Add("C_OPTION", OracleDbType.Int32).Value = objEntityItmGrp.Status;
            cmdReadProductGrpList.Parameters.Add("C_CANCEL", OracleDbType.Int32).Value = objEntityItmGrp.Cancel_Status;
            ...
            cmdReadProductGrpList.Parameters.Add("M_COMMON_SEARCH_TERM", OracleDbType.Varchar2).Value = objEntityItmGrp.CommonSearchTerm;
            cmdReadProductGrpList.Parameters.Add("M_SEARCH_NAME", OracleDbType.Varchar2).Value = objEntityItmGrp.SearchName;
            cmdReadProductGrpList.Parameters.Add("M_ORDER_COLUMN", OracleDbType.Int32).Value = objEntityItmGrp.OrderColumn;
            cmdReadProductGrpList.Parameters.Add("M_ORDER_METHOD", OracleDbType.Int32).Value = objEntityItmGrp.OrderMethod;
            cmdReadProductGrpList.Parameters.Add("M_PAGE_MAXSIZE", OracleDbType.Int32).Value = objEntityItmGrp.PageMaxSize;
            cmdReadProductGrpList.Parameters.Add("M_PAGE_NUMBER", OracleDbType.Int32).Value = objEntityItmGrp.PageNumber;

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit.master" CodeFile="Report_For_SalesExecutive.aspx.cs" Inherits="Reports_Report_For_SalesExecutive_Report_For_SalesExecutive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" EnablePageMethods="true" runat="server">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="#">Reports</a></li>
         <li class="active">Deal Closure Report For Sales Executive</li> 
    </ol>
    ...
    <div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1>Deal Closure Report For Sales Executive</h1>
        <div class="clearfix"></div>
          ...
          <div class="search_bo1 hide_box" style="display:block;">
            <div class="form-group fg2 sa_fg4 sa_480">
              ...
              <button id="reportrange" style="background: #fff; cursor: pointer; padding: 7px 10px; border: 1px solid #ccc; width:90%;text-align: left;border-radius: 4px; height: 34px;" autofocus="">
  ...
  <i class="fa fa-print"></i>
     ...
     <script>
         function PrintClick() {
             ...
             objData.hiddenDfltCurrencyMstrId = document.getElementById("<%=hiddenDfltCurrencyMstrId.ClientID%>").value; 
             ...
             if (objData.corptID != "" && objData.corptID != null && objData.orgID != "" && objData.orgID != null) {
                     ...
                     $.ajax({
                         ...
                         url: "Report_For_SalesExecutive.aspx/PrintList",
         ...
         $(document).ready(function () {
             ...
             document.getElementById("<%=HiddenFieldProject.ClientID%>").value = document.getElementById("<%=ddlProjct.ClientID%>").value;
             ...
             document.getElementById("<%=HiddenFieldProjectT.ClientID%>").value = $("#cphMain_ddlProjct option:selected").text();
         ...
         function LoadList() {
          ...
          function Load_dt() {
              ...
              var url = "Report_For_SalesExecutive.aspx/LoadStaticDatafordt";
              $.ajax({
                  type: 'POST',
                  dataType: 'json',
                  contentType: "application/json; charset=utf-8",
         ...
         var strCorpId = '<%= Session["CORPOFFICEID"] %>';
              var url = "Report_For_SalesExecutive.aspx/GetData";
         var objData = {};

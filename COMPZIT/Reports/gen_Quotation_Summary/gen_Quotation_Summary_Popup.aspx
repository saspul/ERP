<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Quotation_Summary_Popup.aspx.cs" Inherits="Reports_gen_Quotation_Summary_gen_Quotation_Summary_Popup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script type="text/javascript">
        function QuatnSummary() {
            ...
            window.location = "gen_Quotation_Summary.aspx?fd=" + FromDate + "&td=" + ToDate + "&di=" + Division;
        }     
    </script>
</asp:Content>
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
    ...
    <div class="content_area_container cont_contr"> 
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">Quotation Summary</h1>

        <div class="top_br_container hc_at tbr_contr">
          <div class="top_br_1 pa_h1 tb_hdr">
            <div class="col-md-6 tx_100 hcm_1_2">
              <ul>
                <li><span class="fg6 li_100">Quotation Summary Between</span> <span class="fg6 li_100_1" id="lblDate"></span></li>
...
<!-------working area_closed---->
     ...
     <a href="#" type="button" class="list_b" title="Back to List" onclick="QuatnSummary();">
  ...
  <i class="fa fa-print"></i>
   ...
   <script>
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             if (FromDate != "" && ToDate != "" && DivID != "--SELECT DIVISION--") {
                 $.ajax({
                     ...
                     url: "gen_Quotation_Summary_Popup.aspx/PrintList",
     ...
     function Load_dt() {
         ...
         var url = "gen_Quotation_Summary_Popup.aspx/LoadStaticDatafordt";

         var objData = {};
         objData.status = document.getElementById("<%=hiddenStatusId.ClientID%>").value;
         $.ajax({
             type: 'POST',
     ...
     function getdata(strPageNumber) {
         ...
         var url = "gen_Quotation_Summary_Popup.aspx/GetData";
              var objData = {};

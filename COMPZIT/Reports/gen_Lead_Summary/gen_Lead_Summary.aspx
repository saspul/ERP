<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Lead_Summary.aspx.cs" Inherits="Reports_gen_Lead_Summary_gen_Lead_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
  ...
  <div class="form-group fg2 sa_480" id="divddl">
    <label for="email" class="fg2_la1">Division:<span class="spn1">*</span></label>
    <select class="form-control fg2_inp1 inp_mst" id="ddlDivisions" runat="server">
    </select>   
  </div>
  <div class="fg2">
...
<!-------working area_closed---->
  ...
  <i class="fa fa-print"></i>
             ...
             if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                 if (FromDate != "" && ToDate != "" && DivID != "--SELECT DIVISION--") {
                     ...
                     $.ajax({
                         ...
                         url: "gen_Lead_Summary.aspx/PrintList",
     ...
     function Load_dt() {
         ...
         var url = "gen_Lead_Summary.aspx/LoadStaticDatafordt";
         $.ajax({
             type: 'POST',
             dataType: 'json',
             contentType: "application/json; charset=utf-8",
     ...
     function getdata(strPageNumber) {
         ...
         var url = "gen_Lead_Summary.aspx/GetData";
             var objData = {};

...
public partial class Reports_gen_Lead_Summary_gen_Lead_Summary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["di"] != null)
            {
                ...
                hiddenDivision.Value = objEntityReports.Division_Id.ToString(); 
                try
                {
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dt.Rows.Count; intRowBodyCount++)
        {
            ...
            for (int intColumnBodyCount = 0; intColumnBodyCount < dt.Columns.Count; intColumnBodyCount++)
            {
                ...
                if (intColumnBodyCount == 1)
                {
                    ...
                    {
                        string strHref="gen_Lead_Summary_Popup.aspx?Id=" + dt.Rows[intRowBodyCount][11].ToString() ;
                        strHtml += "<td>" + 
                            " <a onclick='return getdetails(this.href);' href=\"gen_Lead_Summary_Popup.aspx?Id=" + dt.Rows[intRowBodyCount][11].ToString() +
                ...
                else if (intColumnBodyCount == 8)
                {
                    ...
                    else
                    {
                        ...
                        strHtml += "<td   >" +
                            " <a  onclick='return getdetails(this.href);' href=\"gen_Lead_Summary_Popup.aspx?Id=" + dt.Rows[intRowBodyCount][11].ToString() +
                            "&st=8&fd=" + strFromDate + "&td=" + strToDate + "&di=" + strDivId + "\">" + dt.Rows[intRowBodyCount][intColumnBodyCount].ToString() +
                            " </a> </td>";
                ...
                else if (intColumnBodyCount == 9)
                {
                    ...
                    else
                    {
                        ...
                        strHtml += "<td   >" +
                            " <a  onclick='return getdetails(this.href);' href=\"gen_Lead_Summary_Popup.aspx?Id=" + dt.Rows[intRowBodyCount][11].ToString() +
                            "&st=9&fd=" + strFromDate + "&td=" + strToDate + "&di=" + strDivId + "\">" + dt.Rows[intRowBodyCount][intColumnBodyCount].ToString() +
                            " </a> </td>";
                        tot9 += Convert.ToInt32(dt.Rows[intRowBodyCount][intColumnBodyCount].ToString());
                    }
                }
                else if (intColumnBodyCount == 10)
                {
                    ...
                    else
                    {
                        ...
                        strHtml += "<td   >" +
                            " <a  onclick='return getdetails(this.href);' href=\"gen_Lead_Summary_Popup.aspx?Id=" + dt.Rows[intRowBodyCount][11].ToString() +
                            "&st=10&fd=" + strFromDate + "&td=" + strToDate + "&di=" + strDivId + "\">" + dt.Rows[intRowBodyCount][intColumnBodyCount].ToString() +
                            " </a> </td>";
                        tot10 += Convert.ToInt32(dt.Rows[intRowBodyCount][intColumnBodyCount].ToString());
                    }
                }               
            ...
            strHtml += "</tr>";
              ...
              strHtml += "<tr style=\"background-color:#eceff1!important;\">";
               strHtml += "<td colspan=\"1\" class=\" txt_rd bg1 tr_l\" style=\"background-color:#eceff1!important;\">Total</th>";
               strHtml += "<td class=\" txt_rd bg1\">"+tot1+"</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot2 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot3 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot4 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot5 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot6 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot7 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot8 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot9 + "</td>";
               strHtml += "<td class=\" txt_rd bg1\">" + tot10 + "</td>";
               strHtml += "</tr>";
        }
        else
        {
            strHtml += "<td class=\"tr_c\" colspan=\"11\">No data available in table</td>";
        }
        strReturn[0] = strHtml;
    ...
    public static string[] GetData(string OrgId, string CorpId, string PageNumber, string PageMaxSize, string strCommonSearchTerm, string OrderColumn, string OrderMethod, string strInputColumnSearch, string FromDate, string ToDate, string DivID)
    {
        ...
        dt = objBusinessLayerReports.Read_Lead_Summary(objEntityReport);
    ...
    public static string[] LoadStaticDatafordt()//Filters
    {
        ...
        foreach (var item in values)
        {
            ...
            {
                sbSearchInputColumns.Append("<th id=\"tdColumnHead_1\" onclick=\"SetOrderByValue(1)\" class=\"sorting th_b2 tr_l\" style=\"word-wrap:break-word;width: 12% !important;\">EMPLOYEE<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i><br><input autocomplete=\"off\" id=\"txtSearchColumn_" + Convert.ToInt32(item) + "\"  onkeypress=\"return isTagEnter(event);\" onkeydown=\"return isTagEnter(event);\" onkeyup=\"return SettypingTimer(event);\" class=\"tb_inp_1 tb_in\" type=\"text\" title=\"EMPLOYEE\" placeholder=\"Employee\"></th>");
            }
        }
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_2\"  onclick=\"SetOrderByValue(2)\" class=\"sorting th_b5\" style=\"word-wrap:break-word;\">New<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_3\"  onclick=\"SetOrderByValue(3)\" class=\"sorting th_b5\" style=\"word-wrap:break-word;\">Open<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_4\"  onclick=\"SetOrderByValue(4)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Quotation</br><span style=\"margin-left:8px;\"> Prepared</span><i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_5\"  onclick=\"SetOrderByValue(5)\" class=\"sorting th_b6\" style=\"word-wrap:break-word;width: 8% !important;\">Quotation</br> Approval Pending<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_6\"  onclick=\"SetOrderByValue(6)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Quotation</br> <span style=\"margin-left:8px;\">Returned</span><i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_7\"  onclick=\"SetOrderByValue(7)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Quotation</br> <span style=\"margin-left:8px;\">Approved</span><i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_8\"  onclick=\"SetOrderByValue(8)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Quotation</br> <span style=\"margin-left:8px;\">Reopened</span><i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_9\"  onclick=\"SetOrderByValue(9)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Quotation</br> <span style=\"margin-left:8px;\">Delivered</span><i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_10\"  onclick=\"SetOrderByValue(10)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Success<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
        sbSearchInputColumns.Append("<th id=\"tdColumnHead_11\"  onclick=\"SetOrderByValue(11)\" class=\"sorting th_b1\" style=\"word-wrap:break-word;\">Loss<i class=\"fa fa-sort pull-right hed_fa\" aria-hidden=\"true\"></i></th>");
    ...
    public static string PrintList(string orgID, string corptID, string FromDate, string ToDate, string DivID,string divText)
    {
        ...
        dtUser = objBusinessLayerReports.Read_Lead_Summary(objEntityReport);
        ...
        try
        {
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                //adding table to pdf
                PdfPTable TBCustomer = new PdfPTable(11);
                float[] footrsBody = { 13, 6, 6, 10, 10, 10, 10, 10, 10,9,6 };
                ...
                TBCustomer.AddCell(new PdfPCell(new Phrase("LOSS", FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.WHITE))) { HorizontalAlignment = Element.ALIGN_CENTER, Padding = 2, BorderColor = FontGray, BackgroundColor = FontColour });
                ...
                if (dtUser.Rows.Count > 0)
                {
                    ...
                    for (int intRowBodyCount = 0; intRowBodyCount < dtUser.Rows.Count; intRowBodyCount++)
                    {
                        ...
                        tot9 += Convert.ToInt32(dtUser.Rows[intRowBodyCount][9].ToString());
                        tot10 += Convert.ToInt32(dtUser.Rows[intRowBodyCount][10].ToString());
                        ...
                        TBCustomer.AddCell(new PdfPCell(new Phrase(dtUser.Rows[intRowBodyCount][9].ToString(), FontFactory.GetFont("Calibri", 8, Font.NORMAL, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_CENTER, Padding = 2, BackgroundColor = iTextSharp.text.BaseColor.WHITE, BorderColor = FontGray });
                        TBCustomer.AddCell(new PdfPCell(new Phrase(dtUser.Rows[intRowBodyCount][10].ToString(), FontFactory.GetFont("Calibri", 8, Font.NORMAL, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_CENTER, Padding = 2, BackgroundColor = iTextSharp.text.BaseColor.WHITE, BorderColor = FontGray });
                    }
                    ...
                    TBCustomer.AddCell(new PdfPCell(new Phrase(tot9.ToString(), FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_CENTER, Padding = 2, BorderColor = FontGray, BackgroundColor = iTextSharp.text.BaseColor.WHITE });
                    TBCustomer.AddCell(new PdfPCell(new Phrase(tot10.ToString(), FontFactory.GetFont("Calibri", 8, Font.BOLD, BaseColor.BLACK))) { HorizontalAlignment = Element.ALIGN_CENTER, Padding = 2, BorderColor = FontGray, BackgroundColor = iTextSharp.text.BaseColor.WHITE });
                }
                else
                {

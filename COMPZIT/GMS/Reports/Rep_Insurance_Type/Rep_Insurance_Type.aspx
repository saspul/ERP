<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="Rep_Insurance_Type.aspx.cs" Inherits="GMS_Reports_Rep_Insurance_Type_Rep_Insurance_Type" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function SearchValidation() {
            ...
            var ddlInsurance = document.getElementById("<%=ddlInsuranceType.ClientID%>").value;
            document.getElementById("<%=ddlInsuranceType.ClientID%>").style.borderColor = "";
            if (ddlInsurance == "" || ddlInsurance == "--SELECT INSURANCE TYPE--")
            {
                document.getElementById("<%=ddlInsuranceType.ClientID%>").style.borderColor = "Red";
                $noconflic("#divddlInsuranceType input.ui-autocomplete-input").css("borderColor", "red");
               
                
                document.getElementById("<%=ddlInsuranceType.ClientID%>").focus();
            ...
            if (ret == true)
            {
                ...
                document.getElementById("<%=HiddenSearchField.ClientID%>").value = ddlDivision + ',' + ddlInsurance;
            }
    ...
    <script>
        function addCommas(amnt) {
          ...
          function projectLoad() {
              $au(function () {
                $au('#cphMain_ddlInsuranceType').selectToAutocomplete1Letter();
                ...
                <asp:UpdatePanel ID="UpdatePanel1" EnableViewState="true" UpdateMode="Conditional" runat="server">
                    ...
                    <ContentTemplate>
                        ...
                        <div id="divDivision " class="eachform" style="width: 40%; float: Left; margin-top: .5%;">
                            ...
                            <asp:DropDownList ID="ddlDivision" TabIndex="2" class="form1" AutoPostBack="false" Style="float: right; width: 55.2% !important; margin-right: 14%; margin-top: 1%;" runat="server">
                            </asp:DropDownList>
                        </div>



                        <div id="DivProject" class="eachform" style="width: 43.5%; margin-top: 1%;">

                            <h2 style="margin-top: 1%; width: 23%; margin-left: 8%;">Insurance Type *</h2>
                            <div id ="divddlInsuranceType">
                            <asp:DropDownList ID="ddlInsuranceType" Height="30px" TabIndex="4" Width="160px" class="form1" runat="server" Style="height: 30px; width: 160px; height: 30px; width: 55.2%; float: left; margin-left: 7%;">
                            </asp:DropDownList>
                            <style>
                                .ui-autocomplete {
                                    padding: 0;

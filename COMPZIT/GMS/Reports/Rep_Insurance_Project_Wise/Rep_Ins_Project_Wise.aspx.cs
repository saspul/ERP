...
public partial class GMS_Reports_Project_Wise_report_Project_Wise_report : System.Web.UI.Page
{
   clsBusinessLayerInsReports ObjBussinessReports = new clsBusinessLayerInsReports();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            divTitle.InnerHtml = "Project Wise Insurance Report";
            ...
            else if (Session["USERID"] == null)
            {
                ...
                if (Request.QueryString["Srch"] != null && Request.QueryString["Srch"] != "")
                {
                    ...
                    string strProjt = strSearchFields[1];
                    ...
                    if (strProjt != null && strProjt != "")
                    {
                        if (ddlProjct.Items.FindByValue(strProjt) != null)
                        {
                            if (ddlProjct.SelectedItem.Value != "--SELECT PROJECT--")
                            {
                                ddlProjct.ClearSelection();
                                ddlProjct.Items.FindByValue(strProjt).Selected = true;
                                ObjEntityReports.ProjctId = Convert.ToInt32(strProjt);
                            }
                        }
                    }
                ...
                dtInsurance = ObjBussinessReports.Read_Insurance_Project_Wise(ObjEntityReports);
    ...
    public void projectLoad()
    {
        ...
        DataTable dtProject = ObjBussinessReports.ReadProject(ObjEntityReports);
    ...
    public string ConvertDataTableToHTML(DataTable dt)
    {
        ...
        if ((ddlDivision.SelectedItem.Text != "--SELECT DIVISION--") ||  (ddlProjct.SelectedItem.Text != "--SELECT PROJECT--"))
        {
        ...
        protected void ddlDivision_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ObjEntityReports.Division_Id = Int32.Parse(ddlDivision.SelectedValue);
        ...
        ddlProjct.Items.Insert(0, "--SELECT PROJECT--");
        ScriptManager.RegisterStartupScript(this, GetType(), "projectLoad", "projectLoad();", true);
        ...
        public DataTable GetTable()
        {
           clsBusinessLayerInsReports objBusinessLayerReports = new clsBusinessLayerInsReports();
            ...
            dt = ObjBussinessReports.Read_Insurance_Project_Wise(ObjEntityReports);
        ...
        protected void BtnCSV_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                objEntityCommon.SectionId = Convert.ToInt32(clsCommonLibrary.Section.INSURANCE_PROJECT_WISE_CSV);
                string strNextId = objBusiness.ReadNextNumberWebForUI(objEntityCommon);
                strImagePath = objCommon.GetImagePath(CL_Compzit.clsCommonLibrary.IMAGE_SECTION.PROJECT_WISE_INSURANCE_CSV);
                string newFilePath = Server.MapPath(strImagePath+"/Project_Wise_Insurance_Report_" + strNextId + ".csv");
                System.IO.File.WriteAllText(newFilePath, strResult);
                filepath = "Project_Wise_Insurance_Report_" + strNextId + ".csv";

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="Rep_Ins_Expiry_Range.aspx.cs" Inherits="GMS_Reports_Rep_Ins_Expiry_Range_Rep_Ins_Expiry_Range" %>
    ...
    function printredirect() {
        ...
        var FloatingValue = document.getElementById("<%=hiddenDecimalCount.ClientID%>").value;
            ...
            if (document.getElementById("<%=HiddenFieldAmount.ClientID%>").value != dec) {
                     ...
                     $p('#cphMain_divPrintReportSorted table ').last().append('<td style="text-align: right;" colspan=7 >Total<td style="text-align: right;">' + document.getElementById("<%=HiddenFieldAmount.ClientID%>").value + '<td  style="text-align: left;">' + document.getElementById("<%=HiddenCurrency.ClientID%>").value + '</td></td></td>')
...
<%--    END--%>
 ...
 <asp:LinkButton ID="lnkCancel" runat="server"></asp:LinkButton>
    ...
    <div style="display:none;cursor: default; float: right; height: 25px; margin-right:1.5%;margin-top:8%;font-family:Calibri;" class="print" onclick="printredirectt()">            
    ...
    <div class="cont_rght">
        ...
        <br />
            ...
            <asp:DropDownList ID="ddlDivisionSearch" class="form1" TabIndex="1"  style="height:25px;width:52%;margin-right: 20%;" runat="server"></asp:DropDownList>
        ...
        <div class="eachform" style="width: 51%;margin-top:0%;">
                ...
                <h2 style="margin-top:1%;">Insurance Expiry</h2>
                          <%-- <asp:DropDownList ID="ddlmodeSearch" class="form1"  style="height:25px;width:52%;margin-right: 4%;display:block" onchange="Disablediv1();"  runat="server" OnSelectedIndexChanged="ddlmodeSearch_SelectedIndexChanged" AutoPostBack="true" >               
                </asp:DropDownList>--%>
             <asp:DropDownList ID="ddlmodeSearch" class="form1"  style="height:25px;width:52%;margin-right: 4%;display:block" onchange="Disablediv1();"  runat="server" >               
                </asp:DropDownList>
                <script type="text/javascript">
            ...
            <div id="divoption" class="eachform" style="width:50%;" runat="server">               
                <div id="divDateTime" runat="server" class="subform"  style="width: 99%; float: left; margin-top: 0%; visibility:hidden">
                           ...
                           <div id="datetimepickerTo" class="input-append date" style=style="font-family: Calibri; width: 98%; height: 47px; float: left; /*! margin-right: 48%; */ margin-top: 0%;"    >
                                <span style="color: rgb(144, 156, 123); font-size: 17px; font-family: Calibri; margin-left: 0%;float: left;">As on Date*</span>
            ...
            <asp:DropDownList ID="ddlCurrency" class="form1" TabIndex="2"  style="height:25px;width:99%;margin-right: -63%;margin-top: -2%;float: right;" runat="server" >

                </asp:DropDownList>
        </div>
                <div class="eachform" style="width:25%;float: right;">
                <asp:Button ID="btnSearch" style="cursor:pointer;margin-top: -0.4%;margin-right: 33%;float: right;" TabIndex="5" runat="server" class="searchlist_btn_lft" Text="Search"  OnClick="btnSearch_Click"  />
                     </div>
                 </div>
            <br style="clear: both" />
            </div>

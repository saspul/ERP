<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="gen_Contract_Category_Master.aspx.cs" Inherits="GMS_GMS_Master_gen_Contract_Category_Master_gen_Contract_Category_Master" %>
   ...
   <style>
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Duplication Error!.Contract Category Name Can’t be Duplicated.";
        }
        ...
        function ConfirmMessage() {
            if (confirmbox > 0) {
                if (confirm("Are You Sure You Want To Leave This Page?")) {
                    window.location.href = "gen_Contract_Category_Master_List.aspx";
                }
                else {
                    return false;
                }
        ...
        function AlertClearAll() {
            if (confirmbox > 0) {
                if (confirm("Are You Sure You Want Clear All Data In This Page?")) {
                    window.location.href = "gen_Contract_Category_Master.aspx";
                    return false;
                }
                else {
                    return false;
...
<div class="cont_rght">
        ...
        <div class="fillform">
            ...
            <br />
            <div class="eachform">
                <h2>Contract Category Name*</h2>
                
                <asp:TextBox ID="txtName" class="form1" runat="server"   MaxLength="100" Width="325px" Height="30px" TextMode="SingleLine" Style="resize:none; text-transform: uppercase; font-family: calibri;float: left;margin-left: 14.8%;"></asp:TextBox>
            ...
            <div class="eachform" style="margin-top: 4%;">
                <div class="subform" style="width: 80%;">
                    ...
                    <asp:Button ID="btnCancel" runat="server" class="cancel" Text="Cancel" PostBackUrl="gen_Contract_Category_Master_List.aspx"  />

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="gen_Job_Category_Master_List.aspx.cs" Inherits="GMS_GMS_Master_gen_Job_Category_Master_gen_Job_Category_Master_List" %>
        ...
        function ChangeStatus(CatId, CatStatus) {
            if (confirm("Do You Want To Change The Status Of This Entry?")) {
                ...
                var Details = PageMethods.ChangeCategoryStatus(CatId, CatStatus, function (response) {
                    ...
                    if (SucessDetails == "success") {
                        if (SearchString == "") {
                            window.location = 'gen_Job_Category_Master_List.aspx?InsUpd=StsCh';
                        }
                        else {
                            window.location = 'gen_Job_Category_Master_List.aspx?InsUpd=StsCh&Srch=' + SearchString + '';
                        }


                    }
                    else {
                        window.location = 'gen_Job_Category_Master_List.aspx?InsUpd=Error';
                    }
                });
            }
            else {
         ...
         <script>
             function DuplicationName() {
                 ...
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recalling Denied!.Job Category Name Can’t be Duplicated.";
        }
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Job Category Details Inserted Successfully.";
             ...
             function SuccessCancelation() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Job Category Cancelled Successfully.";

             }
             function SuccessRecall() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Job Category Details Recalled Successfully.";
             }
             function SuccessStatusChange() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Job Category Status Changed Successfully.";
             }
 ...
 <br />
    ...
    <div class="cont_rght" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Job_Category_Master.png" style="vertical-align: middle;" /> Job Category
        </div>
           <%--0006 start--%>
        ...
        <div onclick="location.href='gen_Job_Category_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Job Category</h3>
                    </div>

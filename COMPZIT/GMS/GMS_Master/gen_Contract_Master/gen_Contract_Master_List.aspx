<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="gen_Contract_Master_List.aspx.cs" Inherits="GMS_GMS_Master_gen_Contract_Master_gen_Contract_Master_List" %>
  ...
  <style>
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Contract Cancelled Successfully.";
        }
        function DuplicationName() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Re Calling Denied!. Contract Name Can’t be Duplicated.";
        }
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Contract Recalled Successfully.";
        }
        function SuccessStatusChange() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Contract Status Changed Successfully.";
             }
    ...
    <script>
        ...
        function ValidateCancelReason() {
         ...
         function SearchValidation() {
             ret = true;
            var ddlContractor = document.getElementById("<%=ddlContractor.ClientID%>").value;
             if (ddlContractor == '--SELECT--') {
                 ddlContractor = "";
                
            }

             var ddlContrctrType = document.getElementById("<%=ddlContrctrType.ClientID%>").value; 
             if (ddlContrctrType == '--SELECT--') {
                 ddlContrctrType = "";
            ...
            if (ret == true) {
                ...
                document.getElementById("<%=HiddenSearchField.ClientID%>").value = searchStatus + ',' + cbx + ',' + ddlContractor + ',' + ddlContrctrType;
              }
            ...
            if (confirm("Do You Want To Change The Status Of This Entry?")) {
                ...
                var Details = PageMethods.ChangeContractStatus(CatId, CatStatus, function (response) {
                    ...
                    if (SucessDetails == "success") {
                        if (SearchString == "") {
                            window.location = 'gen_Contract_Master_List.aspx?InsUpd=StsCh';
                        }
                        else {
                            window.location = 'gen_Contract_Master_List.aspx?InsUpd=StsCh&Srch=' + SearchString + '';
                        }


                    }
                    else {
                        window.location = 'gen_Contract_Master_List.aspx?InsUpd=Error';
                    }
                });
            }
            else {
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:1%;">
            ...
            <h2 style="margin-top: 0.5%;margin-left: 5%;">Contractor </h2>

            <asp:DropDownList ID="ddlContractor" class="form1" TabIndex="1"  style="height:25px;width:52%;margin-right: 4%;" runat="server"></asp:DropDownList>


        </div>
                <asp:Button ID="Button1"  runat="server" Text="MAIL"  OnClick="btnRsnMail_Click" Style="display:none;" />
            <div class="eachform" style="width: 100%; padding-left: 0.5%;padding-top:1% ;float: left;">
        ...
        <div onclick="location.href='gen_Contract_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 47%; padding-bottom: 0.7%; padding-top: 0.6%;">Contract</h3>
                    </div>

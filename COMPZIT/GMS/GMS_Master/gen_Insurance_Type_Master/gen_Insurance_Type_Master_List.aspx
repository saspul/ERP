<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage_Compzit_GMS.master" AutoEventWireup="true" CodeFile="gen_Insurance_Type_Master_List.aspx.cs" Inherits="GMS_GMS_Master_gen_Insurance_Type_Master_gen_Insurance_Type_Master_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CloseCancelView() {
         ...
         <script>
             function DuplicationName() {
                 ...
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recalling denied!. Insurance type name can’t be duplicated.";
             }
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Insurance type cancelled successfully.";

             }
             function SuccessRecall() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Insurance type details recalled successfully.";
             }
             function SuccessStatusChange() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Insurance type  status changed successfully.";
             }
             ...
             function CancelAlert(href) {
                 ...
                 if (confirm("Do you want to cancel this insurance type?")) {
                     window.location = href;
                     return false;
                 }
                 else {
             ...
             function CancelNotPossible() {
                 alert("Sorry, cancellation denied. This insurance type is already selected somewhere or it is a confirmed insurance type!");
                 return false;
 ...
 <br />
    ...
    <div class="cont_rght" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Expiry_report.png" style="vertical-align: middle;" />Insurance Type Master
        </div>
        ...
        <div onclick="location.href='gen_Insurance_Type_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Insurance Type</h3>
                    </div>

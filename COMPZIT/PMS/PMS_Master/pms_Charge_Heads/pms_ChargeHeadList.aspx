<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="pms_ChargeHeadList.aspx.cs" Inherits="PMS_PMS_Master_pms_Charge_Heads_pms_ChargeHeadList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script>
        ...
        function OpenCancelView(StrId) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this Charge head details?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
        ...
        function DeleteByID(strId, strCancelReason, strCancelMust) {
            ...
            if (strId != "" && strUserID != '') {
                var Details = PageMethods.CancelChargeHeadReason(strId, strCancelMust, strUserID, strCancelReason, strOrgIdID, strCorpID, function (response) {

                    var SucessDetails = response;
                    if (SucessDetails == "successcncl") {

                        window.location = 'pms_ChargeHeadList.aspx?InsUpd=Cncl';


                    }
                    else {
                        window.location = 'pms_ChargeHeadList.aspx?InsUpd=Error';
                    }
                });
            }
        ...
        function SuccessCancelation() {
            $("#success-alert").html("Charge head details cancelled successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
        function SuccessUpdate() {
            $("#success-alert").html("Charge head updated successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function PrintClick() {
            ...
            var orgID = '<%= Session["ORGID"] %>';
               ...
               var category = 0;
            //   alert("d");
               category = document.getElementById("cphMain_ddlCategory").value;
               var cat = document.getElementById("cphMain_ddlCategory");
               ...
               if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                   ...
                   $.ajax({
                      ...
                      url: "pms_ChargeHeadList.aspx/PrintList",
                       data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",statusid: "' + statusid + '",CnclSts: "' + CnclSts + '" ,category:"'+category+'",cattext:"'+cattext+'"}',
                       dataType: "json",
            ...
            if (document.getElementById("cphMain_cbxCnclStatus").checked == true) {
               ...
               if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                   ...
                   $.ajax({
                       ...
                       async: false,
                       contentType: "application/json; charset=utf-8",
                       url: "pms_ChargeHeadList.aspx/PrintCSV",
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <ol class="breadcrumb sticky1">
        ...
        <%--li><a href="Account_Group_List.aspx">Charge Head</a></li>--%>
        <li class="active">Charge Head</li>
    </ol>
    ...
    <div class="content_sec2 cont_contr">
        <div class="content_area_container cont_contr">
            <div class="content_box1 cont_contr">
                <h1 class="h1_con">Charge Head LIST</h1>
                <div class="form-group fg2">
                    <label for="email" class="fg2_la1">Category<span class="spn1"></span>:</label>
                    <asp:DropDownList ID="ddlCategory" Style="" class="form-control fg2_inp1 fg_chs1" runat="server" onkeypress="return DisableEnter(event)">
                    </asp:DropDownList>
    ...
    <div id="divAdd" onclick="location.href='pms_ChargeHead.aspx'" class="add" runat="server">
        <a href="pms_ChargeHead.aspx" type="button" id="myBtn" title="Add New">

...
//vehicle expiring chart


Morris.Bar({
        element: 'morris-bar-chart-5',
...
//INSURANCE EXPIRY CHART 

Morris.Bar({
        element: 'morris-bar-chart-6',
    ...
    Morris.Bar({
       ...
       // resize: true,
		xkey: 'device',
		ykeys: ['geekbench', 'geekbench', 'geekbench'],
		labels: ['Geekbench', 'Geekbench',  'Geekbench'],
		resize: true,
...
Morris.Bar({
  ...
  data: [
    { y: 'Project 8', a: 10, b: 30, c:30, d:30, f:29 },
    { y: 'Project 7', a: 100, b: 20, c:30, d:30, e:30 },
    { y: 'Project 6', a: 75,  b: 45, c:60, e:10, g:0 },
...
/*Morris.Bar({
  element: 'morris-bar-chart-10',
  data: [
    { y: 'Division 1', a: 100, b: 20, c:30,},
    { y: 'Division 2', a: 75,  b: 45, c:60,},
    { y: 'Division 3', a: 50,  b: 20, c:50,},
    { y: 'Division 4', a: 50,  b: 30, c:40, },
    { y: 'Division 5', a: 75,  b: 25, c:80, },
    { y: 'Division 6', a: 50,  b: 20, c:80,  }
  ],
  xkey: 'y',
  ykeys: ['a','b','c'],
  labels: ['Available', 'Allocated', 'ON Leave'],
  barColors: ["#1f77b4", "#2ca02d", "#ff912f","#f98722","#ff912f","#f98722","#ff912f"],
 horizontal: true,
  stacked: true,
});*/
 ...
 Morris.Bar({
        element: 'morris-bar-chart-10',
        data: [ { y: 'Division 1', a: 100, b: 20, c:30,},
    { y: 'Division 2', a: 75,  b: 45, c:60,},
    { y: 'Division 3', a: 50,  b: 20, c:50,},
    { y: 'Division 4', a: 50,  b: 30, c:40, },
    { y: 'Division 5', a: 75,  b: 25, c:80, },
    { y: 'Division 6', a: 50,  b: 20, c:80,  }],
		...
		labels: ['Available', 'Allocated',  'ON Leave'],
		resize: true,
		barColors: ["#1f77b4", "#2ca02d", "#ff912f"],
		hideHover: true,
		stacked: true,
    });

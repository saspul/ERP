...
{
   public class clsEntityLayerEmpSalary
    {
        ...
        private int intEmplyUserId = 0;
        private long  intEmpSalaryId = 0;
        ...
        private int intSalaryMode = 0;

        public int SalaryMode
        {
            get
            {
                return intSalaryMode;
            }
            set
            {
                intSalaryMode = value;
        ...
        public long EmpSalaryId
        {
            get
            {
                return intEmpSalaryId;
            }
            set
            {
                intEmpSalaryId = value;
            }
        }
        public int EmplyUserId
        {
            get
            {
                return intEmplyUserId;
            }
            set
            {
                intEmplyUserId = value;
            }
        }

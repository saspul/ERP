...
{
   public class clsEntityLayer_Account_Close
    {
        ...
        private int intYearEndStatus = 0;
        ...
        public int YearEndStatus
        {
            get
            {
                return intYearEndStatus;
            }
            set
            {
                intYearEndStatus = value;
            }
        }
        ...
        public int AccountClsId
        {
            get
            {
                return intAccountClsId;
            }
            set
            {
                intAccountClsId = value;
            }
        }

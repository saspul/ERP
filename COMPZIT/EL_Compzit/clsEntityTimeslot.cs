...
{
  public  class clsEntityTimeslot
    {
        private int intMasterId = 0;
        private string strTimeslotName = "";          
        ...
        //----------------Pageination--------------------
        //Method for storing Timeslot master id.
        public int Timeslot_Master_Id
        {
            get
            {
                return intMasterId;
        ...
        //Method for storing Timeslot Name
        public string Timeslot_Name
        {
            get
            {
                return strTimeslotName;
            }
            set
            {
                strTimeslotName = value;
            }
        }
        //Method for storing StartTime
        ...
        //Method of storing the Status of the Timeslot
        public int Timeslot_Status
        {
            get
            {
                return intStatus;
        ...
        //Method for storing Timeslot cancel reason
        public string Timeslot_Cancel_reason
        {
            get
            {

...
{
   public class clsEntity_Exit_Procedure_List
    {
       private int intExitProcedureDtlId = 0;
        private int intExitProcedure = 0;
        ...
        public int ExitProcedureDtlId
        {
            get
            {
                return intExitProcedureDtlId;
            }
            set
            {
                intExitProcedureDtlId = value;
            }
        }
        public int ExitProcedure
        {
            get
            {
                return intExitProcedure;
            }
            set
            {
                intExitProcedure = value;
            }
        }

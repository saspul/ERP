...
{
    public class clsEntityLayerDutyOff
    {
        ...
        private string strOffdutyDays = "";
         ...
         private int intupdatedteduserid = 0;
          ...
          private string strOffdutyDaystype1 = "";
          private string strOffdutyDaystype2 = "";
          private string strOffdutyDaystype3 = "";
          private string strOffdutyDaystype4 = "";
          private string strOffdutyDaystype5 = "";
          private string strOffdutyDaystype6 = "";

          private string[] a= new string[10];
          private string[] idlist = new string[10];
          private string[] detailid = new string[10];

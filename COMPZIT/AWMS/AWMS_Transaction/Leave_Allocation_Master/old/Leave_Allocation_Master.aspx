            ...
            function DutyOfChkgdateRange(LeavDateFrom, LeaveDateTo) {
                ...
                var dutyoff = 0;
                   ...
                   if (document.getElementById("<%=HiddenFieldHolidayChck.ClientID%>").value != "0") {
                         var Details = PageMethods.ReadDutyofChkDateRanges(LeavDateFrom, orgid, corpid, LeaveDateTo, function (response) {
...
<ContentTemplate> 
     ...
     <asp:HiddenField ID="hiddenCurrentDate" runat="server" />
            ...
            <div class="eachform" >
                ...
                <div class="subform" style="margin-left: 4%; float: left;margin-top: 0.5%; ">
                ...
                <div id="divBank" class="eachform"  style="width:49%">
                         ...
                         <h2>Employee*</h2>
                <asp:DropDownList ID="ddlEmploye" Height="30px" Width="50%"  class="form1" onfocus="clearselect()" onkeydown="return DisableEnter(event)" OnSelectedIndexChanged="ddlEmploye_SelectedIndexChanged" AutoPostBack="true" runat="server" Style="margin-right: 4%;">

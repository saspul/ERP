<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master"  CodeFile="flt_Water_Billing_List.aspx.cs" Inherits="AWMS_AWMS_Transaction_flt_Water_Billing_flt_Water_Billing_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Billing Details Inserted Successfully.";
        }
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Billing Cancelled Successfully.";
        }
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Billing Recalled Successfully.";
        }
        function SuccessReOpen() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Billing Re-Opened Successfully.";
        }
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="/Images/BigIcons/Water-billing.png" style="vertical-align: middle;"  />
            <a id="a_Caption" href="flt_Water_Billing_List.aspx" >Water Billing</a>
        </div>
   <%--0006 start--%>
        ...
        <div onclick="location.href='flt_Water_Billing.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

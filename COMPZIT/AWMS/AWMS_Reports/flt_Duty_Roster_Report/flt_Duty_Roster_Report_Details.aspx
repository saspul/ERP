<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="flt_Duty_Roster_Report_Details.aspx.cs" Inherits="AWMS_AWMS_Reports_flt_Duty_Roster_Report_flt_Duty_Roster_Report_Details" %>
 ...
 input[type="submit"][disabled="disabled"] {
    ...
    <script type="text/javascript">
        ...
        function ConfirmMessage() {
            ...
            var y = x.split(',');
            window.location.href = "/AWMS/AWMS_Reports/flt_Duty_Roster_Report/flt_Duty_Roster_Report.aspx?Id=" + y[0] + "&fromdate=" + y[1] + "&todate=" + y[2] + "&EmpList=" + document.getElementById("<%=HiddenFieldBackIn.ClientID%>").value;
         }
               </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div style="cursor: default; float: right; height: 25px; margin-right: 1.5%; margin-top: 3.5%; font-family: Calibri;" class="print" onclick="printredirect()">
        <a id="print_cap" target="_blank" data-title="Item Listing" href="/AWMS/AWMS_Reports/Print/28_Print.htm" style="color: rgb(83, 101, 51)">
            ...
            <span style="margin-top: 2px; float: right;">Print</span></a> </div>
   ...
   <div style="border-color: #9ba48b;background-color: #f3f3f3;width: 98.5%;margin-top:1%;">
            ...
            <div style="float: left; width: 80%;padding: 10px;margin-top: 2%;font-family:Calibri; border: 1px solid #929292;background-color: #c9c9c9;">
                ...
                <div class="eachform" style="width: 47%; float: right;">
                    ...
                    <asp:Label ID="lbldate" class="form1" runat="server"></asp:Label>
                </div>

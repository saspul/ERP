<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="gen_Water_Card_Recharge_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Water_Card_Recharge_gen_Water_Card_Recharge_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Recharge Cancelled Successfully.";
        }
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Recharge Recalled Successfully.";
        }
        function SuccessReOpen() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Recharge Re-Opened Successfully.";
        }
        ...
        function ReOpenNotPossible() {
            alert("Sorry, ReOpen Denied. This Entry is Already Selected Somewhere Or Available Balance Is low!");
            return false;
        }
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="/Images/BigIcons/Water-Card-Recharge.png" style="vertical-align: middle;"  />
            <a id="a_Caption" href="gen_Water_Card_Recharge_List.aspx" >Water Card Recharge</a>
        </div>
   <%--0006 start--%>
        <div class="eachform" style="width: 22%;margin-top: 2%;">
          ...
          <div style="width: 44%; margin-top: 2.2%; " class="eachform">
            <h2 style="margin-top: 1%;">Card Number</h2>
            <asp:HiddenField ID="hiddenSearchDataBaseField" runat="server" Value="FLT_WTRCRD_MSTR.WTRCRD_NUMBER" />
            <asp:HiddenField ID="HiddenSearchField" runat="server" />
            <asp:TextBox ID="txtProviderName" placeholder="Minimum 3 Characters for Searching" Width="250px" Height="25px" class="form1" runat="server" MaxLength="300" Style="text-transform: uppercase; margin-left: 8px;
        ...
        <div onclick="location.href='gen_Water_Card_Recharge.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Water Card Recharge</h3>
                    </div>

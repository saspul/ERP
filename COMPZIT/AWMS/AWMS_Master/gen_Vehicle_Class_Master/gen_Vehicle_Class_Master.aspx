<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="gen_Vehicle_Class_Master.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Vehicle_Class_Master_gen_Vehicle_Class_Master" %>
   ...
   <style>
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Duplication Error!.Vehicle Class Name Can’t be Duplicated.";
        ...
        function SuccessUpdation() {
           ...
           document.getElementById('cphMain_divImageContainer').style.borderColor = "";
            ...
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Some of the information you entered is not correct or missing. Please check the highlighted field below.";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaWarning.png";
        ...
        function ConfirmMessage() {
            if (confirmbox > 0) {
                if (confirm("Are You Sure You Want To Leave This Page?")) {
                    window.location.href = "gen_Vehicle_Class_Master_List.aspx";
                }
                else {
                    return false;
                }
        ...
        function AlertClearAll() {
            if (confirmbox > 0) {
                if (confirm("Are You Sure You Want Clear All Data In This Page?")) {
                    window.location.href = "gen_Vehicle_Class_Master.aspx";
                    return false;
                }
                else {
                    return false;
...
<div class="cont_rght">
        ...
        <div class="fillform">
            ...
            <br />
            <br />
            <div class="eachform" style="padding-top:2%;">
                <h2>Vehicle Category*</h2>
                
                <asp:DropDownList ID="ddlVhclCategoryType" class="form1" runat="server" Style="float:left;height:30px;width:368px;margin-left:24.4%;font-family: calibri;" onkeydown="return DisableEnter(event)" ></asp:DropDownList>
              
            </div>
            <div class="eachform">
                <h2>Vehicle Class Name*</h2>
             ...
             <div id="divImageContainer"  runat="server" style="width: 52.5%; margin-left: 42.3%;  height: 97px; border: 1px solid rgb(207, 204, 204);background-color: white; overflow:auto;">
            ...
            <div class="eachform" style="padding-top:8px;">
                <h2>Status*</h2>
                <div class="subform" style="margin-left: 34.3%;">
            ...
            <div class="eachform">
                <div class="subform" style="width: 80%;margin-left:34.8%;padding-top: 5%;">
                    ...
                    <asp:Button ID="btnCancel" runat="server" class="cancel" Text="Cancel" PostBackUrl="gen_Vehicle_Class_Master_List.aspx"  />

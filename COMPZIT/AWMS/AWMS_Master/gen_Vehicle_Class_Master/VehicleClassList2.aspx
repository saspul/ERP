<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="VehicleClassList2.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Vehicle_Class_Master_VehicleClassList2" %>
  ...
  <style>
          ...
          $noCon(function () {
              $noCon(window).scroll(function () {
                  if ($noCon(document).height() == $noCon(window).scrollTop() + $noCon(window).height()) {
                      ...
                      var EnabModi = document.getElementById("<%=hiddenEnableModify.ClientID%>").value;
                      var EnabCanc = document.getElementById("<%=hiddenEnableCancel.ClientID%>").value;
                      var EnabRecal = document.getElementById("<%=hiddenEnableRecall.ClientID%>").value;
                      var hidden = document.getElementById("<%=hiddenSearchField.ClientID%>").value;

                      $NonCon.ajax({
                          type: "POST",
                          async: false,
                          contentType: "application/json; charset=utf-8",
                          url: "VehicleClassList2.aspx/LoadTableRows",
                          data: '{OrgId:"' + OrgId + '" ,CorpId: "' + CorpId + '",Rowstart:"' + LstRow + '",intEnableModify:"' + EnabModi + '",intEnableCancel:"' + EnabCanc + '",intEnableRecallCancelled:"' + EnabRecal + '",hiddenSearchField:"' + hidden + '"}',
                          dataType: "json",
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recalling Denied!.Vehicle Class Name Can’t be Duplicated.";
        }
        function CloseCancelView() {
         ...
         <script>
             function SuccessConfirmation() {
                 ...
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Vehicle Class Details Inserted Successfully.";

             }
             function SuccessUpdation() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Vehicle Class Details Updated Successfully.";

             }
             function SuccessCancelation() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Vehicle Class Cancelled Successfully.";

             }
             function SuccessRecall() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Vehicle Class Details Recalled Successfully.";
             }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
      ...
      <asp:HiddenField ID="hiddenCancelPrimaryId" runat="server" />
       <asp:HiddenField ID="hiddenSearchField" Value="0" runat="server" />
    ...
    <div class="cont_rght" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Vehicle-Class-Master.png" style="vertical-align: middle;" /> Vehicle Class
        </div>
           <%--0006 start--%>
        ...
        <div onclick="location.href='gen_Vehicle_Class_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;">
    ...
    <table id="ReportTable" class="main_table dataTable no-footer" role="grid" aria-describedby="ReportTable_info" cellspacing="0" cellpadding="2px">
  
<%--    <thead>
        <tr class="main_table_head">
            <th class="thT" style="width:70%;text-align: left; word-wrap:break-word;">VEHICLE CLASS NAME</th>
            <th class="thT" style="width:10%;text-align:center; word-wrap:break-word;">STATUS</th>
            <th class="thT" style="width:4%; word-wrap:break-word;text-align: center;"> </th>
            <th class="thT" style="width:4%; word-wrap:break-word;text-align: center;"> </th>
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <img class="closeCancelView" style= "margin-top: 0.6%; margin-right: 0.6%;" cursor: pointer;" onclick="CloseCancelView();" src="/Images/Icons/Cancel-flat-white-color-icon.jpg"  height="15px" width="15px" />

                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Vehicle Class</h3>
                    </div>

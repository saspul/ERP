<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="gen_Water_Card_Master_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Water_Card_Master_gen_Water_Card_Master_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function DuplicationNumber() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaWarning.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recall Denied!. Water Card Number Can’t be Duplicated.";
         }
        function DuplicationCardName() {
             document.getElementById('divMessageArea').style.display = "";
             document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaWarning.png";
             document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recall Denied!. Water Card Name Can’t be Duplicated.";
            }
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Cancelled Successfully.";
        }
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Recalled Successfully.";
        }

        function SuccessRecharge() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Water Card Recharged Successfully.";
        }

        function SuccessRechargeIns() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
        ...
        function ReChargeAlert(href) {

            if (confirm("Do you want to Recharge this card?")) {
                window.location = href;
                return false;
            }
            else {
        ...
        function RechargeNotPossible() {
            alert("Sorry, Recharge Denied. This Entry is Inactive!");
            return false;
        }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="cont_rght">
            ...
            <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Water-Card-Master.png" style="vertical-align: middle;"  />   <asp:Label ID="lblEntry" runat="server">Water Card</asp:Label>
            </div>
   <%--0006 start--%>
        ...
        <div onclick="location.href='gen_Water_Card_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Water Card</h3>
                    </div>

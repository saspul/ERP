<%@  Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="gen_Holiday_Master_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Holiday_Master_gen_Holiday_Master_List" %>
    ...
    <script type="text/javascript">
        function DuplicationName() {
            ...
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaWarning.png";
              ...
              document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Duplication Error!. Holiday  Can’t be Duplicated.";
        ...
        function DuplicationCardName() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaWarning.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recall Denied!. Holiday Name Can’t be Duplicated.";
         }
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Holiday Cancelled Successfully.";
        }
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Holiday Recalled Successfully.";
        }

        function SuccessReOpen() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Holiday Re-Opened Successfully.";
        }
        function getdetails(href) {
            window.location = href;
            return false;
        }
       function ReOpenNotPossibleSelctLevAllcn()
        {
            alert("Sorry, Re-open Denied. This Entry Is Already Selected In Leave Allocation");
            return false;
        }
        ...
        {
            alert("Sorry, Cancellation Denied. Salary Already has been Processed");
            return false;
        }
        function CancelNotPossible() {
            alert("Sorry, Cancellation Denied. This Entry is Already Selected Somewhere Or It is a Confirmed Entry! Or Salary Already has been Processed");
            return false;
        }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="cont_rght">
            ...
            <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/holiday-master.png" style="vertical-align: middle;"  />   <asp:Label ID="lblEntry" runat="server">Holiday</asp:Label>
            </div>
   <%--0006 start--%>
        ...
        <div class="eachform" id="divModalYear" style="width:26%;margin-top: 2%;">
                     <h2 style="margin-bottom:0%;margin-left:21%;" >Year*</h2>
                 <asp:DropDownList ID="ddlModalYear" class="form1" runat="server" Style="height:30px;width:163px;margin-right: 0%;float: right;" ></asp:DropDownList>

                </div>

            <div class="eachform" style="width:21%; margin-bottom: 1.2%;margin-left: 2%;">               
          ...
          <div style="width: 20%; margin-top: 2.2%; " class="eachform">
        ...
        <div onclick="location.href='gen_Holiday_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;"> Holiday </h3>
                    </div>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" CodeFile="gen_Vehicle_Status_Master_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Vehicle_Status_Master_gen_Vehicle_Status_Master_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function DuplicationCardName() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recall Denied!. Vehicle Status Name Can’t be Duplicated.";
        }
        ...
        function SuccessRecall() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Vehicle Status Recalled Successfully.";
        }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="cont_rght">
            ...
            <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Vehicle-Status_master.png" style="vertical-align: middle;"  />   <asp:Label ID="lblEntry" runat="server">Vehicle Status</asp:Label>
            </div>
   <%--0006 start--%>
        ...
        <div onclick="location.href='gen_Vehicle_Status_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

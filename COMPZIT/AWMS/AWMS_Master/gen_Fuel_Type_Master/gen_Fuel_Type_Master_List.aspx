<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit.master" CodeFile="gen_Fuel_Type_Master_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Fuel_Type_Master_gen_Fuel_Type_Master_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <link href="/css/New%20css/hcm_ns.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
         ...
         function OpenCancelView(Id) {
             ...
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to cancel this fuel type?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     document.getElementById("<%=hiddenRsnid.ClientID%>").value = Id;
    ...
    <script type="text/javascript">
        ...
        function DuplicationCardName() {
            $("#danger-alert").html("Recall Denied!. Fuel Type Name Can’t be Duplicated.");
        ...
        function SuccessConfirmation() {
         ...
         function SuccessCancelation() {
             $("#success-alert").html("Fuel type cancelled successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
             return false;
        }
         function SuccessRecall() {
             $("#success-alert").html("Fuel type recalled successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
             return false;
         }
        ...
        function ReCallAlert(href) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to recall this entry?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
                    window.location = href;
        ...
        function ChangeStatus(strId, Status) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to change the status of the fuel type?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
                    if (strId != "") {
                        var Details = PageMethods.ChangeStatus(strId, Status, function (response) {
                            ...
                            if (SucessDetails == "successchng") {
                                window.location = 'gen_Fuel_Type_Master_List.aspx?InsUpd=Sts';
                            }
                        });
                    }
                    return false;
        ...
        function SuccessStatusChng() {
            $("#success-alert").html("Fuel type status changed successfully.");
        ...
        function PrintClick() {
            ...
            if (CorpId != "" && CorpId != null && OrgId != "" && OrgId != null) {
                $.ajax({
                    ...
                    url: "gen_Fuel_Type_Master_List.aspx/PrintList",
     ...
     <script>
        ...
        function Load_dt() {
            ...
            var url = "/AWMS/AWMS_Master/gen_Fuel_Type_Master/gen_Fuel_Type_Master_List.aspx/LoadStaticDatafordt";
            var objData = {};
        ...
        function getdata(strPageNumber) {
            ...
            var url = "/AWMS/AWMS_Master/gen_Fuel_Type_Master/gen_Fuel_Type_Master_List.aspx/GetData";
            var objData = {};
...
<!---inner_content_sections area_started-->
        <h1 class="h1_con">Fuel Type</h1>

        <div class="form-group fg2 sa_640_i1 sa_480">
        ...
        <div class="fg5 sa_fg4">
          <label class="form1 mar_bo mar_tp">
            <span class="button-checkbox">
              <button type="button" class="btn-d active" data-color="p" onclick="myFunct()" ng-model="all"><i class="state-icon fa fa-square-o gly2"></i>&nbsp;</button>
...
<!---add_button--->
      <div id="divAdd" onclick="location.href='gen_Fuel_Type_Master.aspx'" runat="server">
           <a href="gen_Fuel_Type_Master.aspx" type="button" id="myBtn" title="Add New">

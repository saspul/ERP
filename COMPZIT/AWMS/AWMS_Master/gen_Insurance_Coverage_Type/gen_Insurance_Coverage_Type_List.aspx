<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_AWMS.master" AutoEventWireup="true" CodeFile="gen_Insurance_Coverage_Type_List.aspx.cs" Inherits="AWMS_AWMS_Master_gen_Insurance_Coverage_Type_gen_Insurance_Coverage_Type_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recalling Denied!.Insurance Coverage Name Can’t be Duplicated.";
        }
        function CloseCancelView() {
         ...
         <script>
             ...
             function SuccessCancelation() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Insurance Coverage Details Cancelled Successfully.";

             }
             function SuccessRecall() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Insurance Coverage Details Recalled Successfully.";
             }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="cont_rght" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Coverage-Type.png" style="vertical-align: middle;" />Insurance Coverage
        </div>
           <%--0006 start--%>
        ...
        <div onclick="location.href='gen_Insurance_Coverage_Type.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Insurance Coverage Type</h3>
                    </div>

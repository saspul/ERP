<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" CodeFile="hcm_Interview_Summary_Report.aspx.cs" Inherits="HCM_HCM_Reports_hcm_Interview_Summary_Report_hcm_Interview_Summary_Report" %>
...
<asp:ScriptManager ID="ScriptManager1" EnablePageMethods="true" runat="server">
    ...
    <asp:HiddenField ID="hiddenManpwrId" runat="server" />
     ...
     <asp:Button ID="BtnCSV" style="float: right; height: 25px; margin-top:1.5%;text-align:center;display:none" runat="server" class="searchlist_btn_rght" Text="CSV"  OnClick="BtnCSV_Click"  />
       <a id="A3"  data-title="Item Listing"  style="float: right; margin-top:3%;color:rgb(83, 101, 51);font-family:Calibri;margin-right: 0.5%;width: 10%;" href="javascript:;" onclick="CallCSVBtn();">
       <img  src="../../../Images/Icons/new_CSV.PNG" title="Export to CSV" style="max-width: 20%;margin-top: 4%;margin-left: 55%;" ><span style="margin-top: 7%;float: right;margin-right: 2%;">CSV</span> </a>
        <div style="cursor: default; float: right; height: 25px; margin-right: -4.5%; margin-top: 3.5%; font-family: Calibri;" class="print" onclick="printsorted()">
     <a id="A2" target="_blank" data-title="Interview summary report" href="/HCM/HCM_Reports/Print/sort_EmpDtlsRprt.htm" style="color: rgb(83, 101, 51);margin-right:15%">
    ...
    <div style="display:none;cursor: default; float: right; height: 25px; margin-right: 1.5%; margin-top: 3.5%; font-family: Calibri;" class="print">
     <a id="print_cap" target="_blank" data-title="Interview summary report" href="/HCM/HCM_Reports/hcm_Interview_Summary_Report/Print/26_Print.htm" style="color: rgb(83, 101, 51);margin-right:15%">
       <img src="/Images/Other Images/imgPrint.png" style="max-width: 60%;margin-right:15%">
        <span style="margin-top: -28px; float: right;">Print</span></a>                                  
</div>
    ...
    <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="\Images\BigIcons\Interview Summary Report.png" style="vertical-align: middle;" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
    <div style="border:.5px solid #9ba48b; background-color: #f3f3f3;margin-top:3%;min-height:50px;padding: 7px 0px 10px 12px;">


     
        <div class="col-md-4" style="width: 33.3%;">

        <div class="eachform" style="margin-top:2.5%;margin-left:2%;width: 100%;height:37px">
         <h2 >MPR Ref# *  </h2>
        <asp:DropDownList ID="ddlDepartmnt" class="form1" runat="server" Style="height: 28px; width: 58%; float: left; margin-left: 12%;" >
           </asp:DropDownList>
        </div>
            </div>
       
                     <div class="col-md-4" style="width: 33.3%;">
           <div class="eachform" style="margin-top:2.5%;margin-left:2%;">
         <h2 style="margin-left: 7%;">Project  </h2>
        <asp:DropDownList ID="ddlProjct" class="form1" runat="server" Style="height: 28px; width: 62%; float: left; margin-left: 12%;">
           </asp:DropDownList>
        </div>
        </div>
                <div class="col-md-4">
    <asp:Button ID="btnSearch" style="cursor:pointer;float:right;margin-right:24%;margin-top: 3%;"  runat="server" class="searchlist_btn_lft" Text="Search" OnClick="btnSearch_Click"  OnClientClick="return SearchValidation()" />
</div> 

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gn_VisaType.aspx.cs" Inherits="Master_gen_VisaType_gn_VisaType" %>
<%--//emp17--%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        function AlertClearAll() {
            ...
            if (document.getElementById("<%=lblAdd.ClientID%>").innerText != "View Visa Type") {
                if (document.getElementById("<%=txtVisaName.ClientID%>").value != "") {
                    if (confirm("Are you sure you want clear all data in this page?")) {
                        window.location.href = "/HCM/HCM_Master/gen_VisaType/gn_VisaType.aspx";
                        return false;
                    }
                    else {
    ...
    <script type="text/javascript">
        ...
        function ChangeStatus(visaId,VisaStatus) {
            if (confirm("Do you want to change the status of this entry?")) {
                ...
                var Details = PageMethods.ChangeVisaStatus(visaId, VisaStatus, function (response) {                   
                     ...
                     if (SucessDetails == "success")
                     {
                         ...
                         {
                             window.location = 'gn_VisaType.aspx?InsUpd=StsCh';          
                         }
                         else
                         {
                             window.location = 'gn_VisaType.aspx?InsUpd=StsCh&Srch='+ SearchString +'';
                         }
            ...
            {
                         window.location = 'gn_VisaType.aspx?InsUpd=Error';
                     }
                 });
             }
             else {
    ...
    <script type="text/javascript">
        function SuccessInsertion() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Visa type inserted successfully.";
        }
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Visa type cancelled successfully.";
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="cont_rght">
         ...
         <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Visa-Type-Master.png" style="vertical-align: middle;"  />   <asp:Label ID="lblEntry" runat="server">Visa Type</asp:Label>
            </div>
           ...
           <asp:Label ID="lblAdd" runat="server" style="font-size: 19px; margin-left: 1%; font-weight: bold; text-decoration:underline; color: rgb(83, 101, 51); font-family: Calibri">    <%-- //emp17 tab index removed name style--%>
            Add Visa Type
             ...
             <div style="float: left; width: 98%">
                ...
                <h2 style="margin-top: 0.5%; margin-left: 57px;">Visa Name* </h2>
   ...
   <div style="float: left; width: 100%">         <%-- //emp17--%>
       <div class="eachform" style="width: 27%;margin-top: 2%;float: left;margin-left: 1%;">       <%-- //emp17--%>
           ...
           <asp:DropDownList ID="ddlStatus" Height="25px"  Width="160px" class="form1" runat="server" Style="float: left; margin-left: 27%;">
                <asp:ListItem Text="All" Value="2"></asp:ListItem> <%-- //emp17--%>

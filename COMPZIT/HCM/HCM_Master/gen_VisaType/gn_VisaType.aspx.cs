...
//
            ...
            if (Request.QueryString["Id"] != null && Request.QueryString["InsUpd"] != "upd")
            {
                ...
                dt = objBusinessVisa.getDetails_ById(objEntityVisa);
    ...
    public void View(string strP_Id)
    {
        ...
        objEntityVisa.VisaId = Convert.ToInt32(strP_Id);
        DataTable dtSponsor = objBussVisa.getDetails_ById(objEntityVisa);

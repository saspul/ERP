<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_Clearance_Form_WorkerList.aspx.cs" Inherits="HCM_HCM_Master_hcm_LeaveMaster_hcm_Clearance_Form_Worker_hcm_Clearance_Form_WorkerList" %>
    ...
    <style>
     ...
     <script>
         ...
         function SearchValidation() {
            ...
            var cbxStatus = document.getElementById("<%=cbxCnclStatus.ClientID%>");
             ...
             if (ret == true) {
                 ...
                 document.getElementById("<%=HiddenSearchField.ClientID%>").value = ddlEmployee + ',' + ddlSts + ',' + cbx;
            }
         ...
         function WorkerId(id) {
             ...
             var nWindow = window.open('/HCM/Hcm_Master/hcm_LeaveMaster/hcm_Clearance_Form_Worker/hcm_Clearance_Form_Worker.aspx?ViewId=' + id + '&RFGP=VW', 'PoP_Up', 'width=1200,height=500,left=70,top=100,directories=no,navigationbar=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,resizable=yes,scrollbars=yes');
             // nWindow.focus();
         }
    ...
    <div class="cont_rght">
        ...
        <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:1%;">
         ...
         <div style="float:left;width:100%;padding-top: 2%;" >
                    <div id="DivCGuarantee" class="eachform" style="width: 25%;">
                ...
                <div id="DivProject" class="eachform" style="width: 25%;">
                ...
                <div id="Div1" class="eachform" style="width: 25%;">
                <div class="subform" style="width:215px;float: left;margin-left: 30%;">
                 ...
                 <div class="eachform" style="width:20%;float: right;">
        ...
        <br />
        <div onclick="location.href='hcm_Clearance_Form_Worker.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

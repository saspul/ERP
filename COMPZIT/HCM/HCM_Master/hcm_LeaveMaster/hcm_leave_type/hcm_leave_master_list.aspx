<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_leave_master_list.aspx.cs" Inherits="HCM_HCM_Master_hcm_leave_type_hcm_leave_master_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function DuplicationLeavAbsnc() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Recall denied!. leave on absence already exists.";
        }
   ...
   <%--0006 start--%>
        <div class="eachform" style="width: 22%;margin-top: 2%;">
          ...
          <div style="width: 44%; margin-top: 2.2%; " class="eachform">
            <asp:Button ID="btnSearch" style="margin-top:-0.4%; cursor:pointer; width: 104px;" runat="server" class="searchlist_btn_lft" Text="Search" OnClick="btnSearch_Click" AccessKey  OnClientClick="return SearchValidation();"/>
        ...
        <div onclick="location.href='hcm_leave_master.aspx'" id="divAdd" class="add"  runat="server" style=" position: fixed; height:26.5px; right:1%;">
                ...
                <div class="modal-CancelView">
                    ...
                    <div class="modal-bodyCancelView">
                        ...
                        <asp:TextBox ID="txtCnclReason" class="form-control" MaxLength="500" Width="250px" Height="115px" TextMode="MultiLine" Style="resize:none;border: 1px solid #cfcccc;" onblur="RemoveTag(cphMain_txtCnclReason)" onkeypress="return isTag(event)" onkeydown="textCounter(cphMain_txtCnclReason,450)" onkeyup="textCounter(cphMain_txtCnclReason,450)" runat="server"></asp:TextBox>
                         <asp:Button ID="btnRsnSave" class="save" runat="server" Text="Save" OnClick="btnRsnSave_Click" OnClientClick="return ValidateCancelReason();"  style="width: 90px; float:left;margin-left:39%;margin-top: 3%;" />

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" CodeFile="gen_Job_Description_Master_List.aspx.cs" Inherits="HCM_HCM_Master_gen_Job_Description_Master_gen_Job_Description_Master_List" %>
  ...
  <style>
    ...
    <script src="../../../JavaScript/jquery-1.8.3.min.js"></script>
      ...
      <script type="text/javascript">
          ...
          function ReCallAlert(href) {
              ...
              if (confirm("Do you want to recall this job description?")) {
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Job description cancelled successfully.";
        }
         ...
         function CancelAlert(href) {
             ...
             if (confirm("Do you want to cancel this job description?")) {
                 window.location = href;
                 return false;
             }
             else {
    ...
    <script>
        ...
        function SearchValidation() {
            ...
            if (ret == true) {
                ...
                document.getElementById("<%=HiddenSearchField.ClientID%>").value = ddlDivision + ',' + ddlDep + ',' + cbx ;
             }
        ...
        function JobDescrpId(id)
        {
            ...
            var nWindow = window.open('/HCM/HCM_Master/gen_Job_Description_Master/gen_Job_Description_Master.aspx?ViewId=' + id + '&RFGP=VW', 'PoP_Up', 'width=1400,height=500,left=70,top=100,directories=no,navigationbar=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,resizable=yes,scrollbars=yes');
           // nWindow.focus();
        }
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/jobdescription.png" style="vertical-align: middle;" />
     Job Description
        </div >
        <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:0.5%;height:10%;">
            ...
            <div style="width:100%;float:left;margin-top:14px">
                ...
                <asp:UpdatePanel runat="server">
                 ...
                 <div class="eachform" style="width: 35%; padding-left: 2.5%;padding-top:0.5% ;float: left;">
                    <h2 style="margin-top: 0.5%;margin-left: 0%;"> Department</h2>
                      <asp:DropDownList ID="ddlDep" class="form1"   style="height:25px;width:55%;float: left;margin-left: 6%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged">      </asp:DropDownList>
                </div>

              <div class="eachform" style="width: 25%;margin-top:0.5%;float: left;">
                   <h2 style="margin-top:1%;">Division</h2>
                      <asp:DropDownList ID="ddlDivision" Height="25px"  Width="160px" class="form1" runat="server" Style="height:25px;width:160px;height:25px;width:69%;float:left; margin-left: 8%;"></asp:DropDownList>
               </div> 

              
                          </ContentTemplate>
                </asp:UpdatePanel>        
                <div class="subform" style="width:19%;float: left;margin-left: 3%;margin-top: 0.5%;">
             ...
             <div style="width:12%;float:right;margin-top:-3.5%;margin-left: 0%;">
        ...
        <div onclick="location.href='gen_Job_Description_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Accommodation_Master_List.aspx.cs" Inherits="Master_gen_Accommodation_Master_gen_Accommodation_Master_List" %>
        ...
        function ChangeStatus() {
         ...
         <script>
             ...
             function SuccessCancelation() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Accommodation Details Cancelled Successfully.";

             }
             function SuccessRecall() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Accommodation  Details Recalled Successfully.";
             }
             function SuccessStatusChange() {
                 document.getElementById('divMessageArea').style.display = "";
                 document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
                 document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Accommodation Status Changed Successfully.";
             }
     ...
     <script>
        ...
        <script>
            function InsertToSearchField()
            {
                ...
                var DropDownAccType=document.getElementById("<%=ddlAccommodationType.ClientID%>");
                var SelectedValueStatus = DropdownStatus.value;
                var SelectedValueType = DropDownAccType.value;
                var ShwCancel = 0;
                ...
                document.getElementById("<%=hiddenSearchField.ClientID%>").value = SelectedValueStatus + '_' + ShwCancel + '_' + SelectedValueType;
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="cont_rght" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/Accommodation-Master.png" style="vertical-align: middle;" /> Accommodation 
        </div>
           <%--0006 start--%>
        <div class="eachform" style="width: 22%;margin-top: 2%;">
            ...
            <div class="eachform" style="width:21%; margin-bottom: 1.2%;">               
         ...
         <div style="width: 29%; margin-top: 2.2%; " class="eachform">
              <h2 style="margin-top:1%;">Accommodation Type </h2>
                <asp:DropDownList ID="ddlAccommodationType" class="form1"  runat="server" Style="height:30px;width:183px;margin-left: 1%;">
                </asp:DropDownList>
          </div>
                <div class="eachform" style="width:11%;margin-left: 10%;margin-bottom: 0.5%;">
        ...
        <div onclick="location.href='gen_Accommodation_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Accommodation </h3>
                    </div>

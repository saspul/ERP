<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Interview_CategoryList.aspx.cs" Inherits="HCM_HCM_Master_gen_Interview_Category_gen_Interview_CategoryList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Interview category cancelled successfully.";
        }
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="/Images/BigIcons/interview catagory.png" style="vertical-align: middle;" />
           Interview Category 
        </div >
         ...
         <div style="float:left;width:100%">
           ...
           <div id="DivProject" class="eachform" style="width: 40%;margin-top:1%;">
              ...
              <div class="eachform" style="width:15%;float: right;margin-right: 2%;margin-top: 2%;">
                <asp:Button ID="btnSearch" style="cursor:pointer;float:left;" runat="server" class="searchlist_btn_lft" Text="Search" onclick="btnSearch_Click" />
                     </div>
        ...
        <div onclick="location.href='gen_Interview_Category.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Interview Category</h3>
                    </div>

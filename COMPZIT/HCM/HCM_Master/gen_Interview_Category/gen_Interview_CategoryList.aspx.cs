...
public partial class HCM_HCM_Master_gen_Interview_Category_gen_Interview_CategoryList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (dtChildRol.Rows.Count > 0)
            {
                ...
                if (Session["USERID"] != null)
                {
                    objEntityInterviewCategory.UserId = Convert.ToInt32(Session["USERID"].ToString());
                }
                else if (Session["USERID"] == null)
                {
                    Response.Redirect("~/Default.aspx");
                ...
                if (dtCorpDetail.Rows.Count > 0)
                {
                    ...
                    {//when Canceled
                        ...
                        if (CnclrsnMust == "0")
                        {
                            objEntityInterviewCategory.CancelReason = objCommon.CancelReason();

                            objBusinessInterviewCategory.CancelInterviewCat(objEntityInterviewCategory);
                            Response.Redirect("gen_Interview_CategoryList.aspx?InsUpd=Cncl");
                        }
                        else
                        {
                            DataTable dtProductSrch = new DataTable();
                            objEntityInterviewCategory.IntwCategoryStatus = 1;
                            objEntityInterviewCategory.CancelStatus = 0;

                            dtProductSrch = objBusinessInterviewCategory.ReadInterviewCatList(objEntityInterviewCategory);
                    ...
                    else if (Request.QueryString["StsCh"] != null)
                    {
                        ...
                        objEntityInterviewCategory.UserId = intUserId;
                        objEntityInterviewCategory.Date = System.DateTime.Now;
                        objBusinessInterviewCategory.StatusChangeInterviewCat(objEntityInterviewCategory);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            objEntityInterviewCategory.IntwCategoryStatus= Convert.ToInt32(ddlStatus.SelectedItem.Value);
        }
        if (cbxCnclStatus.Checked == true)
        {
            objEntityInterviewCategory.CancelStatus = 1;
        }
        else
        {
            objEntityInterviewCategory.CancelStatus = 0;
    ...
    public string ConvertDataTableToHTML(DataTable dt, int intEnableModify, int intEnableCancel)
    {
        ...
        for (int intColumnHeaderCount = 0; intColumnHeaderCount < dt.Columns.Count; intColumnHeaderCount++)
        {
            ...
            {
                strHtml += "<th class=\"thT\" style=\"width:52%;text-align: left; word-wrap:break-word;\">" + dt.Columns[intColumnHeaderCount].ColumnName + "</th>";
            }
            if (intColumnHeaderCount == 2)
            {
                if (cbxCnclStatus.Checked == false)
                {
                    strHtml += "<th class=\"thT\" style=\"width:6%;text-align: center; word-wrap:break-word;\">" + dt.Columns[intColumnHeaderCount].ColumnName + "</th>";
                }
            }
        ...
        if (cbxCnclStatus.Checked == false)
        {
            if (intEnableModify == Convert.ToInt32(clsCommonLibrary.StatusAll.Active))
            {
                ...
                strHtml += "<th class=\"thT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">EDIT </th>";

            }

            if (intEnableCancel == Convert.ToInt32(clsCommonLibrary.StatusAll.Active))
            {
                strHtml += "<th class=\"thT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">DELETE </th>";
            }
        }
        else
        {
        ...
        for (int intRowBodyCount = 0; intRowBodyCount < dt.Rows.Count; intRowBodyCount++)
        {
            ...
            for (int intColumnBodyCount = 0; intColumnBodyCount < dt.Columns.Count; intColumnBodyCount++)
            {
                ...
                {
                    strHtml += "<td class=\"tdT\" style=\" width:52%;word-break: break-all; word-wrap:break-word;text-align: left;\" >" + dt.Rows[intRowBodyCount][intColumnBodyCount].ToString() + "</td>";
                }
                if (intColumnBodyCount == 2)
                {
                    if (cbxCnclStatus.Checked == false)
                    {
                        ...
                        {
                            strHtml += "<td class=\"tdT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">" + " <a  class=\"tooltip\" title=\"Make Inactive\" onclick='return ChangeStatus();' href=\"gen_Interview_CategoryList.aspx?StsCh=" + Id + "\"\" >" +
                                "<img  style=\"cursor:pointer\" src='/Images/Icons/activate.png' /> " + "</a> </td>";

                        }
                        else
                        {
                            strHtml += "<td class=\"tdT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">" + " <a  class=\"tooltip\" title=\" Make Active\" onclick='return ChangeStatus();' href=\"gen_Interview_CategoryList.aspx?StsCh=" + Id + "\"\" >" +
            ...
            if (intEnableModify == Convert.ToInt32(clsCommonLibrary.StatusAll.Active))
            {
                if (cbxCnclStatus.Checked == false)
                {
                    ...
                    strHtml += "<td class=\"tdT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">" + " <a class=\"tooltip\" title=\"Edit\" onclick='return getdetails(this.href);' " +
                          " href=\"gen_Interview_Category.aspx?Id=" + Id + "\">" + "<img  style=\"\" src='/Images/Icons/edit.png' /> " + "</a> </td>";
                }
            ...
            if (cbxCnclStatus.Checked == true)
            {
                strHtml += "<td class=\"tdT\" style=\"width:4%; word-wrap:break-word;text-align: center;\">" + " <a  class=\"tooltip\" title=\"View\"  onclick='return getdetails(this.href);' " +
                 " href=\"gen_Interview_Category.aspx?ViewId=" + Id + "\">" + "<img  style=\"\" src='/Images/Icons/view.png' /> " + "</a> </td>";
            ...
            if (intEnableCancel == Convert.ToInt32(clsCommonLibrary.StatusAll.Active))
            {
                if (cbxCnclStatus.Checked == false)
                {
                    ...
                    {
                        strHtml += "<td class=\"tdT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">" + " <a class=\"tooltip\" title=\"Delete\"   onclick='return CancelAlert(this.href);' " +
                         " href=\"gen_Interview_CategoryList.aspx?Id=" + Id + "\">" + "<img  src='/Images/Icons/delete.png' /> " + "</a> </td>";
                    }
                    else
                    {

                        strHtml += "<td class=\"tdT\" style=\"width:6%; word-wrap:break-word;text-align: center;\">" + " <a  class=\"tooltip\" title=\"Delete\" onclick='return CancelNotPossible();' >"
    ...
    protected void btnRsnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            objEntityInterviewCategory.IntwCategoryId = Convert.ToInt32(hiddenRsnid.Value);
            ...
            if (Session["USERID"] != null)
            {
                objEntityInterviewCategory.UserId = Convert.ToInt32(Session["USERID"]);
            ...
            objEntityInterviewCategory.CancelReason = txtCnclReason.Text.Trim();
            objBusinessInterviewCategory.CancelInterviewCat(objEntityInterviewCategory);
            Response.Redirect("gen_Interview_CategoryList.aspx?InsUpd=Cncl");
        }
    }

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" CodeFile="gen_Joining_Intimation.aspx.cs" Inherits="HCM_HCM_Master_gen_Joining_Intimation_gen_Joining_Intimation" %>
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/joining invitation.png" style="vertical-align: middle;" />
     Joining Intimation
        </div >
       ...
       <ContentTemplate>
            ...
            <asp:DropDownList ID="ddlDep" class="form1" style="height:25px;width:65%;float: left;margin-left: 6%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged">      </asp:DropDownList>
             
        </div>
                        <div class="eachform" style="width: 25%;margin-top:0.5%;margin-left:2%;float: left;">

                <h2 style="margin-top:1%;">Division</h2>

                <asp:DropDownList ID="ddlDivision" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged" class="form1" runat="server" Style="height:25px;width:160px;height:25px;width:69%;float:left; margin-left: 8%;">

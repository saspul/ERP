<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Interview_Temp_Master_List.aspx.cs" Inherits="HCM_HCM_Master_gen_Interview_Temp_Master_gen_Interview_Temp_Master_List" %>
  ...
  <style>
    ...
    <script type="text/javascript">
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Interview template details inserted successfully.";
        }
        function SuccessUpdation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Interview template details updated successfully.";
        }
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Interview template cancelled successfully.";
        }
        function SuccessStatusChange() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Interview template status changed successfully.";
        }
    ...
    <script>
        ...
        function SearchValidation() {
            ...
            if (ret == true) {
                ...
                document.getElementById("<%=HiddenSearchField.ClientID%>").value = cbx+","+ Status;
            }
        ...
        function ChangeStatus(CatId, CatStatus) {
            if (confirm("Do you want to change the status of this template?")) {
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/interview template.png" style="vertical-align: middle;" />
     Interview Template
        </div >
        ...
        <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:1%;">
         ...
         <div style="float:left;width:100%">
            ...
            <div id="DivProject" class="eachform" style="width: 40%;margin-top:1%;">
                      ...
                      <asp:ListItem selected Text="Active" Value="1"></asp:ListItem>
        ...
        <div onclick="location.href='gen_Interview_Temp_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Interview Template</h3>
                    </div>

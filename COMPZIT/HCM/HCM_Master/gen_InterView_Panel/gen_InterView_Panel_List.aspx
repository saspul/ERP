<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_InterView_Panel_List.aspx.cs" Inherits="HCM_HCM_Master_gen_InterView_Panel_gen_InterView_Panel_List" %>
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/interview panel.png" style="vertical-align: middle;" />
    Interview Panel
        </div >
       ...
       <ContentTemplate>
            ...
            <asp:DropDownList ID="ddlDep" class="form1" style="height:25px;width:160px;height:25px;width:69%;float:left; margin-left: 2%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged">       </asp:DropDownList>

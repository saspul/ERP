<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Candidate_SelectionList.aspx.cs" Inherits="HCM_HCM_Master_gen_Candidate_Selection_gen_Candidate_SelectionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script type="text/javascript">
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Candidate details inserted successfully.";
        }
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/candidate selection.png" style="vertical-align: middle;" />
     Candidate Selection
        </div >
       ...
       <ContentTemplate>
            ...
            <asp:DropDownList ID="ddlDep" class="form1" style="height:25px;width:160px;height:25px;width:60%;float:left; margin-left: 5%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged" TabIndex="1">      </asp:DropDownList>
                ...
                <asp:DropDownList ID="ddlDivision" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged" class="form1" runat="server" Style="height:25px;width:65%;float: left;margin-left: 6%;" TabIndex="2">

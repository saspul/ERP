<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPageNewHcm.master" CodeFile="hcm_Job_Delegation.aspx.cs" Inherits="HCM_HCM_Master_hcm_UserRol_ChilDefntion_hcm_UserRol_ChilDefntion" %>
         ...
         return ret;
                                 ...
                                 <script language="javascript" type="text/javascript">
                                     ...
                                     function loadChildRoles() {
                                         ...
                                         $noCon.ajax({
                                             type: "POST",
                                             url: "hcm_Job_Delegation.aspx/LoadChildRol",
...
<div style="float: left; width: 98%;  margin-top: 2%; padding-left: 1%;">

              
   <div class="eachform" style="width: 10%; float: left;">
         <label class="lblh2" style="width: 73%;">User Role* </label>
       </div>
                <div class="eachform" style="width: 70%; float: left;">
                             <div id="DivCatDtls"  runat="server">
                                ...
                                <div class="colmcenter" style="margin-top: 0%;">
                                 ...
                                 <input  value="7" checked  type="radio" onkeypress="return isTag(event);" id="RadApprv" name="selector"><label style="width:21%" for="RadApprv">DM ALLOCATION</label>
          ...
          <div style="float: left; width: 100%;margin-top: 3%;margin-bottom: 3%;background-color: #e1e1e1;">
     
               <div class="smart-form" style="float: left; width: 60%;padding-bottom: 2%;">
                   	...
                   	<div  id="divlistview" style="width:91%;float:left;margin-top:4%;margin-left: 1%;"  runat="server">

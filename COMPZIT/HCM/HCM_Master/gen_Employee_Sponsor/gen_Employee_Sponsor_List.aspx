<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Employee_Sponsor_List.aspx.cs" Inherits="HCM_HCM_Master_gen_Employee_Sponsor_gen_Employee_Sponsor_List" %>
  ...
  <style>
    ...
    <script type="text/javascript">
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor details inserted successfully.";
        }
        function SuccessUpdation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor details updated successfully.";
        }
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor cancelled successfully.";
        }
        ...
        function SuccessStatusChange() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor status changed successfully.";
        }
        function SuccessReOpen() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor details reopened successfully.";
        }
        function SuccessConfirm() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor details confirmed successfully.";
         }
         function SuccessClose() {
             document.getElementById('divMessageArea').style.display = "";
             document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
             document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Employee sponsor details closed successfully.";
        }
   ...
   <%--  for giving pagination to the html table--%>
    ...
    <script>
        ...
        function SearchValidation() {
            ret = true;
            var ddlSponsorStatus = document.getElementById("<%=ddlSponsorStatus.ClientID%>").value;
            if (ddlSponsorStatus == '--SELECT STATUS--') {
                ddlSponsorStatus = "";

             }

            var ddlType = document.getElementById("<%=ddlType.ClientID%>").value;
            if (ddlType == '--SELECT TYPE--') {
                ddlType = "";

             }
             var GuaranteStatus = document.getElementById("<%=ddlSponsorStatus.ClientID%>").value;
             var searchStatus = document.getElementById("<%=ddlType.ClientID%>").value;
             ...
             if (ret == true) {
                ...
                // document.getElementById("<%=HiddenSearchField.ClientID%>").value = searchStatus + ',' + GuaranteStatus + ',' + cbxStatus + ',' + ddlSponsorStatus + ',' + ddlType;
                 document.getElementById("<%=HiddenSearchField.ClientID%>").value = searchStatus + ',' + GuaranteStatus + ',' + cbx;
         ...
         function ChangeStatus(CatId, CatStatus) {
             if (confirm("Do you want to change the status of this entry?")) {
                 ...
                 var Details = PageMethods.ChangeSponsorStatus(CatId, CatStatus, function (response) {
                    var SucessDetails = response;
                
                    if (SucessDetails == "success") {
                        if (SearchString == "") {
                            window.location = 'gen_Employee_Sponsor_List.aspx?InsUpd=StsCh';
                        }
                        else {
                            window.location = 'gen_Employee_Sponsor_List.aspx?InsUpd=StsCh&Srch=' + SearchString + '';
                        }
        ...
        function PreviewPDF(pageurl) {
            ...
            var SearchString = document.getElementById("<%=HiddenSearchField.ClientID%>").value;
            if (SearchString != "") {
                window.location = 'gen_Employee_Sponsor_List.aspx?Srch=' + SearchString + '';
            }
            else {
                window.location = 'gen_Employee_Sponsor_List.aspx?';
            }
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
     ...
     Employee Sponsor
        ...
        <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:1%;height:10%;">

            <div style="width:100%;float:left;margin-top:14px">
                        <div class="eachform" style="width: 25%;margin-top:1%;margin-left:3%;float:left">

                <h2 style="margin-top:1%;">Type</h2>

                <asp:DropDownList ID="ddlType" Height="25px"  Width="160px" class="form1" runat="server" Style="height:25px;width:160px;float:left; margin-left: 8%;">
              ...
              <%--           <asp:ListItem Text="Pending" Value="1"></asp:ListItem>
                   ...
                   <asp:ListItem Text="Approved" Value="3"></asp:ListItem>
                    ...
                    <div class="subform" style="width:22%;float: left;margin-top: 1%;">


                    <asp:CheckBox ID="cbxCnclStatus" Text="" runat="server"  Checked="false" class="form2" />
                    <h3 style="margin-top:1%;">Show Deleted Entries</h3>
                  </div>
                  <div class="eachform" style="width: 35%; padding-left: 0.5%;padding-top:1% ;float: left;">
            <h2 style="margin-top: 0.5%;margin-left: -3%;"> Status</h2>

            <asp:DropDownList ID="ddlSponsorStatus" class="form1"   style="height:25px;width:48%;margin-right: 37%;" runat="server">
             ...
             <div style="width:1%;float:left;margin-top:-4%;margin-left: 86%;">
        ...
        <div onclick="location.href='gen_Employee_Sponsor_Master.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Employee Sponsor</h3>
                    </div>

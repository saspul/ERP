<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_Cand_Arival_Confirm.aspx.cs" Inherits="HCM_HCM_Master_hcm_OnBoarding_hcm_Candidate_Arrivl_Marking_hcm_Cand_Arival_Confirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:HiddenField ID="hiddenCandidList" runat="server" />
  ...
  <div id="divReport" class="table-responsive" runat="server">
      ...
      <div class="eachform" style="width: 59%; margin-top: 3%; float: right">             
                       <asp:Button ID="btnAdd" Style="display:none;" TabIndex="10" runat="server" class="cancel" Text="Save"   OnClientClick="return getselected();" OnClick="btnAdd_Click" />
    ...
    <script>
       ...
       <script>
           ...
           function ConfirmMessage() {
               if (confirmbox > 0) {
                   if (confirm("Are you sure you want to leave this page?")) {
                       window.location.href = "hcm_Cand_Arrivl_Marking.aspx";
                       return false;
                   }
                   else {
                       return false;
    ...
    <script>
        function SuccessIns() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Candidate data inserted successfully.";
        ...
        function SuccessUpdation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Candidate data updated successfully.";
            var $Mo = jQuery.noConflict();
            $Mo(window).scrollTop(0);
        }
        function SuccessConfirmed() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Arrival confirmed successfully.";
            var $Mo = jQuery.noConflict();
            $Mo(window).scrollTop(0);
        }
    </script>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_Cand_Arrivl_Marking.aspx.cs" Inherits="HCM_HCM_Master_hcm_OnBoarding_hcm_Candidate_Arrivl_Marking_hcm_Cand_Arrivl_Marking" %>
...
<style>
    ...
    <script type="text/javascript">
        ...
        function SuccessIns() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Candidate shortlist data saved successfully.";
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/cadidate shortlist.png" style="vertical-align: middle;" />
     Candidate Arrival Marking
        </div >
       ...
       <ContentTemplate>
            ...
            <asp:DropDownList ID="ddlDep" class="form1" style="height:25px;width:160px;height:25px;width:65%;float:left; margin-left: 5%;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged">      </asp:DropDownList>
             
        </div>
                   <div class="eachform" style="width: 29%; padding-left: 2%;padding-top:0.5% ;float: left;">

                <h2 style="margin-top: 0.5%;margin-left: 0%;">Division</h2>

                <asp:DropDownList ID="ddlDivision" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged" class="form1" runat="server" Style="height:25px;width:58%;float: left;margin-left: 6%;">
            ...
            <asp:DropDownList ID="ddlProject" class="form1"  style="height:25px;width:74%;float: left;margin-left: 6%;" runat="server">      </asp:DropDownList>
               ...
               <%-- <div class="eachform" style="width:98%;float: right;">
                <%--<asp:Button ID="btnSearch" style="cursor:pointer;margin-top: -0.4%;" TabIndex="5" runat="server" class="searchlist_btn_lft" Text="Search" onclick="btnSearch_Click" OnClientClick="return SearchValidation();"  />--%>
        ...
        <div id="divReport" class="table-responsive" runat="server" style="margin-top: 2%;width: 100%;">
            <br />
            <br />
            <br />
            <br />

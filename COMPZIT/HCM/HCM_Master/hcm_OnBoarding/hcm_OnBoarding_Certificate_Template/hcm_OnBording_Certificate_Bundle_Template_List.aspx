<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_OnBording_Certificate_Bundle_Template_List.aspx.cs" Inherits="HCM_HCM_Master_hcm_OnBoarding_hcm_OnBoarding_Certificate_Template_hcm_OnBording_Certificate_Bundle_Template_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <div class="cont_rght" style="width:100%" >
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="/Images/BigIcons/bundle-48.PNG" style="vertical-align: middle;" />
         ...
         <div id="DivProject" class="eachform" style="width: 40%;margin-top:1%;">
                ...
                <asp:DropDownList ID="ddlStatus" Height="30px" TabIndex="4" Width="160px" class="form1" runat="server" Style="height:30px;width:160px;height:30px;width:55.2%;float:left; margin-left: 7%;">
     ...
     <div onclick="location.href='hcm_OnBording_Certificate_Bundle_Template.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
   ...
   <%--  <div style="width: 100% !important; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: #3a3a3a; filter: Alpha(Opacity=90); -moz-opacity: 0.2; opacity: 0.4; z-index: 29; height: auto !important;"
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Certificate Bundle Template</h3>
                    </div>
    ...
    <script>
        function Successstatschanged() {
            ...
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Certificate bundle template Status changed successfully.";
            var $Mo = jQuery.noConflict();
        ...
        function DuplicateInterviewCategory() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Certificate bundle template can’t be duplicated.";
        ...
        function SuccessUpdation() {
          ...
          function SuccessCancelation() {
              document.getElementById('divMessageArea').style.display = "";
              document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
              document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Certificate bundle template  cancelled successfully.";
        }

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" EnableEventValidation="false" CodeFile="gen_Candidate_Personal_Informn.aspx.cs" Inherits="Master_gen__Cand_Personal__Informn_gen__Cand_Personal__Informn" %>
    ...
    <script type="text/javascript">
        ...
        function PrintPdf() {
            ...
            var UsrName = '<%= Session["USERFULLNAME"] %>';
                 ...
                 var strId = document.getElementById("<%=HiddenCandidateId.ClientID%>").value;


                 if (strCorpID != "" && strCorpID != null && strOrgIdID != "" && strOrgIdID != null && UsrName != null && UsrName != "" && strId != "") {
                     $.ajax({
                         type: "POST",
                         async: false,
                         contentType: "application/json; charset=utf-8",
                         url: "gen_Candidate_Personal_Info_List.aspx/PrintJoinigForm",
                         data: '{strId: "' + strId + '",UsrName: "' + UsrName + '",strOrgIdID: "' + strOrgIdID + '",strCorpID: "' + strCorpID + '"}',
                         dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" EnablePageMethods="true" runat="server">
     ...
     <asp:HiddenField ID="hiddenImageFile" runat="server" />
     <asp:HiddenField ID="hiddenImageFileDeleted" runat="server" />
    <asp:HiddenField ID="hiddenImageFileAct" runat="server" />
    ...
    <a id="divPrint" runat="server" class="print" style="cursor: pointer;float: right; margin-top: 0%; margin-left: 0%; width: 13%;color: rgb(83, 101, 51)"  onclick="PrintPdf();"  >
       <img src="/Images/Other Images/imgPrint.png" style="max-width: 45%">
        <span style="margin-top: 2px; float: left;">Print</span></a>



      <%--<a id="divPrint" style="float: right; margin-top: 0%; margin-left: 0%; width: 13%;" onclick="PrintPdf();">Print</a>--%>
    <br />
        ...
        <table id="test" class="logo" style="width: 99%; float: left; margin-right: 0%; height: 10%; border: 2px solid #06558f; border-spacing: 10px; font-family: Calibri">
            ...
            <tr>
                <td style="padding: 0px;">
                    <asp:Button ID="btnCnfrmPrsn" src="/Images/Icons/check-mark.png" runat="server" Style="height: 30px; background: transparent; width: 100%; border: 0px solid #a1a1a1;" class="" Text="Confirm" OnClientClick="return ValidateAll();" OnClick="btnCnfrmPrsn_Click" />
                </td>
            </tr>

        </table>
        <%--<asp:ImageButton ID="" Style="width: 66%;height: 20px;margin-top: 4%;" class="save"  src="/Images/Icons/check-mark.png" runat="server" OnClientClick="return ValidateAll();" OnClick="btnCnfrmPrsn_Click"/>--%>
    </div>

    <%--   </div>--%>


    <div id="div1" class="list" onclick="return ConfirmMessage();" runat="server" style="position: fixed; right: 0%; top: 42%; height: 26.5px;z-index: 1;">
    </div>
    ...
    <div id="divMain" style="width: 85%; margin-top: 3%; float: left; margin-left: 0%;">
       ...
       <ContentTemplate>--%>
                    ...
                    <div style="float: left; width: 95%">
                        ...
                        <div id="div7" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
                            <asp:Label ID="Label2" runat="server">Personal Details</asp:Label>
                        </div>
                        <br />
                    ...
                    <div style="float: left; width: 95%" id="divDivforHRPd" runat="server">
                        <div class="eachform" style="float: left; width: 51%;">
                            ...
                            <asp:DropDownList ID="ddlDivison" Height="30px" Width="267px" onchange="return IncrmntConfrmCounterpd();" class="form1" runat="server" Style="text-align: left; float: right; margin-top: 0%;"></asp:DropDownList>
                    ...
                    <div style="float: left; width: 95%">
                        ...
                        <div class="eachform" style="width: 51%; float: left; height: 35px;">
                           ...
                           <%--<p class="error" id="ErrorMsgUsrMob" style="display: none; font-family: Calibri; font-size: small; margin-top: 0%; margin-left: 1%;">Please enter valid Mobile Number</p>--%>
                        ...
                        <div class="eachform" style="float: right;">
                            ...
                            <div id="divNationality">
                                <asp:DropDownList ID="ddlNationality" Height="30px" Width="51.3%" onkeypress="return isTagEnter(event);" onchange="return IncrmntConfrmCounterpd();" class="form1" runat="server" Style="text-align: left; float: right;"></asp:DropDownList>
                 ...
                 <div style="float: left; width: 95%">
                    ...
                    <div class="eachform" style="float: left; width: 51%;">
                        ...
                        <%--<p class="error" id="ErrorMsgUsrEmail" style="display: none; padding-left: 6%; font-family: Calibri; font-size: small; margin-top: 1px; margin-left: 30%;">Please enter valid email address</p>--%>
                         <p class="error" id="ErrorMsgUsrEmail" style="display:none;padding-left:36.5%;">Please enter valid email address</p> <%--evm-0023--%>
                           ...
                           <div class="eachform" style="width: 45%; float: right;">
                            ...
                            <p class="error" id="ErrorMsgUsrLocalContact" style="display: none; font-family: Calibri; font-size: small; margin-top: 0%; margin-left: 24%;">Please enter valid Contact Number</p>
                    ...
                    <div style="float: left; width: 95%">
                           ...
                           <div class="eachform" style="float: left; width: 96%;">
                                <h2 style="margin-top: 0%;">Attach Candidate Image</h2>

                                  <label for="cphMain_FileUploadImage" style="margin-left: 8.2%;" class="custom-file-upload" tabindex="0">
                                        <img src="/Images/Icons/cloud_upload.jpg" />Upload Image</label>

                                <asp:FileUpload ID="FileUploadImage" class="fileUpload" runat="server" Style="height: 30px; display:none;" onchange="ClearDivDisplayImage()" Accept="All" />
                                 <asp:Label ID="lblNoSelectedFile" runat="server" Text="No File selected" Style="font-family: Calibri; font-size: medium;"></asp:Label>
                               <br>
                               <br>
                            <div id="divImageEdit" runat="server" style="float: right; width: 54%; height: 20px; margin-top: -1%;">
                                <div class="imgWrap">
                                    <img id="ClearImage" src="/Images/Icons/clear-image-green.png" alt="Clear" onclick="ClearImage()" onmouseover="ImagePosition('ClearImage')"; style="cursor: pointer; float: left;" />
            ...
            <div style="float: left; width: 100%">
                ...
                <div id="divHrContact" style="display: block;">
                    ...
                    <div class="eachform" style="float: left; width: 100%;">
                        ...
                        <asp:RadioButton ID="RadioSponsor1"  onkeypress="return isTag(event);" onclick="DisableSponsor('Sponsor1')" Style="float: left; margin-left: 11.5%; font-family: Calibri; color: #697259;" Text="Yes" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="RadioSponsor" />
                        <asp:RadioButton ID="RadioSponsor2"  onkeypress="return isTag(event);" onclick="DisableSponsor('Sponsor2')" Style="float: left; font-family: Calibri; color: #697259;" Text="No" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="RadioSponsor" />
            ...
            function AlertCancelAllCD() {
                if (confirmboxCD > 0) {
                    if (confirm("Are you sure you want cancel in this page?")) {
                        window.location.href = "gen_Candidate_Personal_Info_List.aspx";
                        return false;
                    }
                    else {
                        return false;
        ...
        <div id="divTblid3" style="float: left; width: 100%; background-color: #f3f3f3; border: 2px solid; border-color: #06558f; padding: 2%; display: none;">
            ...
            <div id="divDepnt" style="width: 98%; border: 1px solid; border-color: darkgrey; padding: 1%; margin-top: 1%;">
                ...
                <div class="eachform" style="float: right; margin-bottom: 1%">
                    <h2>Date Of Birth</h2>
                           <div id="div5" class="input-append date" style="float: left; margin-left: 17%; width: 64%;">

                        <div id="Div6" class="input-append date" style="font-family: Calibri; float: right; width: 87%; margin-right: -4%; margin-top: 0%;">
                ...
                <div style="margin-top: 5%; float: left; margin-left: 32%;">
                    <asp:Button ID="btnUpdateDepnt" runat="server" class="save" Style="display: none;" Text="Update" OnClick="btnUpdateDepnt_Click" OnClientClick="return ValidateDepnt('adddep',this.id);" />
                    ...
                    <asp:Button ID="btnAddDepnt" runat="server" class="save" Text="Save"  OnClientClick="return ValidateDepnt('adddep',this.id);" />
            ...
            <div id="div8" style="width: 98%; border: 1px solid; border-color: darkgrey; padding: 1%; margin-top: 1%;">
             ...
             <div class="eachform" style="float: right; width: 49%; margin-right: -1%;">
                   ...
                   <asp:RadioButton  ID ="RbMaritalStatusDP2" style="float:left;" onchange="IncrmntConfrmCounterDep();"  Text="Unmarried" runat="server"  GroupName ="RadioMrtlSts"/> 
                        ...
                        <asp:RadioButtonList ID="rblMarrStatus" RepeatDirection="Horizontal"  onchange="changeMaritalStatus();"  onkeypress="return isTag(event);" runat="server">
        ...
        <script>
            ...
            function ValidateDepnt(btnDpCheck, Buttonid) {
                    var ret = true;
                    ...
                    NameWithoutReplace = document.getElementById("<%=txtOccptnFM.ClientID%>").value.trim(); // evm-0023 trim(single line)
                    replaceText1 = NameWithoutReplace.replace(/</g, "");
                    replaceText2 = replaceText1.replace(/>/g, "");
                    ...
                    if (ret == true && Buttonid == 'cphMain_btnAddDepnt') {
                        var User_Id = '<%= Session["USERID"] %>';
                        var strOrgIdID = '<%=Session["ORGID"]%>';
                        var strCorpID = '<%=Session["CORPOFFICEID"]%>';

                        if (User_Id == "" || strOrgIdID == "" || strCorpID=="")
                        {
                            window.location = '/Security/Login.aspx';
                        }
                        ...
                        var txtDepntName = document.getElementById("<%=txtDepndtNameFM.ClientID%>").value;                       
                        var ddlRelationship = cphMain_ddlReltnshpFM.options[cphMain_ddlReltnshpFM.selectedIndex].value;
                        var txtOccupation = document.getElementById("<%=txtOccptnFM.ClientID%>").value;
                        var txtDob = document.getElementById("<%=txtAgeFM.ClientID%>").value; 

                        if (strCorpID != "" && strCorpID != null && strOrgIdID != "" && strOrgIdID != null && User_Id != null && User_Id != "" && strId != "") {
                            $.ajax({
                                type: "POST",
                                async: false,
                                contentType: "application/json; charset=utf-8",
                                url: "gen_Candidate_Personal_Informn.aspx/SaveDependant",
                                data: '{strId: "' + strId + '",User_Id: "' + User_Id + '",strOrgIdID: "' + strOrgIdID + '",strCorpID: "' + strCorpID + '",txtDepntName: "' + txtDepntName + '",ddlRelationship: "' + ddlRelationship + '",txtOccupation: "' + txtOccupation + '",txtDob: "' + txtDob + '"}',
                                dataType: "json",
                                success: function (data) {
                                    if (data.d != "") {
                                        document.getElementById("cphMain_divReportforDependent").innerHTML = data.d;
                                        SuccessConfirmationDepnt();
                                    }
                                }
                            });
                        }
        ...
        <script>
            ...
            function updateDepntById(Id) {
              ...
              //  else
                ...
                var $Mo2 = jQuery.noConflict();
                $Mo2(Window).scrollTop(0);
              return false;
          }
          ...
          function deleteDepntById(Id) {
              ...
              if (confirm("Do you want to cancel this Entry?")) {
                  var Details = PageMethods.deleteDepntDtlById(Id, empId, OrgId, CorpId, function (response) {
                      ...
                      document.getElementById("cphMain_divReportforDependent").innerHTML = response.strDepntLIst;
            ...
            function readDepntList() {
                ...
                var Details = PageMethods.ReadDepntList( empId, OrgId, CorpId, function (response) {
        ...
        function DeleteImigrationByid(x, emp_Id) {
            ...
            function ReadImigrationList() {
                ...
                PageMethods.ReadImigrationList(candid,CorpId, OrgId, function (response) {

                    document.getElementById("<%=divImigList.ClientID%>").innerHTML = response.strhtml;
        ...
        <div id="divTblid4" style="float: left; background-color: #f3f3f3; width: 100%; border: 2px solid; border-color: #06558f; padding: 2%; display: none">
            ...
            <div id="divImgratn" style="width: 98%; border: 1px solid; border-color: darkgrey; padding: 1%; margin-bottom: 1%; font-family: Calibri">
                ...
                <div id="Divvisatype" class="eachform" style="float: left; width: 49%;">
                    ...
                    <asp:DropDownList ID="Ddlvisatype" onchange="IncrmntConfrmCounterImig();" Height="30px" Width="48%" class="form1" runat="server" Style="margin-left: 28%; float: left; text-align: left;"></asp:DropDownList>
                </div>
                ...
                <div class="eachform" style="float: left; width: 49%; margin-bottom: 0%;">
                    ...
                    <div id="divEligiblervwdate" class="input-append date" style="float: left; margin-left: 13%; width: 57%">
                        ...
                        <div id="Div2" class="input-append date" style="font-family: Calibri; float: right; width: 83%; margin-right: 3%; margin-top: 1%;">
                            <asp:TextBox ID="txtVisaExpDate" onkeypress="return isTag(event);"  onchange="IncrmntConfrmCounterImig();" class="textDate form1" placeholder="DD-MM-YYYY" MaxLength="20" runat="server" Style="width: 80%; height: 27px; font-family: calibri; float: left;"></asp:TextBox>

                            <input type="image" id="img2" class="add-on" src="/Images/Icons/CalandarIcon.png" onclick="IncrmntConfrmCounterImig()" onblur="return TextDateChange()" style="height: 19px; float: left; margin-top: 0%; width: 18px; cursor: pointer;" />
                ...
                <div class="eachform" style="float: left; width: 48%">
                    ...
                    <div id="Div4" class="input-append date" style="font-family: Calibri; float: right; width: 56%; margin-top: 1%;">
                        <asp:TextBox ID="txtPassExpDate" onkeypress="return isTag(event);"  class="textDate form1" onchange="IncrmntConfrmCounterImig();" placeholder="DD-MM-YYYY" MaxLength="20" runat="server" Style="width: 68.8%; height: 27px; font-family: calibri; float: left;"></asp:TextBox>

                        <input type="image" id="Image1" class="add-on" src="/Images/Icons/CalandarIcon.png" onclick="IncrmntConfrmCounterImig();" onblur="return TextDateChange()" style="margin-top: 0%; height: 19px; float: left; width: 18px; cursor: pointer;" />
                ...
                <div class="eachform" style="margin-top: 7%; float: left; width: 50%; height: 33px;">
                    <div class="subform" style="width: 448px; float: left">
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnUpdateStaffImigrationDtls" runat="server" class="save" Text="Update" Style="display: none" OnClientClick="return Validateimmigration(this.id); " OnClick="btnUpdateStaffImigrationDtls_Click" />
                            
                            <%--<asp:Button ID="btnAddStaffImigrationDtls" runat="server" class="save" Text="Save" OnClick="btnAddStaffImigrationDtls_Click" OnClientClick="return Validateimmigration(this.id); " />--%>

                            <asp:Button ID="btnAddStaffImigrationDtls" runat="server" class="save" Text="Save"  OnClientClick="return Validateimmigration(this.id); " />
     ...
     function Validateimmigration(ButtonId) {

         var ret = true;

         document.getElementById("<%=txtVisaExpDate.ClientID%>").style.borderColor = "";
         document.getElementById("<%=txtPassExpDate.ClientID%>").style.borderColor = "";
         ...
         var issudate = document.getElementById("<%=txtPassExpDate.ClientID%>").value;
             ...
             cdate = document.getElementById("<%=hiddenCurrentDate.ClientID%>").value;
         ...
         var CurrDate = cdate;
         var arrCurrDate = CurrDate.split("-");
         cdate = new Date(arrCurrDate[2], arrCurrDate[1] - 1, arrCurrDate[0]);


      
         if (dateexpiry < cdate) {
             document.getElementById("<%=txtVisaExpDate.ClientID%>").style.borderColor = "red";
             ret = false;
         }
         if (dateissued<cdate) {
             document.getElementById("<%=txtPassExpDate.ClientID%>").style.borderColor = "red";
             ret = false;
         ...
         if (ret == true && ButtonId == 'cphMain_btnAddStaffImigrationDtls') {
             var User_Id = '<%= Session["USERID"] %>';
             var strOrgIdID = '<%=Session["ORGID"]%>';
             var strCorpID = '<%=Session["CORPOFFICEID"]%>';
             ...
             var ddlVisaType = cphMain_Ddlvisatype.options[cphMain_Ddlvisatype.selectedIndex].value;
             var txtVisaNumber = document.getElementById("<%=TextVisa.ClientID%>").value;
             var txtVisaExpityDate = document.getElementById("<%=txtVisaExpDate.ClientID%>").value;
             var txtPassportNum = document.getElementById("<%=TextPass.ClientID%>").value;
             var txtPassportExpiryDate= document.getElementById("<%=txtPassExpDate.ClientID%>").value;
             ...
             objData.strOrgIdID = strOrgIdID;
             objData.strCorpID = strCorpID;
             objData.ddlVisaType = ddlVisaType;
             objData.txtVisaNumber = txtVisaNumber;
             objData.txtVisaExpityDate = txtVisaExpityDate;
             objData.txtPassportNum = txtPassportNum;
             objData.txtPassportExpiryDate = txtPassportExpiryDate;
             ...
             if (strId != "") {
                 $.ajax({
                     ...
                     async: false,
                     contentType: "application/json; charset=utf-8",
                     url: "gen_Candidate_Personal_Informn.aspx/SaveStaffImigrationDtls",
                     data: JSON.stringify(objData),
                     dataType: "json",
                     success: function (data) {
                         if (data.d != "") {
                             document.getElementById("cphMain_divImigList").innerHTML = data.d;
                             ImigSuccessConfirmation();
                         }
                     }
                 });
             }
        ...
        <%-------------    ----------------------------Start Other info-----------------------------------------%>
        <asp:HiddenField ID="hiddenOtherDetailsMode" runat="server" />
        <div id="divTblid1" style="float: left; background-color: #f3f3f3; width: 100%; border: 2px solid; border-color: #06558f; padding: 2%; display: none;">
            ...
            <div class="eachform" style="float: left;">
                ...
                <asp:TextBox ID="TextSpOcu" class="form1" runat="server" onchange="return IncrmntConfrmCounterOther();" MaxLength="49" Width="50%" Height="30px" onkeypress="return isTag(event);" Style="resize: none; text-transform: uppercase; font-family: calibri; margin-left: 16.2%; float: left;"></asp:TextBox>
            ...
            <div class="eachform" style="float: left; width: 100%;">
                <div style="float: left; width: 50%">
                    ...
                    <asp:RadioButton ID="RBillness1" onkeypress="return isTag(event);" onclick="DisableIllness('illness1')" Style="float: left; font-family: Calibri; color: #697259;" Text="Yes" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="Radioillness" />
                    <asp:RadioButton ID="RBillness2" onkeypress="return isTag(event);" onclick="DisableIllness('illness2')" Style="float: left; font-family: Calibri; color: #697259;" Text="No" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="Radioillness" />
                </div>
            ...
            <div class="eachform" style="float: left; width: 100%;">
                <div style="float: left; width: 50%">
                    ...
                    <asp:RadioButton ID="RadioAppliedYes" onkeypress="return isTag(event);" onclick="DisableApllied('Applied1')" Style="float: left; font-family: Calibri; color: #697259;" Text="Yes" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="RadioApplied" />
                    <asp:RadioButton ID="RadioAppliedNo" onkeypress="return isTag(event);" onclick="DisableApllied('Applied2')" Style="float: left; font-family: Calibri; color: #697259;" Text="No" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="RadioApplied" />
                </div>
                <div class="eachform" style="float: right; width: 48%">
                    <h2>If Yes, please give details</h2>
            ...
            <div class="eachform" style="float: left; width: 100%;">
                <div style="float: left; width: 50%">
                    ...
                    <asp:RadioButton ID="RadioRelate1" onkeypress="return isTag(event);" Style="float: left; font-family: Calibri; color: #697259;" Text="Yes" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="RadioRelate" />
                    <asp:RadioButton ID="RadioRelate2" onkeypress="return isTag(event);" Style="float: left; font-family: Calibri; color: #697259;" Text="No" onchange="return IncrmntConfrmCounterOther();" runat="server" Checked="true" GroupName="RadioRelate" />
                </div>
                <div style="float: left; width: 48%; margin-left: 2%;">
                    ...
                    <asp:RadioButton ID="RadioObj1" onkeypress="return isTag(event);" Style="float: left; font-family: Calibri; color: #697259;" Text="Yes" onchange="return IncrmntConfrmCounterOther();" runat="server" GroupName="Radioobj" />
                    <asp:RadioButton ID="RadioObj2" onkeypress="return isTag(event);" Style="float: left; font-family: Calibri; color: #697259;" Text="No" onchange="return IncrmntConfrmCounterOther();" runat="server" Checked="true" GroupName="Radioobj" />
                </div>
            </div>
        ...
        <script>
            ...
            function AlertClearAllOthers() {
                ...
                var OtherDetailsMode=document.getElementById("<%=hiddenOtherDetailsMode.ClientID%>").value;
                if (confirmboxother > 0 || OtherDetailsMode=="UPD") {
                    if (confirm("Are you sure you want clear all data in this page?")) {
                        ...
                        document.getElementById('filePath' + FileCounterPer).innerHTML = 'No File Uploaded'; //EVM-0023
        ...
        <script>
            ...
            function ChangeFilePer(x) {
                if (ClearDivDisplayImage1(x)) {
                    ...
                    IncrmntConfrmCounterOther();  //evm-0023 single ln
                ...
                if (confirmboxEdu > 0) {
                    if (confirm("Are you sure you want clear all data in this page?")) {
                      ...
                      document.getElementById("<%=txtEduInstite.ClientID%>").value = "";
                        ...
                        OptionStart.attr("value", "--Select Course--");
   ...
   function SuccessUpdationWrkExp() {
       ...
       $('#divWorkExp input[type="text"]').val(''); 
       document.getElementById("<%=txtAddressOfEmployerWrkExp.ClientID%>").innerHTML = "";
            ...
            if (confirm("Do you want to cancel this Entry?")) {
                ...
                function readWrkExpList() {
                    ...
                    var CandID = document.getElementById("<%=HiddenCandidateId.ClientID%>").value;
                        ...
                        var OrgIDStaff = document.getElementById("<%=HiddenOrgId.ClientID%>").value;
                var CorpidIDStaff = document.getElementById("<%=HiddenCorpId.ClientID%>").value;
                    var Details = PageMethods.ReadWrkExpList(CandID, OrgIDStaff, CorpidIDStaff, function (response) {
 ...
 <%--evm 0019 workexperience--%>
                    ...
                    if (document.getElementById("<%=txtDateOfJoiningWrkExp.ClientID%>").value != "" && document.getElementById("<%=txtDateOfLeavingWrkExp.ClientID%>").value != "") {
                        ...
                        var datepickerDate = document.getElementById("<%=txtDateOfLeavingWrkExp.ClientID%>").value;
                            ...
                            if (dateTxIss >= dateCompExp) {
                                document.getElementById("<%=txtDateOfLeavingWrkExp.ClientID%>").value = "";
                                alert("Sorry, leaving date should be greater than join date !");
                            }
                        }
                        return false;
                ...
                function ValidateWrkExp(ButtonId) {
                    var ret = true;
                    ...
                    document.getElementById("<%=txtAddressOfEmployerWrkExp.ClientID%>").style.borderColor = "";
                    document.getElementById("<%=txtNameOfEmployerWrkExp.ClientID%>").style.borderColor = "";
                    document.getElementById("<%=txtGCCExpYearsWrkExp.ClientID%>").style.borderColor = "";
                    // replacing < and > tags
               ...
               var EmployerWrkExp = document.getElementById("<%=txtNameOfEmployerWrkExp.ClientID%>").value.trim();
                    ...
                    var TotalWorkExprnc = document.getElementById("<%=txtWorkExpYearsWrkExp.ClientID%>").value.trim();
                    var GCCWorkExprnc = document.getElementById("<%=txtGCCExpYearsWrkExp.ClientID%>").value.trim();

                    if (TotalWorkExprnc != "" && GCCWorkExprnc != "") {
                        if (TotalWorkExprnc < GCCWorkExprnc) {
                            document.getElementById('divMessageAreaWrkExp').style.display = "";
                            document.getElementById('imgMessageAreaWrkExp').src = "/Images/Icons/imgMsgAreaWarning.png";
                            document.getElementById("<%=txtGCCExpYearsWrkExp.ClientID%>").style.borderColor = "Red";
                                  document.getElementById("<%=lblMessageAreaWrkExp.ClientID%>").innerHTML = "GCC experience should be less than or equal to work experience.";
                            document.getElementById("<%=txtGCCExpYearsWrkExp.ClientID%>").focus();
                            ret = false;
                        }
                    }
            ...
            ret = false;
                    ...
                    if (ret == true && ButtonId == 'cphMain_btnAddWrkExp') {
                        ...
                        if (User_Id == "" || strOrgIdID == "" || strCorpID == "" || strId == "") {
                            window.location = '/Security/Login.aspx';
                        }


                        var NameOfEmployerWrkExp = document.getElementById("<%=txtNameOfEmployerWrkExp.ClientID%>").value;
                        var GCCExpYearsWrkExp = document.getElementById("<%=txtGCCExpYearsWrkExp.ClientID%>").value;
                        var WorkExpYearsWrkExp = document.getElementById("<%=txtWorkExpYearsWrkExp.ClientID%>").value;

                        var DateOfJoiningWrkExp = document.getElementById("<%=txtDateOfJoiningWrkExp.ClientID%>").value;
                        var DateOfLeavingWrkExp = document.getElementById("<%=txtDateOfLeavingWrkExp.ClientID%>").value;

                        var DesignationWrkExp = document.getElementById("<%=txtDesignationWrkExp.ClientID%>").value;
                        var SalaryWrkExp = document.getElementById("<%=txtSalaryWrkExp.ClientID%>").value;
                        var AddressOfEmployerWrkExp = document.getElementById("<%=txtAddressOfEmployerWrkExp.ClientID%>").value;
                        ...
                        objData.NameOfEmployerWrkExp = NameOfEmployerWrkExp;
                        objData.GCCExpYearsWrkExp = GCCExpYearsWrkExp;
                        objData.WorkExpYearsWrkExp = WorkExpYearsWrkExp;

                        objData.DateOfJoiningWrkExp = DateOfJoiningWrkExp;
                        objData.DateOfLeavingWrkExp = DateOfLeavingWrkExp;

                        objData.DesignationWrkExp = DesignationWrkExp;
                        objData.SalaryWrkExp = SalaryWrkExp;
                        objData.AddressOfEmployerWrkExp = AddressOfEmployerWrkExp;
        
                            $.ajax({
                                type: "POST",
                                async: false,
                                contentType: "application/json; charset=utf-8",
                                url: "gen_Candidate_Personal_Informn.aspx/SaveWorkExperience",
                                data: JSON.stringify(objData),
                                dataType: "json",
                                success: function (data) {
                                    if (data.d != "") {
                                        document.getElementById("cphMain_divListWrkExp").innerHTML = data.d;
                                        SuccessConfirmationWrkExp();
                                    }
                                }
                            });
                            return false;
        ...
        return ret;
            ...
            <div id="divWorkExp" style="border: .5px solid; border-color: #9ba48b; background-color: #f3f3f3; width: 96%; margin-top: 1%; padding: 2%;">
                ...
                <div class="eachform" style="float: right">
                    ...
                    <div id="divDateOfJoiningWrkExp" class="input-append date" style="float: right; width: 54%; margin-right: 5%;">

                        <%--evm 0019 workexperience--%>

                        <asp:TextBox ID="txtDateOfJoiningWrkExp" class="form1" onblur="DateChkSearch();" onkeypress="return isTag(event);" onchange="return IncrmntConfrmCounterWrkExp();" placeholder="DD-MM-YYYY" MaxLength="20" runat="server" Height="30px" Width="43%" Style="height: 30px; width: 79%; margin-top: 0%; float: left;"></asp:TextBox>

                        <input type="image" runat="server" id="Image11" class="add-on" onblur="return DateChkSearch()" src="/Images/Icons/CalandarIcon.png" style="height: 22px; width: 22px; margin-top: 0%;" />
                        <%--evm 0019 workexperience--%>
                ...
                <div class="eachform" style="float: left;">
                    ...
                    <div id="divDateOfLeavingWrkExp" class="input-append date" style="float: right; width: 54%; margin-right: 5%;">


                        <%--evm 0019 workexperience--%>
                        <asp:TextBox ID="txtDateOfLeavingWrkExp" class="form1" onblur="DateChkSearch();" onkeypress="return isTag(event);" onchange="return IncrmntConfrmCounterWrkExp();" placeholder="DD-MM-YYYY" MaxLength="20" runat="server" Height="30px" Width="43%" Style="height: 30px; width: 79%; margin-top: 0%; float: left;"></asp:TextBox>

                        <input type="image" runat="server" id="Image15" class="add-on" onblur="return DateChkSearch()" src="/Images/Icons/CalandarIcon.png" style="height: 22px; width: 22px; margin-top: 0%;" />
                        <%--evm 0019 workexperience--%>
                ...
                <div class="eachform" style="float: left;">
                    ...
                    <%--<asp:TextBox ID="txtSalaryWrkExpAAAAAA" class="form1" runat="server" onkeypress="return isTag(event);" onchange="return IncrmntConfrmCounterWrkExp();" onkeydown="return isNumber(event);" onblur="NumChecking('cphMain_txtSalaryWrkExp');" MaxLength="16" Height="30px" Style="height: 30px; width: 50%; resize: none; text-transform: uppercase; font-family: calibri; margin-right: 5%;"></asp:TextBox>--%>

                    <asp:TextBox ID="txtSalaryWrkExp" class="form1" runat="server" onkeypress="return isTag(event);" onchange="return IncrmntConfrmCounterWrkExp();" MaxLength="49" Height="30px" Style="height: 30px; width: 50%; resize: none; text-transform: uppercase; font-family: calibri; margin-right: 5%;"></asp:TextBox>

                </div>
                <div class="eachform" style="float: right">
                    <h2>Address of last Employer*</h2>
                    <asp:TextBox ID="txtAddressOfEmployerWrkExp" class="form1" onkeypress="return isTagWithEnter(event);" onkeydown="textCounter(cphMain_txtAddressOfEmployerWrkExp, 499);" onblur="textCounter(cphMain_txtAddressOfEmployerWrkExp, 499);" onchange="return IncrmntConfrmCounterWrkExp();" runat="server" TextMode="MultiLine" MaxLength="499" Width="50%" Height="81px" Style="text-transform: uppercase;height: 81px; width: 50%; resize: none; font-family: calibri; margin-right: 5%;"></asp:TextBox>
                    <%--//emp17--%>
                </div>
                ...
                <div class="eachform" style="margin-top: 2%; margin-left: 17%;">
                    <div class="subform" style="width: 448px;">
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnUpdateWrkExp" runat="server" Style="display: none;" class="save" Text="Update" OnClick="btnUpdateWrkExp_Click" OnClientClick="return ValidateWrkExp(this.id); " />
                            <asp:Button ID="btnAddWrkExp" runat="server" class="save" Text="Save" OnClientClick="return ValidateWrkExp(this.id);" />
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="eachform" style="float: right;">
                            ...
                            <asp:DropDownList ID="ddlEduQualification" class="form1" onchange="return QualificationDdlChange();" onkeypress="return isTag(event)" runat="server" Style="height: 30px; width: 55%; text-align: left; margin-right: 3%;">
                                <asp:ListItem Value="--Select Course--" Text="--Select Course--"></asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="eachform" style="margin-top: 2%; margin-left: 29%;">
                    <div class="subform" style="width: 448px; margin-left: 11%">
                        <div class="form-group">
                            ...
                            <asp:Button ID="BtnUpdateEdu" runat="server" Style="display: none;" class="save" Text="Update" OnClick="btnUpdateEdu_Click" OnClientClick="return ValidateEdu(this.id); " />
                            <%--<asp:Button ID="BtnAddEdu" runat="server" class="save" Text="Save" OnClick="btnAddEdu_Click" OnClientClick="return ValidateEdu();" />--%>
                            <asp:Button ID="BtnAddEdu" runat="server" class="save" Text="Save" OnClientClick="return ValidateEdu(this.id);" />
            ...
            <asp:HiddenField ID="Hiddenddlselect" runat="server" />
             <asp:HiddenField ID="HiddenddlQualificationSelectVal" runat="server" />
            <script>
                function QualificationDdlChange() {
                    IncrmntConfrmCounterEdu();
                    var ddlQualValue = document.getElementById("<%=ddlEduQualification.ClientID%>").value;
                    if (ddlQualValue != "--Select Course--" || ddlQualValue != "0" || ddlQualValue != "") {
                        document.getElementById("<%=HiddenddlQualificationSelectVal.ClientID%>").value = ddlQualValue;
                    }
                    else {
                        document.getElementById("<%=HiddenddlQualificationSelectVal.ClientID%>").value = 0;
                    }
                ...
                function SuccessUpdationEdu() {
                    ...
                    function updateEduDtlById(Id, CandID) {
                        ...
                        document.getElementById("<%=ddlEduQualification.ClientID%>").value = "--Select Course--";
                        document.getElementById("<%=ddlEduType.ClientID%>").value = 0;
                        var Details = PageMethods.ReadEduDtlById(Id, CandID, function (response) {
                            if (response.EduType != "") {
                                ...
                                document.getElementById("<%=Hiddenddlselect.ClientID%>").value ="";
                            ...
                            //       }
                            //   }
                            document.getElementById("<%=HiddenddlQualificationSelectVal.ClientID%>").value = response.CourseID;

                            setTimeout(QualfctnLoad(response.CourseID), 50);
                        ...
                        $noC(Window).scrollTop(0);    //15emp17
                        return false;
                    }
                    ...
                    function deleteEduDtlById(Id, CandID) {
                        ...
                        if (confirm("Do you want to cancel this Entry?")) {
                            var Details = PageMethods.deleteEduById(Id, CandID, function (response) {
                                ...
                                SuccessDeletionEdu();
                                table=    $p('#ReportTableEdu').DataTable({       //15emp17
                                    "pagingType": "full_numbers",
                                    "bSort": true
                            ...
                            table=     $ds('#ReportTableEdu').DataTable({
                                "pagingType": "full_numbers",
                                "bSort": true
                    ...
                    function readEduList() {                       
                        var CandID = document.getElementById("<%=HiddenCandidateId.ClientID%>").value;                       
                     //   table.destroy();
                            var Details = PageMethods.ReadEduList(CandID, function (response) {
                                document.getElementById("cphMain_divListEdu").innerHTML = response.strEduList;
...

            {
                if (year == "--YEAR--") {
                    ...
                    document.getElementById("<%=lblMessageAreaEdu.ClientID%>").innerHTML = "Enter year";
                        ...
                        //percentage
                        var percentage = document.getElementById("<%=txtEduPercentage.ClientID%>").value.trim();
                        document.getElementById("<%=txtEduPercentage.ClientID%>").style.borderColor = "";
                        if (percentage != "") {
                            if (parseFloat(percentage) > 100 || isNaN(percentage)) {
                                document.getElementById("<%=txtEduPercentage.ClientID%>").style.borderColor = "Red";
                                ret = false;
                            }
                        }
                        //Course
                        document.getElementById("<%=ddlEduQualification.ClientID%>").style.borderColor = "";
                        if (Course == "--Select Course--" || Course == "" || Course == "0") {
                            document.getElementById('divMessageAreaEdu').style.display = "";
                            document.getElementById('imgMessageAreaEdu').src = "/Images/Icons/imgMsgAreaWarning.png";
                            ...
                            document.getElementById("<%=HiddenddlQualificationSelectVal.ClientID%>").value=document.getElementById("<%=ddlEduQualification.ClientID%>").value;
                        }
                        ...
                        if (ret == true && ButtonId == 'cphMain_BtnAddEdu') {
                        ...
                        var EduType = cphMain_ddlEduType.options[cphMain_ddlEduType.selectedIndex].value;
                        var EduQualification = cphMain_ddlEduQualification.options[cphMain_ddlEduQualification.selectedIndex].value;
                        var EduSpecialization = document.getElementById("<%=txtEduSpecialization.ClientID%>").value;
                        var EduInstite = document.getElementById("<%=txtEduInstite.ClientID%>").value;
                        var EduPercentage = document.getElementById("<%=txtEduPercentage.ClientID%>").value;
                        var MonthEdu = document.getElementById("<%=ddlMonthEdu.ClientID%>").value;
                        var YearEdu = document.getElementById("<%=ddlYearEdu.ClientID%>").value;
                        var EduDegree = document.getElementById("<%=txtEduDegree.ClientID%>").value;
                        var startDate = "";
                                ...
                                objData.EduType = EduType;
                                objData.EduQualification = EduQualification;
                                objData.EduSpecialization = EduSpecialization;
                                objData.EduInstite = EduInstite;
                                objData.EduPercentage = EduPercentage;
                                objData.MonthEdu = MonthEdu;
                                objData.YearEdu = YearEdu;
                                objData.EduDegree = EduDegree;
                                ...
                                if (strId != "") {
                                    $.ajax({
                                        ...
                                        async: false,
                                        contentType: "application/json; charset=utf-8",
                                        url: "gen_Candidate_Personal_Informn.aspx/AddEducation",
                                        data: JSON.stringify(objData),
                                        dataType: "json",
                                        success: function (data) {
                                            if (data.d != "") {
                                                document.getElementById("cphMain_divListEdu").innerHTML = data.d;
                                                SuccessConfirmationEdu();
                                            }
                                        }
                                    });
                                }
                ...
                <div class="eachform" style="margin-top: 2%; margin-left: 29%;">
                    <div class="subform" style="width: 448px; float: left; margin-left: 10.8%;">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="BtnLangUpdate" runat="server" Style="display: none;" class="save" Text="Update" OnClick="btnUpdLang_Click" OnClientClick="return ValidateLang(this.id); " />
                            <%--<asp:Button ID="BtnLangAdd" runat="server" class="save" Text="Save" OnClick="btnAddLang_Click" OnClientClick="return ValidateLang();" />--%>
                            <asp:Button ID="BtnLangAdd" runat="server" class="save" Text="Save"  OnClientClick="return ValidateLang(this.id);" />
...
function readLangList() {
    ...
    var CandID = document.getElementById("<%=HiddenCandidateId.ClientID%>").value;
    var Details = PageMethods.ReadLangList(CandID, function (response) {
...
function ValidateLang(ButtonId) {
    var ret = true;
    ...
    if (ret == true && ButtonId == 'cphMain_BtnLangAdd') {
        var User_Id = '<%= Session["USERID"] %>';
        var strOrgIdID = '<%=Session["ORGID"]%>';
        var strCorpID = '<%=Session["CORPOFFICEID"]%>';
        ...
        var LangId = cphMain_ddlQuLang.options[cphMain_ddlQuLang.selectedIndex].value;
        var LangWrt = 0, LangRead = 0, LangSpk = 0, LangMotherTongue = 0;

        if (document.getElementById("<%=CbxLangWrt.ClientID%>").checked == true) {
            LangWrt = 1;
        }
        if (document.getElementById("<%=CbxLangRead.ClientID%>").checked == true) {
            LangRead = 1;
        }
        if (document.getElementById("<%=CbxLangSpk.ClientID%>").checked == true) {
            LangSpk = 1;
        }
        if (document.getElementById("<%=cbxLangMotherTongue.ClientID%>").checked == true) {
            LangMotherTongue = 1;
        }
        ...
        objData.LangId = LangId;
        objData.LangWrt = LangWrt;
        objData.LangRead = LangRead;
        objData.LangSpk = LangSpk;
        objData.LangMotherTongue = LangMotherTongue;
        ...
        if (strId != "") {
            $.ajax({
                ...
                async: false,
                contentType: "application/json; charset=utf-8",
                url: "gen_Candidate_Personal_Informn.aspx/SaveLangDtls",
                data: JSON.stringify(objData),
                dataType: "json",
                success: function (data) {
                    if (data.d != "") {
                        document.getElementById("cphMain_divListLang").innerHTML = data.d;
                        SuccessConfirmationLang();
                    }
                }
            });
        }
    ...
    <script>
        ...
        function BssicInfoValidation(Mode) {
            ...
            $noCon("div#divNationality input.ui-autocomplete-input").css("borderColor", "");
            ...
            var Localcontact = document.getElementById("<%=txtloccontact.ClientID%>").value.trim();
               ...
               if (document.getElementById("<%=HiddenStaffHR.ClientID%>").value == "HR") {
                // alert(document.getElementById("<%=HiddenStaffHR.ClientID%>").value);
                   ...
                   if (country == "--SELECT NATIONALITY--") {
                       ...
                       $noCon("div#divNationality input.ui-autocomplete-input").css("borderColor", "red");
                    ...
                    if (LocalContact.length != 0) {
                        if (!mobileregular.test(LocalContact)) {
                            document.getElementById("<%=txtloccontact.ClientID%>").focus();
                           ...
                           document.getElementById('imgMessageAreaMain').src = "/Images/Icons/imgMsgAreaWarning.png";
                           document.getElementById("<%=LblMessageAreaMain.ClientID%>").innerHTML = "Some of the information you entered is not correct or missing. Please check the highlighted fields below.";
                           document.getElementById('ErrorMsgUsrLocalContact').style.display = "";
                           ret = false;
                       }
                    }
                   if (LastName == "") {
    ...
    <script>
        ...
        function ImigClear() {
            ...
            document.getElementById("<%=Ddlvisatype.ClientID%>").focus();
            document.getElementById("<%=Ddlvisatype.ClientID%>").selectedIndex = 0;
    ...
    <script>
        ...
        function ClearDivDisplayImage() {
            ...
            var hidnImageSize = document.getElementById("<%=hiddenPermitFileSize.ClientID%>").value;
                ...
                if (size > hidnImageSize) {
                    ...
                    document.getElementById("<%=lblNoSelectedFile.ClientID%>").textContent = "No File Selected";
                    alert(" Sorry Maximum file size exceeds. Please Upload Image of size less than " + convertToKb + "KB !.");
                    //return false;
                }
                else {

                    if (document.getElementById("<%=FileUploadImage.ClientID%>").value != "") {
                        document.getElementById("<%=lblNoSelectedFile.ClientID%>").textContent = document.getElementById("<%=FileUploadImage.ClientID%>").value;
                         document.getElementById("<%=divImageDisplay.ClientID%>").innerHTML = "";
                         document.getElementById("<%=hiddenImageFileDeleted.ClientID%>").value = document.getElementById("<%=hiddenImageFile.ClientID%>").value;
                         document.getElementById("<%=hiddenImageFile.ClientID%>").value = "";
                     }
        ...
        function ClearImage() {
            if (document.getElementById("<%=hiddenImageFile.ClientID%>").value != "" || document.getElementById("<%=FileUploadImage.ClientID%>").value != "") {
    ...
    <script>
        ...
        (function ($au) {
            $au(function () {
                ...
                $au('#cphMain_ddlNationality').selectToAutocomplete1Letter();

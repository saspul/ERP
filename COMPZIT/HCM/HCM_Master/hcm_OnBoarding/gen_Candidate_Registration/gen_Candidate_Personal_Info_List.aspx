<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_Candidate_Personal_Info_List.aspx.cs" Inherits="Master_gen_Emply_Personal_Informn_gen_Emp_Personal_Info_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:HiddenField ID="hiddenCorpImgPath" runat="server" />
    ...
    <div class="cont_rght" >
         ...
         <a id="divPrint" href="#" onclick="return PrintPdf('BlankMode')" runat="server" target="_blank" style="font-family: Calibri;float: right; margin-top: 0%; margin-left: 0%; width: 20%;" >Download Joining Form</a>
        <br />


        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
              <img src="/Images/BigIcons/user regn.png" style="vertical-align: middle;" /> Candidate Registration
        </div>
           <%--0006 start--%>
        <div class="eachform" style="width: 22%;margin-top: 2%;display:none;">
            ...
            <div class="eachform" style="width:25%; margin-bottom: 1.2%;display:none;">               
                ...
                <div class="eachform" style="width:25%;display:none;">
                             <asp:Button ID="btnSearch" style="display:none;pointer;margin-top: -0.4%;" runat="server" class="searchlist_btn_lft" Text="Search" OnClick="btnSearch_Click" OnClientClick="return InsertToSearchField();"  />
                     </div>
        <%--stop 0006--%>
        <br />

       <div onclick="location.href='gen_Candidate_Personal_Informn.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;display:block">

...
public partial class HCM_HCM_Master_hcm_PayrollSystem_hcm_Monthly_Attendance_Sheet_hcm_Monthly_Attendance_Sheet_View : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string ShowAmendmentDtls(string id, string orgID, string corptID)
    {
        string strHtml = "";
        clsBusinessLayerEmployeeDailyWorkHour objBusinessEmpDailyWorkHour = new clsBusinessLayerEmployeeDailyWorkHour();
        clsEntityEmployeeDailyWorkHour objEntityEmpDailyWorkHour = new clsEntityEmployeeDailyWorkHour();
        ...
        objEntityEmpDailyWorkHour.CorpId = Convert.ToInt32(corptID);
        DataTable dt = objBusinessEmpDailyWorkHour.readAmenmentDtl(objEntityEmpDailyWorkHour);
        if (dt.Rows.Count > 0)
        {
             strHtml+="<table id=\"TableWrkshtdtlsAmnt\" class=\"table table-striped table-bordered\" style=\"font-family:Calibri;\"  width=\"100%\">";
             strHtml+="<thead><tr>";  
             strHtml+="<th data-class=\"expand\" style=\"width: 10%\">Employee Code</th>";
             strHtml+="<th data-class=\"expand\" style=\"width: 15%\">Employee</th>";
             strHtml+="<th data-class=\"expand\" style=\"width: 10%\">Designation</th>";   
             strHtml+="<th data-class=\"expand\" style=\"width: 10%\">Project Ref#</th>"; 
             strHtml+="<th data-class=\"expand\" style=\"width: 5%\">Attendance</th>";
             strHtml+="<th data-class=\"expand\" style=\"width: 5%\">O.T</th>"; 
             strHtml+="<th data-class=\"expand\" style=\"width: 5%\">Idle Hour</th>"; 
             strHtml+="<th data-class=\"expand\" style=\"width: 5%\">Final O.T</th>"; 
             strHtml+="<th data-class=\"expand\" style=\"width: 5%\">Rounded O.T</th>"; 
             strHtml+="<th data-class=\"expand\" style=\"width: 25%\">Remarks</th>";
             strHtml+="</tr></thead>";
             strHtml+="<tbody> ";
             strHtml+="<tr> ";            
             strHtml += "<td  class=\"expand\">"+dt.Rows[0]["USR_CODE"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\">"+dt.Rows[0]["EMPLOYEE_NAME"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\"> "+dt.Rows[0]["DESIGNATION"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\">"+dt.Rows[0]["PROJECTS_INTER_REF"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\"> "+dt.Rows[0]["ATTENDANCE"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\"> "+dt.Rows[0]["EMDLHRDTL_OT"].ToString()+"</td>";
             strHtml += "<td  class=\"expand\"> "+dt.Rows[0]["EMDLHRDTL_IDLE_HOUR"].ToString()+"</td>";                  
             string FinalOTstr = "";
             Decimal idlHr = Convert.ToDecimal(dt.Rows[0]["EMDLHRDTL_IDLE_HOUR"].ToString());
             if (dt.Rows[0]["EMDLHRDTL_OT"].ToString() != "")
             {
               Decimal OTdec = Convert.ToDecimal(dt.Rows[0]["EMDLHRDTL_OT"].ToString());
               if (idlHr >= OTdec)
               {
                 FinalOTstr = "0";
               }
            ...
            strHtml += "<td  class=\"expand\">"+FinalOTstr+"</td>";
            strHtml += "<td  class=\"expand\">"+dt.Rows[0]["EMDLHRDTL_RNDED_OT"].ToString()+"</td>";
            strHtml += "<td  class=\"expand\"> "+dt.Rows[0]["EMDLHRDTL_REMARKS"].ToString()+"</td>";
            strHtml+="</tr>"; 
            strHtml+="</tbody>"; 
            strHtml+="</table>";
        }

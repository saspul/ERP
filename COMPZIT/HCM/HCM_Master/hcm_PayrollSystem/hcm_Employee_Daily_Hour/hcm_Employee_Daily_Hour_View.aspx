<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageNewHcm.master" AutoEventWireup="true" CodeFile="hcm_Employee_Daily_Hour_View.aspx.cs" Inherits="HCM_HCM_Master_hcm_PayrollSystem_hcm_Employee_Daily_Hour_hcm_Employee_Daily_Hour_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
   ...
   <div id="divMessageArea" style="display: none">
    ...
    <div class="cont_rght" >
        ...
        <div onclick="location.href='hcm_Employee_Daily_Hour_List.aspx'" id="divList" class="list" runat="server" style=" position: fixed; height:26.5px; right:1%;top:30%;">
...
<tr >
    ...
    <th data-class="expand">Remarks</th>
        ...
        <footer style="background: white;font-family:Calibri;font-size:14px;">
            ...
            <asp:Button ID="btnCancel" runat="server" Style="float: left;margin-top:0.5%;margin-left:1%;" class="btn btn-primary" OnClientClick="  $nooC('#dialog_simple').dialog('close');" Text="Cancel" />
       ...
       <script type="text/javascript">
           ...
           $nooC(function () {
               $nooC('#dialog_simple').dialog({
                   ...
                   resizable: false,
                   modal: true,
                   title: "View Daily Attendance Sheet",
                   position: 'top',
               });
           ...
           function ConfirmCancel() {
               CancelAlert("hcm_Employee_Daily_Hour_View.aspx");
               return false;
           }
    ...
    border-bottom-color: #c8b6b6;
          ...
          #datatable_fixed_column_wrapper,#TableWrkshtdtls_wrapper{
                ...
                if (e == true) {
                    ...
                    var Details = PageMethods.ConfirmDtls(Id, orgID, corptID, userID,strMODE,tableSts, function (response) {
                        ...
                        /*    $nooC('#dialog_simple').dialog('close');
                            ...
                            window.location.href = "hcm_Employee_Daily_Hour_View.aspx?InsUpd=" + strMODE;

                          /*  var delayInMilliseconds = 1000; //1 second
                            setTimeout(function () {
                                window.location.href = "hcm_Employee_Daily_Hour_View.aspx";
                            }, delayInMilliseconds);*/
                        }
                            ...
                            //error
                            $nooC('#dialog_simple').dialog('close');
                            $nooC("#warning-alert").html("Daily attendance sheet already confirmed");
                            $nooC("#warning-alert").fadeTo(9000, 500).slideUp(500, function () {
                            });
                            $nooC("#warning-alert").alert();
                        }

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageNewHcm.master" AutoEventWireup="true" CodeFile="hcm_Employee_Daily_Hour.aspx.cs" Inherits="HCM_HCM_Master_hcm_PayrollSystem_hcm_Employee_Daily_Hour_hcm_Employee_Daily_Hour" %>
           ...
           function ConfirmCancelUpld() {
               if (confirmbox > 0) {
                   if (confirm("Are you sure you want to cancel this page?")) {
                       window.location.href = "hcm_Employee_Daily_Hour_List.aspx";
 ...
 <script type="text/javascript" src="Scripts/ui.progressbar.js"></script>  
    ...
    <script type="text/javascript">
        ...
        function SuccessUpdation() {
            document.getElementById('divErrorTotal').style.visibility = "visible";
            document.getElementById("<%=lblErrorTotal.ClientID%>").innerHTML = "Daily attendance sheet updated as per the document";
        ...
        function ViewMissingProductCode() {
            ...
            if (ErrorCount == '0' && IncorrectEmpCodeCount == '0' && IncorrectOTCount == '0' && IncorrectRemarksCount == '0' && AlreadyConfirmedCount == '0' && IncorrectProjectCodeCount == '0') {
        ...
        function ClosModalView() {
            ...
            for (var key in jsonAtt) {
                ...
                var JobList = jsonAtt[key].JOBNUM;
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
   ...
   <%--      evm-0027--%>
           ...
           <asp:HiddenField ID="HiddenFieldInsTableSts" runat="server" Value="0"/>
 ...
 <asp:HiddenField ID="HiddenTotalErrorEmp" runat="server" value="0"/>
        ...
        <div id="divReportCaption" style="margin-top: 1%;font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
           <a id="a_Caption" style="margin-left:1%;color: rgb(83, 101, 51);" >Daily Attendance Sheet</a>
        </div>
            <br />
            <br />
               ...
               <div class="eachform" style="float:left;width:50%;margin-left:1%;">
               ...
               <div id="divDate"  style="float:right;width: 33%;">
                      ...
                      <input id="txtefctvedate" name="txtefctvedate" type="text" class="Tabletxt form-control datepicker"  data-dateformat="dd-mm-yyyy" placeholder="dd-mm-yyyy" maxlength="50" onchange="show()" style="width:77%;margin-left:-5%;" onkeypress="return DisableEnter(event);" onkeydown="return DisableEnter(event);" />
                          ...
                          <div class="eachform" id="DeptDiv" style="float: left; width: 80%;margin-left:1%;">
            ...
            <div id="divFileUploader" class="eachform" style="height: 40px;margin-top:0.5%;">
               ...
               <asp:Label ID="Label1" runat="server" Text="No File selected" Style="font-family: Calibri; font-size: medium;"></asp:Label>
                ...
                <a href="/CustomFiles/csvTemplate/Daily attendance with header.csv">  <img src="../../../../Images/Icons/CSV.PNG" title="Sample CSV File" style="margin-left: 1%;" /></a>
...
<div style="width:30%;margin:auto;float:left">
            ...
            <div id="divReportLastWorkSheet" class="table-responsive" runat="server">
            ...
            <div id="div2" class="eachform" "  >
               ...
               <div id="divNote" class="eachform" style="padding-left:1%; color: red; font-family:Calibri; display:none">
                 <asp:Label ID="lblNote" runat="server" Text="Note: Required CSV File Must Contain Employee Code, Project Code And Attendance Fields."></asp:Label> 
                   </div>

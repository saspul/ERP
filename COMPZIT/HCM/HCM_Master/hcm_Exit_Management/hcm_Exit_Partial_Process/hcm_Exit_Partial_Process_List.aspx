<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_Exit_Partial_Process_List.aspx.cs" Inherits="HCM_HCM_Master_hcm_Exit_Management_hcm_Exit_Partial_Process_hcm_Exit_Partial_Process_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        (function ($au) {
            $au(function () {
                $au('#cphMain_ddlDesig').selectToAutocomplete1Letter();
    ...
    <script>
        ...
        function SearchValidation() {
            var fromDate = document.getElementById("<%=txtAssgndDate.ClientID%>").value;
        ...
        function JobDescrpId(id, UserID) {
           
            var nWindow = window.open('/HCM/HCM_Master/hcm_Exit_Management/hcm_Exit_Partial_Process/hcm_Exit_Partial_Process.aspx?Id=' + id + '&RFGP=VW&Usr=' + UserID + '', 'PoP_Up', 'width=1200,height=500,left=70,top=100,directories=no,navigationbar=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,resizable=yes,scrollbars=yes');
            // nWindow.focus();
        }
    </script>
...
<asp:ScriptManager ID="ScriptManager1" EnablePageMethods="true" runat="server">
    ...
    <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/ExitPartialProcess.png" style="vertical-align: middle;" />
     Exit Partial Process
        </div >

        <div style="border:.5px solid #9ba48b; background-color: #f3f3f3;width: 98%;margin-top:2%;padding: 1%;float: left;">
              <div id="DivCGuarantee" class="eachform" style="margin-top:30PX;width: 25%;float: left;">  <%--  EMP25--%>
         <h2 style="padding-top: 1%;">Designation : </h2>
        <asp:DropDownList ID="ddlDesig" class="form1" runat="server" Style="height: 28px; width: 54%; float: left; margin-left: 7%;" onkeypress="return DisableEnter(event)">
           </asp:DropDownList>
        </div>
            <div style="float: left;width: 45%;border: .5px solid #9ba48b;margin-left: 2%;">

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="hcm_Notice_Period_List.aspx.cs" Inherits="HCM_HCM_Master_hcm_Exit_Management_hcm_Notice_Period_hcm_Notice_Period_List" %>
 ...
 <style>
      ...
      <script type="text/javascript">
          ...
          function CloseCancelView() {
              if (confirm("Do you want to close  without completing cancellation process?")) {
                  ...
                  document.getElementById("<%=txtCnclReason.ClientID%>").value = "";//evm-0023 clear txtCnclReason
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Notice period cancelled successfully.";
        }
       
        function SuccessStatusChange() {
            document.getElementById('divMessageArea').style.display = "";
            document.getElementById('imgMessageArea').src = "/Images/Icons/imgMsgAreaInfo.png";
            document.getElementById("<%=lblMessageArea.ClientID%>").innerHTML = "Notice period status changed successfully.";
        }
   ...
   <%--  for giving pagination to the html table--%>
    ...
    <script>
        ...
        function ValidateCancelReason() {
         ...
         function ChangeStatus(CatId, CatStatus) {
             if (confirm("Do you want to change the status of this entry?")) {
                 ...
                 var EmpId = document.getElementById("<%=HiddenFieldUserId.ClientID%>").value;         
                 var Details = PageMethods.ChangeSponsorStatus(CatId, CatStatus,EmpId, function (response) {
                     var SucessDetails = response;

                     if (SucessDetails == "success") {
                       
                             window.location = 'hcm_Notice_Period_List.aspx?InsUpd=StsCh';
                     }
                     else {
                         window.location = 'hcm_Notice_Period_List.aspx?InsUpd=Error';
                     }
                 });
             }
             else {
        ...
        function CancelNotAlert() {
            alert("Sorry, cancellation denied. This entry is already selected somewhere !");
            return false;
   ...
   <div id="divMessageArea" style="display: none;width:91%;">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri;">
            <img src="/Images/BigIcons/Notice Period assign.png" style="vertical-align: middle;" />
   Notice Period
        </div >
        
          <div style="border:.5px solid;border-color: #9ba48b;background-color: #f3f3f3;width: 93.5%;margin-top:0.5%;height:10%;">
        <div class="eachform" style="width: 25%;margin-top: 2%;">

                <h2 style="margin-top:1%;margin-left:8%;">Status*</h2>
            ...
            <div class="eachform" style="width:30%; margin-bottom: 1.4%;">               
                ...
                <div class="eachform" style="width:11%;margin-left: 30%;margin-bottom: 0.5%;">
        ...
        <div onclick="location.href='hcm_Notice_Period.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Notice Period</h3>
                    </div>

...
public partial class MasterPage_MasterPageCompzitFinance : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //change framework
            //objEntityLogin.FrameworkId = 2;
            //objEntityLogin.FrameworkTypId = 1;
            ...
            if (Session["DSGN_CONTROL"] != null)
            {
                ...
                if (Session["DSGN_CONTROL"].ToString() == "C" || Session["DSGN_CONTROL"].ToString() == "c")
                {
                    ...
                    {
                        strHtm = objbusinessLayerLogin.ReadAcsBussnssUnit_Usr(objEntLoginOControl, "/Home/Compzit_Home/Compzit_Home_Finance.aspx");
                    }
                    else
                    {

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Sales.master" AutoEventWireup="true" CodeFile="gen_ChangePassword_Sales.aspx.cs" Inherits="Security_gen_ChangePassword_Sales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="cont_rght">
        ...
        <div class="fillform">
            ...
            <div class="eachform" style="margin-left: 82%;width:50%">
                <h2>Show Password</h2>
            ...
            <div class="eachform">
                <div class="subform">
                    ...
                    <asp:Button ID="btnCancel" runat="server" class="save" Text="Cancel" PostBackUrl="/Home/Compzit_Home/Compzit_Home_Sales_Executive.aspx" />

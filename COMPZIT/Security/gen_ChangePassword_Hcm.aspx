<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_ChangePassword_Hcm.aspx.cs" Inherits="Security_gen_ChangePassword_Hcm" %>
        ...
        <div class="fillform">
            ...
            <div class="eachform">
                <div class="subform">
                    ...
                    <asp:Button ID="btnCancel" runat="server" class="save" Text="Cancel" PostBackUrl="/Home/Compzit_Home/Compzit_Home_Hcm.aspx" />

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Product_MasterList.aspx.cs" Inherits="Master_gen_Product_Master_gen_Product_MasterList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            $("#success-alert").html("Product cancelled successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
        }
    ...
    <script>
        ...
        function OpenCancelView(StrId) {
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this product?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
        ...
        function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_Product_MasterList.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_Product_MasterList.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Product status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        function AlreadySts() {
            $("#divWarning").html("Sorry, This product status is already changed!");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
   ...
   <asp:HiddenField ID="HiddenFieldCnclSts" runat="server" />
    ...
    <div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">PRODUCT MASTER</h1>

        <div class="form-group fg2 sa_480" id="divUnit">
...
<!-------working area_closed---->
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Product_Master.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
 ...
 <script>
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this product?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId,corptID, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_Product_MasterList.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_Product_MasterList.aspx?InsUpd=AlCncl';
                         }
                         else if (SucessDetails == "AlSts") {
                             window.location = 'gen_Product_MasterList.aspx?InsUpd=AlSts';
                         }
                         else {
                             window.location = 'gen_Product_MasterList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             $.ajax({
                 ...
                 async: false,
                 contentType: "application/json; charset=utf-8",
                 url: "gen_Product_MasterList.aspx/PrintList",
                 data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",Status: "' + Status + '",CnclSts: "' + CnclSts + '",Divs: "' + Divs + '",divText: "' + divText + '"}',
                 dataType: "json",
                 success: function (data) {
                     if (data.d != "") {
     ...
     <script>
         ...
         $(document).ready(function () {
             ...
             document.getElementById("<%=HiddenFieldDivision.ClientID%>").value = document.getElementById("<%=ddlDivisionSearch.ClientID%>").value;
             document.getElementById("<%=HiddenFieldTypeText.ClientID%>").value = $("#cphMain_ddlDivisionSearch option:selected").text();
             Load_dt();
             getdata(1);
         ...
         function Load_dt() {
             ...
             var url = "gen_Product_MasterList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_Product_MasterList.aspx/GetData";
             var objData = {};

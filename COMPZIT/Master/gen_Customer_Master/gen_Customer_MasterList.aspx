<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Customer_MasterList.aspx.cs" Inherits="Master_gen_Customer_Master_gen_Customer_MasterList" %>
    ...
    <link rel="stylesheet" type="text/css" href="/css/New css/hcm_ns.css"/>
     ...
     <script type="text/javascript">
         ...
         function SuccessCancelation() {
             $("#success-alert").html("Customer details cancelled successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
         }
         ...
         function OpenCancelView(StrId) {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to cancel this Customer?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
        ...
        function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_Customer_MasterList.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_Customer_MasterList.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Customer status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
	...
	<div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">CUSTOMER MASTER</h1>

        <div class="form-group fg2 sa_fg1" id="divcus">
          <label for="email" class="fg2_la1">Customer Type:<span class="spn1"></span></label>
          <select class="form-control fg2_inp1" id="ddlCustomerType" runat="server">
...
<a href="gen_Customer_Master.aspx" type="button" onclick="topFunction()" id="myBtn" title="Add New">
<i class="fa fa-plus-circle"></i>
    ...
    <!---new--->
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_Customer_MasterList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var custype = 0;
             if (document.getElementById("<%=ddlCustomerType.ClientID%>").value != "--SELECT TYPE--") {
                  custype = document.getElementById("<%=ddlCustomerType.ClientID%>").value;
             }
             //alert(custype);
     ...
     //END
        ...
        function ChangeStatus(StrId, stsmode, cnclusrId) {
            ...
            if (cnclusrId == "0") {
             ...
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this Customer?",
                 alertType: "info"
             }).done(function (e) {
                 ...
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, orgID, corptID, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             ...
                             window.location = 'gen_Customer_MasterList.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_Customer_MasterList.aspx?InsUpd=AlCncl';
                         }
                         else {
                             window.location = 'gen_Customer_MasterList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
        ...
        function PrintClick() {
           ...
           // var CnclSts = document.getElementById("<%=HiddenFieldCnclSts.ClientID%>").value;
            ...
            if (document.getElementById("<%=cbxCnclStatus.ClientID%>").checked == true) {
             ...
             if (document.getElementById("<%=ddlCustomerType.ClientID%>").value != "--SELECT TYPE--") {
                 custype = document.getElementById("<%=ddlCustomerType.ClientID%>").value;
                 var cus = $("#cphMain_ddlCustomerType :selected").text();
             }
            if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                 ...
                 $.ajax({
                     ...
                     async: false,
                     contentType: "application/json; charset=utf-8",
                     url: "gen_Customer_MasterList.aspx/PrintList",
                     data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",Status: "' + strddlStatus + '",CnclSts: "' + strCancelStatus + '",custype:"' + custype + '",cus:"' + cus + '"}',
                     dataType: "json",
                     success: function (data) {
                         if (data.d != "") {
    ...
    <script>
        ...
        $au(function () {
            ...
            $("div#divcus input.ui-autocomplete-input").focus();

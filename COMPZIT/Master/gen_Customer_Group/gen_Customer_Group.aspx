<%@ Page Language="C#"  MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Customer_Group.aspx.cs" Inherits="Master_gen_Customer_Group_gen_Customer_Group" %>
 ...
 <link href="/css/New css/pro_mng.css" rel="stylesheet" />
         ...
         function ConfirmMessage() {
             if (confirmbox > 0) {
                 ezBSAlert({
                     ...
                     if (e == true) {
                         window.location.href = "gen_Customer_GroupList.aspx";
                         return false;
                     }
                     else {
                         return false;
         ...
         function AlertClearAll() {
             if (confirmbox > 0) {
                 ezBSAlert({
                     ...
                     if (e == true) {
                         window.location.href = "gen_Customer_Group.aspx";
                         return false;
                     }
                     else {
                         return false;
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            $("#divWarning").html("Duplication error!. Customer group can’t be duplicated.");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            document.getElementById("<%=txtCustmrGrpName.ClientID%>").style.borderColor = "Red";
        }
        ...
        function NameValidate() {
            ...
            // replacing < and > tags
            var NameWithoutReplace = document.getElementById("<%=txtCustmrGrpName.ClientID%>").value;
            var replaceText1 = NameWithoutReplace.replace(/</g, "");
            var replaceText2 = replaceText1.replace(/>/g, "");
            document.getElementById("<%=txtCustmrGrpName.ClientID%>").value = replaceText2;

            document.getElementById("<%=txtCustmrGrpName.ClientID%>").style.borderColor = "";
          

            var Name = document.getElementById("<%=txtCustmrGrpName.ClientID%>").value.trim();
            ...
            if (Name == "" ) {
                ...
                if (Name == "") {
                    ...
                    document.getElementById("<%=txtCustmrGrpName.ClientID%>").style.borderColor = "Red";
                    document.getElementById("<%=txtCustmrGrpName.ClientID%>").focus();
                    ret = false;
                }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="gen_Customer_GroupList.aspx">Customer Group</a></li>
        <li id="lblEntryB" runat="server" class="active">Add Customer Group</li>
      </ol>
   <div class="myAlert-top alert alert-success" id="success-alert">
    ...
    <div class="content_area_container cont_contr">
      ...
      <div class="content_box1 cont_contr" onmouseover="closesave()">
        <h2 id="lblEntry" runat="server">Add Customer Group</h2>

              <div class="form-group fg2 sa_fg1">
                <label for="email" class="fg2_la1">Customer Group:<span class="spn1">*</span></label>
                  <asp:TextBox autocomplete="off" ID="txtCustmrGrpName" placeholder="Customer Group" class="form-control fg2_inp1 inp_mst" runat="server" MaxLength="50" Style="text-transform: uppercase;"></asp:TextBox>
              </div>

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_App.master" AutoEventWireup="true" CodeFile="app_LicensePackList.aspx.cs" Inherits="Master_app_LicensePack_app_LicensePackList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold;color:rgb(83, 101, 51); font-family:Calibri">
                <img src="../../Images/BigIcons/01.png" style="vertical-align: middle;" />
            License Pack
        </div>
           <%--0006 start--%>
        ...
        <div onclick="location.href='app_LicensePack.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px;right:1%;" >
          <%--  <a href="app_LicensePack.aspx">

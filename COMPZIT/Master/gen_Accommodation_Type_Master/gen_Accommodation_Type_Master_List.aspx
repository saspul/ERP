<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Accommodation_Type_Master_List.aspx.cs" Inherits="Master_gen_Accommodation_Master_gen_Accommodation_Type_Master_List" %>
    ...
    <link rel="stylesheet" type="text/css" href="/css/New css/hcm_ns.css"/>
     <script type="text/javascript">
         function SuccessConfirmation() {
             $("#success-alert").html("Accommodation details inserted successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
         }
         function SuccessUpdation() {
             $("#success-alert").html("Accommodation details updated successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
         }
         function SuccessCancelation() {
             $("#success-alert").html("Accommodation address cancelled successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
         }
         ...
         function OpenCancelView(StrId) {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to cancel this Accommodaiton Type?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
        ...
        function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_Accommodation_Type_Master_List.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_Accommodation_Type_Master_List.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Accommodation status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function AlreadySts() {
            $("#divWarning").html("Sorry, This Accommodation status is already changed!");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
 ...
 <li><a href="/Home/Compzit_LandingPage/Compzit_LandingPage.aspx">Home</a></li>
      ...
      <li class="active">Accommodation Type</li>
    </ol>
...
<!---inner_content_sections area_started--->
          <h1 class="h1_con">Accommodation Type</h1>
...
<!----frame_closed section to footer script section--->
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Accommodation_Type_Master.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
...
<!----------------------------------------------Content_section_opened------------------------------------------------------------->
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ...
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this Accommodation Status?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, orgID, corptID, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_Accommodation_Type_Master_List.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_Accommodation_Type_Master_List.aspx?InsUpd=AlCncl';
                         }
                         else if (SucessDetails == "AlSts") {
                             window.location = 'gen_Accommodation_Type_Master_List.aspx?InsUpd=AlSts';
                         }
                         else {
                             window.location = 'gen_Accommodation_Type_Master_List.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             $.ajax({
                 ...
                 async: false,
                 contentType: "application/json; charset=utf-8",
                 url: "gen_Accommodation_Type_Master_List.aspx/PrintList",
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_Accommodation_Type_Master_List.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_Accommodation_Type_Master_List.aspx/GetData";
             var objData = {};

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_TermsTemplateList.aspx.cs" Inherits="Master_gen_TermsTemplate_gen_TermsTemplateList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            $("#success-alert").html("Template cancelled successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
        }
        ...
        function OpenCancelView(StrId) {
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this template?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
        ...
        function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_TermsTemplateList.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_TermsTemplateList.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Template status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        function AlreadySts() {
            $("#divWarning").html("Sorry, This template status is already changed!");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">   
   ...
   <asp:HiddenField ID="hiddenCancelPrimaryId" runat="server" />
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Terms Template</li>      
      </ol>
    ...
    <div class="myAlert-bottom alert alert-danger" id="divWarning">
     ...
     <div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">TERMS TEMPLATE</h1>
...
<!----frame_closed section to footer script section--->
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_TermsTemplate.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
 ...
 <script>
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this template?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_TermsTemplateList.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_TermsTemplateList.aspx?InsUpd=AlCncl';
                         }
                         else if (SucessDetails == "AlSts") {
                             window.location = 'gen_TermsTemplateList.aspx?InsUpd=AlSts';
                         }
                         else {
                             window.location = 'gen_TermsTemplateList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             $.ajax({
                 ...
                 async: false,
                 contentType: "application/json; charset=utf-8",
                 url: "gen_TermsTemplateList.aspx/PrintList",
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_TermsTemplateList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_TermsTemplateList.aspx/GetData";
             var objData = {};

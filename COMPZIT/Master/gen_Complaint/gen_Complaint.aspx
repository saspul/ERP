<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Complaint.aspx.cs" Inherits="Master_gen_Complaints_gen_ComplaintAdd" %>
 ...
 <link href="/css/New css/pro_mng.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            ...
            $("#divWarning").html("Duplication error!. Complaint can’t be duplicated.");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            document.getElementById("<%=txtComplaintDesc.ClientID%>").style.borderColor = "Red";
            document.getElementById("<%=txtComplaintDesc.ClientID%>").focus();
        }

        function SuccessConfirmation() {
            $("#success-alert").html("Complaint details inserted successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        }
        function SuccessUpdation() {
            $("#success-alert").html("Complaint details updated successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        }
        function Validate() {
            ...
            // replacing < and > tags
            var NameWithoutReplace = document.getElementById("<%=txtComplaintDesc.ClientID%>").value;
            var replaceText1 = NameWithoutReplace.replace(/</g, "");
            var replaceText2 = replaceText1.replace(/>/g, "");
            document.getElementById("<%=txtComplaintDesc.ClientID%>").value = replaceText2;

            document.getElementById("<%=txtComplaintDesc.ClientID%>").style.borderColor = "";
            document.getElementById("<%=txtPenalty.ClientID%>").style.borderColor = "";
            document.getElementById("<%=ddlCtgry.ClientID%>").style.borderColor = "";
            $("div#divBnk input.ui-autocomplete-input").css("borderColor", "");
            var Name = document.getElementById("<%=txtComplaintDesc.ClientID%>").value.trim();
            var DropdownCategory = document.getElementById("<%=ddlCtgry.ClientID%>");
            var SelectedValueCategory = DropdownCategory.value;

            if (Name == "" || SelectedValueCategory == "--SELECT CATEGORY--") {
                $("#divWarning").html("Some of the information you entered is not correct or missing. Please check the highlighted fields below.");
                $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
                });

                if (SelectedValueCategory == "--SELECT CATEGORY--") {
     ...
     <script>
         ...
         $au(function () {
             $au('#cphMain_ddlCtgry').selectToAutocomplete1Letter();
         });
    </script>
        ...
        function ConfirmMessage() {
            if (confirmbox > 0) {
                ezBSAlert({
                    ...
                    if (e == true) {
                        window.location.href = "gen_ComplaintList.aspx";
                        return false;
                    }
                    else {
                        return false;
        ...
        function AlertClearAll() {
            if (confirmbox > 0) {
                ezBSAlert({
                    ...
                    if (e == true) {
                        window.location.href = "gen_Complaint.aspx";
                        return false;
                    }
                    else {
                        return false;
    ...
    <script type="text/javascript" language="javascript">
        ...
        function BlurPenalty(obj) {
            var PenaltyWithoutReplace = document.getElementById(obj).value;
            var replaceText1 = PenaltyWithoutReplace.replace(/-/g, "");         
            document.getElementById(obj).value = replaceText1;

            var txtDiscVal = document.getElementById(obj).value;
            //  alert('txtDiscVal' + txtDiscVal);
            if (txtDiscVal == "") {
               ...
               // alert(FloatingValue);
                ...
                document.getElementById(obj).value = n;
            }
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
      ...
      <li><a href="gen_ComplaintList.aspx">Complaint Master</a></li>
        <li id="lblEntryB" runat="server" class="active">Add Complaint Master</li>
      </ol>
   <div class="myAlert-top alert alert-success" id="success-alert">
    ...
    <div class="content_area_container cont_contr">
      ...
      <div class="content_box1 cont_contr" onmouseover="closesave()">
        <h2 id="lblEntry" runat="server">Add Complaint Master</h2>         

        <div class="form-group fg2 tr_l sa_o_fg5 sa_480">
          <label for="email" class="fg2_la1">Complaint:<span class="spn1">*</span></label>
          <textarea id="txtComplaintDesc" runat="server" maxlength="200"  style="resize: none; text-transform: uppercase;" onkeydown="textCounter(cphMain_txtComplaintDesc,190)" onkeyup="textCounter(cphMain_txtComplaintDesc,190)" rows="3" cols="28" class="form-control flt_l fg2_inp1 inp_mst tx_100" placeholder="Complaint"></textarea>
        </div>

        <div class="form-group fg2 sa_o_fg5 sa_480" id="divBnk">
          <label for="email" class="fg2_la1">Category:<span class="spn1">*</span></label>
             <asp:DropDownList ID="ddlCtgry" class="form-control fg2_inp1 inp_mst" runat="server" ></asp:DropDownList>
                   
        </div>

        <div class="form-group fg2 sa_o_fg5 sa_480">
          <label for="email" class="fg2_la1">Penalty:<span class="spn1"></span></label>
          <input autocomplete="off" id="txtPenalty"  runat="server" maxlength="13"  onkeydown="return isNumber('cphMain_txtPenalty', event)" onblur="BlurPenalty('cphMain_txtPenalty');" type="text" class="form-control fg2_inp1 tr_r" placeholder="0.00">
        </div>

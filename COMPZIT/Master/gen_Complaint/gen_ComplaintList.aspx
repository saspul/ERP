<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_ComplaintList.aspx.cs" Inherits="Master_gen_Complaints_gen_ComplaintList" %>
    ...
    <link href="/css/New css/pro_mng.css" rel="stylesheet" />
         ...
         <script>
             ...
             function SuccessCancelation() {
                 $("#success-alert").html("Complaint cancelled successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
               
             }
             function SuccessRecall() {
                 $("#success-alert").html("Complaint details recalled successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
         }
             ...
             function OpenCancelView(StrId) {
                 ezBSAlert({
                     type: "confirm",
                     messageText: "Do you want to cancel this complaint?",
                     alertType: "info"
                 }).done(function (e) {
                     if (e == true) {
        ...
        function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_ComplaintList.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_ComplaintList.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Complaint status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function ReCallAlert(StrId) {
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to recall this complaint?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:HiddenField ID="HiddenFieldCnclRole" runat="server" Value="0" />
      <asp:HiddenField ID="HiddenFieldRecallRole" runat="server" Value="0" />
    ...
    <asp:HiddenField ID="HiddenFieldCnclSts" runat="server" />
     ...
     <ol class="breadcrumb">
        ...
        <li class="active">Complaint Master</li>
    ...
    <div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">Complaint Master</h1>
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Complaint.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
 ...
 <script>
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this complaint?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_ComplaintList.aspx?InsUpd=StsCh';
                         }
                         else {
                             window.location = 'gen_ComplaintList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
        ...
        if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
            $.ajax({
                ...
                async: false,
                contentType: "application/json; charset=utf-8",
                url: "gen_ComplaintList.aspx/PrintList",
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_ComplaintList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_ComplaintList.aspx/GetData";
             var objData = {};
             ...
             objData.EnableRecall = document.getElementById("<%=HiddenFieldRecallRole.ClientID%>").value;

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit_Min.master" AutoEventWireup="true" CodeFile="gen_Org_Parking_RegOld.aspx.cs" Inherits="Master_gen_Org_Parking_gen_Org_Parking_Reg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function OrgParkingNullValidation() {
            ...
            var OrgName = document.getElementById("<%=txtOrgName.ClientID%>").value;

            var OrgAdd = document.getElementById("<%=txtOrgAdd1.ClientID%>").value;

            var OrgMobile = document.getElementById("<%=txtOrgMobile.ClientID%>").value;
            var mobileregular = /^(\+91-|\+91|0)?\d{10,50}$/;

            var EmailAdd = document.getElementById("<%=txtOrgEmail.ClientID%>").text;
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="cont_rght">
        ...
        <div id="divWait" runat="server">
            <asp:Label ID="Label1" runat="server"> Please do not Refresh the Page while Registration is on Process  </asp:Label>
        ...
        <div class="fillform">
            ...
            <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
                <img src="../../Images/BigIcons/organisation regn.png" style="vertical-align: middle;" />
            ...
            <table class="eachform">
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 30%;">
                        ...
                        <p class="error" id="ErrorMsgOrgWebsite" style="visibility: hidden">Please fill this out</p>
                    </td>
 ...
 <td style="text-align: left; width: 18%;">
                            ...
                            <td style="text-align: left; width: 30%;">
                              <asp:TextBox ID="txtLicPacCount" class="form1" runat="server" MaxLength="4" Height="30px" Width="250px" ReadOnly="true" Style="text-transform: uppercase"></asp:TextBox>
                        ...
                        <tr>
                          ...
                          <h2>Corporate Pack Count </h2>
                            ...
                            <td style="text-align: left; width: 30%;">
                             <asp:TextBox ID="txtCorPacCount" class="form1" runat="server" MaxLength="2" Height="30px" Width="250px" ReadOnly="true" Style="text-transform: uppercase"></asp:TextBox>
                  ...
                  <tr>
                         ...
                         <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                                ...
                                <p class="error" id="ErrorMsgOrgConPwd" style="visibility: hidden; font-family:Calibri;">Both passwords must be equal</p>
                            </td>

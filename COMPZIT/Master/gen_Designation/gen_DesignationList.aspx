<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_DesignationList.aspx.cs" Inherits="Master_gen_Designation_gen_DesignationList" %>
    ...
    <link rel="stylesheet" type="text/css" href="/css/New css/hcm_ns.css"/>
      <script type="text/javascript">
          ...
          function SuccessCancelation() {
              $("#success-alert").html("Designation cancelled successfully.");
              $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
              });
          }
          ...
          function OpenCancelView(StrId) {
              ezBSAlert({
                  type: "confirm",
                  messageText: "Do you want to cancel this Desgination?",
                  alertType: "info"
              }).done(function (e) {
                  if (e == true) {
         ...
         function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
            ...
            $.ajax({
                ...
                url: "gen_DesignationList.aspx/ReOpenConfByID",
                data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                dataType: "json",
                success: function (data) {
                    window.location.href = "gen_DesignationList.aspx?InsUpd=" + data.d;
                }
            });
            return false;
        }
        function SuccessSts() {
            $("#success-alert").html("Designation status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function AlreadySts() {
            $("#divWarning").html("Sorry, This Designation status is already changed!");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
...
<!---inner_content_sections area_started--->
          <h1 class="h1_con">Designation Master</h1>
...
<!----frame_closed section to footer script section--->
        ...
        <div class="modal-dialog mod1" role="document" id="divCancelPopUp">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   ...
                   <asp:Button ID="Button1" Text="Save" class="btn btn-success" runat="server"  OnClientClick="return ValidateCancelReason();"/>                   
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Designation.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
...
<!----------------------------------------------Content_section_opened------------------------------------------------------------->
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ...
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this Designation Status?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, orgID, corptID, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_DesignationList.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_DesignationList.aspx?InsUpd=AlCncl';
                         }
                         else if (SucessDetails == "AlSts") {
                             window.location = 'gen_DesignationList.aspx?InsUpd=AlSts';
                         }
                         else {
                             window.location = 'gen_DesignationList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
         ...
         var DsgControl = '<%=Session["DSGN_CONTROL"].ToString()%>';
         var DesignationTypeId = '<%=Session["DSGN_TYPID"].ToString()%>';
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             $.ajax({
                 type: "POST",
                 async: false,
                 contentType: "application/json; charset=utf-8",
                 url: "gen_DesignationList.aspx/PrintList",
                 data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",Status: "' + Status + '",CnclSts: "' + CnclSts + '",DsgControl:"' + DsgControl + '",DesignationTypeId:"'+DesignationTypeId+'"}',
                 dataType: "json",
                 success: function (data) {
                     if (data.d != "") {
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_DesignationList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_DesignationList.aspx/GetData";
             var objData = {};
             objData.DsgControl = DsgControl;
             objData.DesignationTypeId = DesignationTypeId;
    ...
    <!----new---->
      ...
      <%-- <div class="cont_rght">
                    ...
                    <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
                      <img src="../../Images/BigIcons/designation master.png" style="vertical-align: middle;" />   Designation Master
                    </div>
                 <%--0006 start--%>
        <%--<div class="eachform" style="width: 22%;margin-top: 2%;">
            ...
            <%--<div class="eachform" style="width:25%; margin-bottom: 1.2%;">               
              ...
              <%--0006 end--%>
                    ...
                    <%--<div onclick="location.href='gen_Designation.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

                   <%--     <a href="gen_Designation.aspx">
            ...
            <%--<div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 40%; padding-bottom: 0.7%; padding-top: 0.6%;">Designation Master</h3>
                    </div>

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Corp_OfficeList.aspx.cs" Inherits="Master_gen_Corp_Ofiice_gen_Corp_OfficeList" %>
   ...
   <script src="/css/New%20Plugins/libs/jquery-2.1.1.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function SuccessCancelation() {
            $("#success-alert").html("Business unit cancelled successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
        }
        function SuccessSts() {
            $("#success-alert").html("Business unit status changed successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
        }
    ...
    <script>
        function OpenCancelView(StrId) {
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this business unit?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
	...
	<div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">BUSINESS UNIT</h1>
  ...
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Corp_Office.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
    ...
    <script>
     function ChangeStatus(StrId, stsmode, cnclusrId) {
                   if (cnclusrId == "0") {
                       ezBSAlert({
                           type: "confirm",
                           messageText: "Do you want to change the status of this business unit?",
                           alertType: "info"
                       }).done(function (e) {
                           if (e == true) {
                        ...
                        var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, function (response) {
                            ...
                            if (SucessDetails == "success") {
                                window.location = 'gen_Corp_OfficeList.aspx?InsUpd=StsCh';
                            }
                            else {
                                window.location = 'gen_Corp_OfficeList.aspx?InsUpd=Error';
                            }
                        });
                    }
                });
               ...
               function PrintClick() {
                   ...
                   if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                       $.ajax({
                           ...
                           async: false,
                           contentType: "application/json; charset=utf-8",
                           url: "gen_Corp_OfficeList.aspx/PrintList",
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_Corp_OfficeList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_Corp_OfficeList.aspx/GetData";
             var objData = {};

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_approval_set_list.aspx.cs" Inherits="Master_gen_approval_set_gen_approval_set_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" Runat="Server">
    ...
    <script>
        ...
        function OpenCancelView(StrId) {
            ...
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this Approval?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
            ...
            if (strId != "") {
                ...
                var Details = PageMethods.CancelReason(strId, strCancelMust, strUserID, strCancelReason, strOrgIdID, strCorpID, function (response) {
                    ...
                    if (SucessDetails == "successcncl") {
                        ...
                        window.location = 'gen_approval_set_List.aspx?InsUpd=Cncl';


                    }
                    else {
                        window.location = 'gen_approval_set_List.aspx?InsUpd=Error';
                    }
                });
            }
                    ...
                    if (strId != "") {
                        ...
                        var Details = PageMethods.ChangeStatus(strId, Status, function (response) {
                            ...
                            if (SucessDetails == "successchng") {
                                ...
                                window.location = 'gen_approval_set_List.aspx?InsUpd=Sts';
        ...
        function SuccessInsertion() {
            $("#success-alert").html("Approval set inserted successfully.");
        ...
        function SuccessUpdation() {
            $("#success-alert").html("Approval Set updated successfully.");
            $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function SuccessStatusChng() {
            $("#success-alert").html("Approval Set status changed successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
            return false;
        }
        ...
        function AlreadyCancelMsg() {
            $("#danger-alert").html("Sorry, this approval set is already deleted!");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <ol id="OlSection" runat="server" class="breadcrumb">
      ...
      <li class="active">Approval Set</li>
    </ol>
<!---breadcrumb_section_started----> 
...
<!---inner_content_sections area_started--->
          <h1 id="lblEntry" runat="server" class="h1_con">APPROVAL SET</h1>
          ...
          <div class="form-group fg2">
            <label for="email" class="fg2_la1">Status<span class="spn1"></span>:</label>
              <asp:DropDownList ID="dlstatus" runat="server" class="form-control fg2_inp1 fg_chs1"  OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" >
                  ...
                  <asp:ListItem Value="2">Reopen</asp:ListItem>
           ...
           <div class="fg2">
            <label class="form1 mar_bo mar_tp">
              <span class="button-checkbox">
                ...
                <input type="checkbox" class="hidden" id="cbxCnclStatus" runat="server" runat="server" />
              </span>
...
<!---frame_border_area_closed---->
     ...
     <div class="modal fade" id="dialog_simple" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       ...
       <div id="divAdd" onclick="location.href='gen_approval_set.aspx'" runat="server">
           <a href="gen_approval_set.aspx" type="button" id="myBtn" title="Add New">
       ...
       //  alert("d");
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             ...
             $.ajax({
                 ...
                 url: "gen_approval_set_list.aspx/PrintList",
         ...
         var orgID = '<%= Session["ORGID"] %>';
            ...
            if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
                ...
                $.ajax({
                    ...
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    url: "gen_approval_set_list.aspx/PrintCSV",

...
public partial class Master_gen_Document_Workflow_gen_Document_Workflow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else if (Request.QueryString["ReId"] != null)
            {
                ...
                string strId = strRandomMixedId.Substring(2, intLenghtofId);
                //DisableAllControls(Page);
                lblEntry.InnerHtml = "View Document Workflow";
                ...
                HiddenHrchyId.Value = strId;
                hiddenEditMode.Value = "1";
                hiddenReplaceApproverSts.Value = "1";
            }
            //when  viewing
            ...
            if (Request.QueryString["VId"] != null)
            {
                ...
                ulLink.Visible = false;
                hiddenConditionChng.Value = "1";
                DisableAllControls(Page);
    ...
    public class clsTVData
    {
        ...
        public string CONDITIONTYP { get; set; }
    ...
    public void WRKFLW(string id, int mode)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                DateTime dat = objCommon.textToDateTime(dt.Rows[0]["WRKFLW_STRTDATE"].ToString());
            ...
            {
                DateTime Edat = objCommon.textToDateTime(dt.Rows[0]["WRKFLW_ENDDATE"].ToString());
            ...
            if (dt.Rows[0]["WRKFLW_APPRVL_RULE_STS"].ToString() == "1")
            {
                cbxApprvlRules.Checked = true;
            }
            else
            {
                cbxApprvlRules.Checked = false;
            }
            hiddenApprvlRuleSts.Value = dt.Rows[0]["WRKFLW_APPRVL_RULE_STS"].ToString();

            if (dt.Rows[0]["WRKFLW_MAJORITY_APRVL"].ToString() == "1")
            {
                cbxMajorityApprvl.Checked = true;
            }
            else
            {
                cbxMajorityApprvl.Checked = false;
            }
            if (dt.Rows[0]["WRKFLW_SINGLE_APRVL"].ToString() == "1")
            {
    ...
    public void Update1(string id, int mode)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            dtDetail.Columns.Add("CANMODIFY", typeof(string));
            ...
            for (int intCount = 0; intCount < dt.Rows.Count; intCount++)
            {
                ...
                objEntityDtl.TempId = Convert.ToInt32(dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString());
                DataTable dtSubst = objBusinessWrkflow.ReadSubstutEmptls(objEntityDtl);
                ...
                if (dtSubst.Rows.Count > 0)
                {
                    for (int intRow = 0; intRow < dtSubst.Rows.Count; intRow++)
                    {
                        if (SubstituteList == "")
                        {
                            SubstituteList = dtSubst.Rows[intRow]["DSGN_ID"].ToString() + "‡" + dtSubst.Rows[intRow]["USR_ID"].ToString() + "‡" + dtSubst.Rows[intRow]["DSGN_NAME"].ToString() + "‡" + dtSubst.Rows[intRow]["USR_NAME"].ToString() + "‡" + dtSubst.Rows[intRow]["WRKFLWSUBEMP_ID"].ToString();
                        }
                        else
                        {
                            SubstituteList = SubstituteList + "¦" + dtSubst.Rows[intRow]["DSGN_ID"].ToString() + "‡" + dtSubst.Rows[intRow]["USR_ID"].ToString() + "‡" + dtSubst.Rows[intRow]["DSGN_NAME"].ToString() + "‡" + dtSubst.Rows[intRow]["USR_NAME"].ToString() + "‡" + dtSubst.Rows[intRow]["WRKFLWSUBEMP_ID"].ToString();
                        }
                    }
                }
                ...
                drDtl["MAILSTS"] = dt.Rows[intCount]["WRKFLWDTL_MAIL_MSG_STS"].ToString();
                drDtl["SKIPLVLSTS"] = dt.Rows[intCount]["WRKFLWDTL_SKIP_LEVEL_STS"].ToString();
                drDtl["SUBSTUTVAL"] = SubstituteList;
                drDtl["PARENTID"] = dt.Rows[intCount]["WRKFLW_PARENT_DTL_ID"].ToString();
                drDtl["CANMODIFY"] = dt.Rows[intCount]["WRKFLWDTL_APRVR_MODFY"].ToString();

                dtDetail.Rows.Add(drDtl);

                objstr.Append("<li>");
                objstr.Append("<span><i class=\"fa fa-black-tie\"></i>" + dt.Rows[intCount]["USR_NAME"].ToString() + "</span>");
                objstr.Append("<button onclick=\"return FuctionOrganize1('" + dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString() + "','" + dt.Rows[intCount]["WRKFLW_LEVEL"].ToString() + "','" + dt.Rows[intCount]["USR_NAME"].ToString() + "','" + dt.Rows[intCount]["WRKFLW_ID"].ToString() + "');\" class=\"edt_1 tablinks notv\"><i class=\"fa fa-edit\"></i></button>");
                objstr.Append(bindSubmenu1(dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString()));
                objstr.Append("</li>");

                clsEntityApprovalHierarchyTemp objEntity = new clsEntityApprovalHierarchyTemp();
                objEntity.TempId = Convert.ToInt32(dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString());
                DataTable dtSub = objBussinesspasprt.ReadSubtableDOCDtls(objEntity);
    ...
    public void Update(string id, int mode)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                cbxSingleApproval.Checked = false;
                cbxSingleApproval.Enabled = false;
            }
    ...
    public void Updatesub(string id, int mode)
    {
        ...
        if (Session["CORPOFFICEID"] != null)
        {
            objentityPass.Corporate_id = Convert.ToInt32(Session["CORPOFFICEID"].ToString()); 
        }
        else if (Session["CORPOFFICEID"] == null)
        {
            Response.Redirect("/Default.aspx");
        ...
        objentityPass.TempId = Convert.ToInt32(id);
        objentityPass.Mode = 0;

        objentityPassport.Corporate_id = objentityPass.Corporate_id;
        objentityPassport.Organisation_id = objentityPass.Organisation_id;
        objentityPassport.TempId = objentityPass.TempId;
        objentityPassport.Mode = objentityPass.Mode;

        DataTable dt = objBussinesspas.ReadTemplatedtls(objentityPassport);
        DataTable dt1 = objBusinessWrkFlow.ReadSubtableDtls(objentityPass);
        ...
        dtDetail1.Columns.Add("MAILSTS", typeof(string));
        dtDetail1.Columns.Add("SKIPLVLSTS", typeof(string));
        dtDetail1.Columns.Add("SUBSTUTVAL", typeof(string));
        ...
        if (dt1.Rows.Count > 0)
        {
            ...
            for (int intCount1 = dt1.Rows.Count - 1; intCount1 >= 0; intCount1--)
            {
                ...
                clsEntityApprovalHierarchyTemp objEntityDtl = new clsEntityApprovalHierarchyTemp();
                objEntityDtl.TempId = Convert.ToInt32(dt1.Rows[intCount1]["HRCHY_DTL_ID"].ToString());
                DataTable dtSubst = objBussinesspas.ReadSubstutEmptls(objEntityDtl);
                ...
                drDtl1["MAILSTS"] = dt1.Rows[intCount1]["HRCHY_MAIL_MSG_STS"].ToString();
                drDtl1["SKIPLVLSTS"] = dt1.Rows[intCount1]["HRCHY_SKIP_LEVEL_STS"].ToString();
                drDtl1["SUBSTUTVAL"] = SubstituteList;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (cbxMajorityApprvl.Checked == true)
            {
                objEntityWrkFlow.MajorityAprvSts = 1;
            }
            if (cbxSingleApproval.Checked == true)
            {
                objEntityWrkFlow.SingleApprvlSts = 1;
            }
            if (cbxApprvlRules.Checked == true)
            {
                objEntityWrkFlow.ApprovalRuleSts = 1;
            }
            ...
            string jsonApprvData = hiddenApprovalDtls.Value;
            string cApprvData = jsonApprvData.Replace("\"{", "\\{");
            string dApprvData = cApprvData.Replace("\\n", "\r\n");
            string gApprvData = dApprvData.Replace("\\", "");
            string hApprvData = gApprvData.Replace("}\"]", "}]");
            string iApprvData = hApprvData.Replace("}\",", "},");

            List<clsTVData> objDataApprvDataList = new List<clsTVData>();
            objDataApprvDataList = JsonConvert.DeserializeObject<List<clsTVData>>(iApprvData);

            if (hiddenApprovalDtls.Value != "" && hiddenApprovalDtls.Value != null)
            {
                foreach (clsTVData objData in objDataApprvDataList)
                {
                    clsEntityApprovalHierarchyTemp objEntityDetails = new clsEntityApprovalHierarchyTemp();
                    if (objData.DTLID != "")
                    {
                        objEntityDetails.ApprvlRuleId = Convert.ToInt32(objData.DTLID);
                    }
                    objEntityDetails.ConditionId = Convert.ToInt32(objData.CONDITION);
                    objEntityDetails.ConditionTypeId = Convert.ToInt32(objData.CONDITIONTYP);
                    if (objData.MINVAL != "")
                    {
                        objEntityDetails.MinVal = Convert.ToInt32(objData.MINVAL);
                    }
                    if (objData.MAXVAL != "")
                    {
                        objEntityDetails.MaxVal = Convert.ToInt32(objData.MAXVAL);
                    }
                    objEntityDetails.CondtnValues = objData.CONDITIONVALUES;

                    objEntityApprvlRulesList.Add(objEntityDetails);
                }
            }
            ...
            if (HiddenFieldMainData.Value != "" && HiddenFieldMainData.Value != null)
            {
                objBusinessWrkFlow.InsertDocumentWorkflow(objEntityWrkFlow, objEntityWrkFlowMainList, objEntityWrkFlowSubList, objEntitySubstituteList, objEntityApprvlRulesList);
    ...
    protected void btnCnfrm_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hiddenCnclApprvlData.Value != "" && hiddenCnclApprvlData.Value != null)
            {
                string[] strCnclSplit = hiddenCnclApprvlData.Value.Split(',');
                foreach (string strCncl in strCnclSplit)
                {
                    if (strCncl != "")
                    {
                        clsEntityApprovalHierarchyTemp objEntityDetails = new clsEntityApprovalHierarchyTemp();
                        objEntityDetails.ApprvlRuleId = Convert.ToInt32(strCncl);
                        objEntityApprvlRulesDELETEList.Add(objEntityDetails);
                    }
                }
            }
        ...
        try
        {
            ...
            if (CnclSts == 0)
            {
                ...
                if (clickedButton.ID == "btnUpdate" || clickedButton.ID == "btnUpdateFloat")
                {
                    if (Request.QueryString["ReId"] != null)
                    {
                        Response.Redirect("gen_Document_Workflow.aspx?ReId=" + Request.QueryString["ReId"] + "&InsUpd=Upd");
                    }
                    else if (Request.QueryString["VId"] != null)
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "PassSavedValues", "PassSavedValues();", true);
                    }
                    else
                    {
                        Response.Redirect("gen_Document_Workflow.aspx?Id=" + Request.QueryString["Id"] + "&InsUpd=Upd");
    ...
    [WebMethod]
    public static string SaveDetails(string CorpId, string OrgId, string UserId, string Id, string Name, string DocId, string ApprvlTrnsfr, string ApprvlModify, string Descrptn, string Priority, string Status, string Dept, string Divsn, string HrchyId, string StrtDate, string EndDate, string MajrtyApprvl, string SingleApprvl, string HrchyChngdMode, string ReplaceApprvrSts,
        string DTLID, string LEVEL, string DESGID, string EMPID, string APPRVMANSTS, string SUBEMPSTS, string THRESMODE, string PERIOD, string APPRVPENSTS, string TTCSTS, string SMSSTS, string SYSSTS, string MAILSTS, string APRVRMODIFY, string SKIPLVLSTS, string SUBSTUTVAL, string PARENTID)
    {
        string strReturn = "";
        try
        {
            ...
            objEntityWrkFlow.User_Id = Convert.ToInt32(UserId);
            objEntityWrkFlow.TempId = Convert.ToInt32(Id);

            DataTable dt = objBusinessWrkFlow.Readwrkflwdtls11(objEntityWrkFlow);

            if (dt.Rows.Count > 0)
            {
                objEntityWrkFlow.Name = dt.Rows[0]["WRKFLW_NAME"].ToString();
                objEntityWrkFlow.Doc = dt.Rows[0]["DOC_ID"].ToString();
                objEntityWrkFlow.Status_id = Convert.ToInt32(dt.Rows[0]["WRKFLW_STATUS"].ToString());
                objEntityWrkFlow.descr = dt.Rows[0]["WRKFLW_DESCRIPTN"].ToString();
                objEntityWrkFlow.apptrans = Convert.ToInt32(dt.Rows[0]["WRKFLW_APRVL_TRNSFR"].ToString());
                objEntityWrkFlow.appmdf = Convert.ToInt32(dt.Rows[0]["WRKFLW_APRVR_MODFY"].ToString());
                objEntityWrkFlow.prity = Convert.ToInt32(dt.Rows[0]["WRKFLW_PRIORTY"].ToString());
                objEntityWrkFlow.hrid = Convert.ToInt32(dt.Rows[0]["HRCHY_ID"].ToString());
                objEntityWrkFlow.Dep = dt.Rows[0]["WRKFLW_CPRDEPT_IDS"].ToString();
                objEntityWrkFlow.div = dt.Rows[0]["WRKFLW_CPRDIV_IDS"].ToString();
                if (dt.Rows[0]["WRKFLW_STRTDATE"].ToString() != "")
                {
                    objEntityWrkFlow.StartDate = objCommon.textToDateTime(dt.Rows[0]["WRKFLW_STRTDATE"].ToString());
                }
                if (dt.Rows[0]["WRKFLW_ENDDATE"].ToString() != "")
                {
                    objEntityWrkFlow.EndDate = objCommon.textToDateTime(dt.Rows[0]["WRKFLW_ENDDATE"].ToString());
                }
                objEntityWrkFlow.ApprovalRuleSts = Convert.ToInt32(dt.Rows[0]["WRKFLW_APPRVL_RULE_STS"].ToString());
                objEntityWrkFlow.MajorityAprvSts = Convert.ToInt32(dt.Rows[0]["WRKFLW_MAJORITY_APRVL"].ToString());
                objEntityWrkFlow.SingleApprvlSts = Convert.ToInt32(dt.Rows[0]["WRKFLW_SINGLE_APRVL"].ToString());
            }
            else
            {
                objEntityWrkFlow.Name = Name;
                objEntityWrkFlow.Doc = DocId;
                objEntityWrkFlow.Status_id = Convert.ToInt32(Status);
                objEntityWrkFlow.descr = Descrptn;
                objEntityWrkFlow.apptrans = Convert.ToInt32(ApprvlTrnsfr);
                objEntityWrkFlow.appmdf = Convert.ToInt32(ApprvlModify);
                objEntityWrkFlow.Dep = Dept;
                objEntityWrkFlow.div = Divsn;
                objEntityWrkFlow.hrid = Convert.ToInt32(HrchyId);
                if (StrtDate != "")
                {
                    objEntityWrkFlow.StartDate = objCommon.textToDateTime(StrtDate);
                }
                if (EndDate != "")
                {
                    objEntityWrkFlow.EndDate = objCommon.textToDateTime(EndDate);
                }
                objEntityWrkFlow.prity = Convert.ToInt32(Priority);
                objEntityWrkFlow.MajorityAprvSts = Convert.ToInt32(MajrtyApprvl);
                objEntityWrkFlow.SingleApprvlSts = Convert.ToInt32(SingleApprvl);
                //objEntityWrkFlow.ApprovalRuleSts = ;
            }
            ...
            if (EMPID != "-Select-" && DESGID != "-Select-" && PERIOD != "")
            {
                ...
                {
                    objEntityDetails.DtlId = Convert.ToInt32(DTLID);//WrkflowDtlId
                }
                if (PARENTID != "")
                {
                    objEntityDetails.ParentId = Convert.ToInt32(PARENTID);//WrkflowDtlId
                }
                ...
                if (Convert.ToInt32(ApprvlModify) == 1)
                {
                    objEntityDetails.CanModify = 1;
                }
                else
                {
                    objEntityDetails.CanModify = Convert.ToInt32(APRVRMODIFY);
                }
            ...
            else
            {
                ...
                {
                    objentityPass.TempId = Convert.ToInt32(PARENTID);

                    dtLevel = objBussinesspasprt.ReadSubtableDOCDtls(objentityPass);
                    if (dtLevel.Rows.Count > 0)
                    {
                        int intLast = dtLevel.Rows.Count - 1;
                        strReturn = dtLevel.Rows[intLast]["WRKFLW_DTL_ID"].ToString();
                    }
                }
                else
                {
                    objentityPass.TempId = objEntityWrkFlow.TempId;

                    dtLevel = objBussinesspasprt.ReadDocumentdtls(objentityPass);
                    if (dtLevel.Rows.Count > 0)
                    {
                        int intLast = dtLevel.Rows.Count - 1;
                        strReturn = dtLevel.Rows[intLast]["WRKFLW_DTL_ID"].ToString();
    ...
    [WebMethod]
    public static string LoadHierarchy(string Id)
    {
        Master_gen_Document_Workflow_gen_Document_Workflow objMaster = new Master_gen_Document_Workflow_gen_Document_Workflow();
        ...
        if (dt.Rows.Count > 0)
        {
            for (int intCount = 0; intCount < dt.Rows.Count; intCount++)
            {
                ...
                objstr.Append("<span><i class=\"fa fa-black-tie\"></i>" + dt.Rows[intCount]["USR_NAME"].ToString() + "</span>");
                objstr.Append("<button onclick=\"return FuctionOrganize1('" + dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString() + "','" + dt.Rows[intCount]["WRKFLW_LEVEL"].ToString() + "','" + dt.Rows[intCount]["USR_NAME"].ToString() + "','" + dt.Rows[intCount]["WRKFLW_ID"].ToString() + "');\" class=\"edt_1 tablinks notv\"><i class=\"fa fa-edit\"></i></button>");
                objstr.Append(objMaster.bindSubmenu1(dt.Rows[intCount]["WRKFLW_DTL_ID"].ToString()));
                objstr.Append("</li>");
            }
        }
        return objstr.ToString();
    ...
    [WebMethod]
    public static string[] LoadConditionsTable(string CorpId, string OrgId, string DocId, string Id, string ApprvlSts)
    {
        string[] arr = new string[2];
        ...
        try
        {
            ...
            DataTable dt = objBusinessWrkFlow.ReadApprovalConditions(objEntityWrkFlow);

            clsEntityApprovalHierarchyTemp objEntity = new clsEntityApprovalHierarchyTemp();
            objEntity.Doc = DocId;
            DataTable dtConditions = objBusinessWrkFlow.ReadApprovalConditions(objEntity);

            DataTable dtDetail = new DataTable();
            dtDetail.Columns.Add("DTLID", typeof(string));
            dtDetail.Columns.Add("CONDITION", typeof(string));
            dtDetail.Columns.Add("CONDITIONTYPE", typeof(string));
            dtDetail.Columns.Add("MAXVAL", typeof(string));
            dtDetail.Columns.Add("MINVAL", typeof(string));
            dtDetail.Columns.Add("VALUES", typeof(string));
            dtDetail.Columns.Add("PACKAGE", typeof(string));
            dtDetail.Columns.Add("PROCEDURE", typeof(string));
            dtDetail.Columns.Add("CONDITIONNAME", typeof(string));
            dtDetail.Columns.Add("CONDITIONTYPENAME", typeof(string));
            dtDetail.Columns.Add("VALUESNAMES", typeof(string));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    DataRow drDtl = dtDetail.NewRow();
                    drDtl["DTLID"] = dt.Rows[intCount]["WRKFLWRULES_ID"].ToString();
                    drDtl["CONDITION"] = dt.Rows[intCount]["CNDTN_ID"].ToString();
                    drDtl["CONDITIONTYPE"] = dt.Rows[intCount]["CNDTN_TYPE_ID"].ToString();
                    drDtl["MAXVAL"] = dt.Rows[intCount]["WRKFLWRULESVAL_MAXVAL"].ToString();
                    drDtl["MINVAL"] = dt.Rows[intCount]["WRKFLWRULESVAL_MINVAL"].ToString();
                    drDtl["VALUES"] = dt.Rows[intCount]["WRKFLWRULESVAL_VALUES"].ToString();
                    drDtl["PACKAGE"] = dt.Rows[intCount]["CNDTN_PACKAGE"].ToString();
                    drDtl["PROCEDURE"] = dt.Rows[intCount]["CNDTN_PROCEDURE"].ToString();
                    drDtl["CONDITIONNAME"] = dt.Rows[intCount]["CNDTN_NAME"].ToString();
                    drDtl["CONDITIONTYPENAME"] = dt.Rows[intCount]["CNDTN_TYPE_NAME"].ToString();

                    string ConditionValues = dt.Rows[intCount]["WRKFLWRULESVAL_VALUES"].ToString();
                    string ConditionValNames = "";
                    if (ConditionValues != "")
                    {
                        objEntityWrkFlow.ConditionId = Convert.ToInt32(dt.Rows[intCount]["CNDTN_ID"].ToString());
                        objEntityWrkFlow.Corporate_id = Convert.ToInt32(CorpId);
                        objEntityWrkFlow.Organisation_id = Convert.ToInt32(OrgId);
                        objEntityWrkFlow.Name1 = "";

                        if (dt.Rows[intCount]["CNDTN_PACKAGE"].ToString() != "" && dt.Rows[intCount]["CNDTN_PROCEDURE"].ToString() != "")
                        {
                            DataTable dtConditionVal = objBusinessWrkFlow.ReadApprovalConditionVal(dt.Rows[intCount]["CNDTN_PACKAGE"].ToString(), dt.Rows[intCount]["CNDTN_PROCEDURE"].ToString(), objEntityWrkFlow);

                            string[] ConditionValuesSplit = ConditionValues.Split('¦');
                            foreach (string strVal in ConditionValuesSplit)
                            {
                                if (strVal != "")
                                {
                                    DataRow[] results = dtConditionVal.Select("ID = '" + strVal + "'");
                                    //DataRow row = results[0];
                                    string strValName = "";
                                    foreach (DataRow row in results)
                                    {
                                        strValName = row["NAME"].ToString();
                                    }
                                    if (ConditionValNames == "")
                                    {
                                        ConditionValNames = strVal + "‡" + strValName;
                                    }
                                    else
                                    {
                                        ConditionValNames = ConditionValNames + "¦" + strVal + "‡" + strValName;
                                    }
                                }
                            }
                        }
                    ...
                    drDtl["VALUESNAMES"] = ConditionValNames;
            ...
            arr[1] = "0";
            if (dtConditions.Rows.Count != dt.Rows.Count)
            {
                arr[1] = "1";
            }
        }
    ...
    [WebMethod]
    public static string LoadConditions(string DocId)
    {
        string arr = "";
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                for (int intCount = 0; intCount < dt.Rows.Count; intCount++)
                {
                    if (arr == "")
                    {
                        arr = dt.Rows[intCount]["CNDTN_ID"].ToString() + "‡" + dt.Rows[intCount]["CNDTN_NAME"].ToString();
                    }
                    else
                    {
                        arr = arr + "¦" + dt.Rows[intCount]["CNDTN_ID"].ToString() + "‡" + dt.Rows[intCount]["CNDTN_NAME"].ToString();
                    }
                }
            }
        }
    ...
    [WebMethod]
    public static string[] LoadConditionTypes(string DocId, string ConditionId)
    {
        ...
        try
        {
            ...
            objEntityWrkFlow.Doc = DocId;
            objEntityWrkFlow.ConditionId = Convert.ToInt32(ConditionId);
            DataTable dt = objBusinessWrkFlow.ReadConditionTyps(objEntityWrkFlow);
            ...
            if (dt.Rows.Count > 0)
            {
                for (int intCount = 0; intCount < dt.Rows.Count; intCount++)
                {
                    if (arr[0] == "")
                    {
                        arr[0] = dt.Rows[intCount]["CNDTN_TYPE_ID"].ToString() + "‡" + dt.Rows[intCount]["CNDTN_TYPE_NAME"].ToString();
                    }
                    else
                    {
                        arr[0] = arr[0] + "¦" + dt.Rows[intCount]["CNDTN_TYPE_ID"].ToString() + "‡" + dt.Rows[intCount]["CNDTN_TYPE_NAME"].ToString();
                    }
                }

                arr[1] = dt.Rows[0]["CNDTN_PACKAGE"].ToString();
                arr[2] = dt.Rows[0]["CNDTN_PROCEDURE"].ToString();
            }
        }
        catch (Exception ex)
        {
    ...
    [WebMethod]
    public static string LoadConditionValues(string CorpId, string OrgId, string Package, string Procedure, string ConditionId, string strText)
    {
        clsBusinessLayerPMS objBusinessWrkFlow = new clsBusinessLayerPMS();
        clsEntityApprovalHierarchyTemp objEntityWrkFlow = new clsEntityApprovalHierarchyTemp();
        ...
        objEntityWrkFlow.Corporate_id = Convert.ToInt32(CorpId);
        objEntityWrkFlow.Organisation_id = Convert.ToInt32(OrgId);
        objEntityWrkFlow.Name1 = strText;

        StringBuilder sb = new StringBuilder();
        if (Package != "" && Procedure != "")
        {
            DataTable dt = objBusinessWrkFlow.ReadApprovalConditionVal(Package, Procedure, objEntityWrkFlow);

            for (int intCount = 0; intCount < dt.Rows.Count; intCount++)
            {
                sb.Append("<option value=" + dt.Rows[intCount]["ID"].ToString() + ">" + dt.Rows[intCount]["NAME"].ToString() + "</option>");
            }
        }
    ...
    [WebMethod]
    public static string CheckConditionOverlaps(string CorpId, string OrgId, string Id, string DocId, string ListDept, string ListDiv, string FullValues)
    {
        string strArray = "";
        ...
        objEntityWrkFlow.Dep = ListDept;
        objEntityWrkFlow.div = ListDiv;
        objEntityWrkFlow.Corporate_id = Convert.ToInt32(CorpId);
        objEntityWrkFlow.Organisation_id = Convert.ToInt32(OrgId);
        objEntityWrkFlow.Doc = DocId;
        if (Id != "")
        ...
        //objEntityWrkFlow.ConditionId = Convert.ToInt32(CurrentCondition);
        //objEntityWrkFlow.ConditionTypeId = Convert.ToInt32(CurrentConditionType);
        //if (objEntityWrkFlow.ConditionId == 1)
        //{
        //    objEntityWrkFlow.MinVal = Convert.ToInt32(CurrentMinVal);
        //    objEntityWrkFlow.MaxVal = Convert.ToInt32(CurrentMaxVal);
        //}
        //else
        //{
        //    objEntityWrkFlow.CondtnValues = CurrentValues;
        //}

        DataTable dtAll = objBusinessWrkFlow.ReadApprovalRules(objEntityWrkFlow);

        clsCommonLibrary objCommon = new clsCommonLibrary();
        string strRandom = objCommon.Random_Number();

        string strUse = ""; int Return = 0;
        if (dtAll.Rows.Count > 0)
        {
            for (int Count = 0; Count < dtAll.Rows.Count; Count++)
            {

                string[] strValSplit = FullValues.Split('—');
                foreach (string strValues in strValSplit)
                {
                    string[] strDtlSplit = strValues.Split('%');
                    string CurrentCondition = strDtlSplit[0];
                    string CurrentConditionType = strDtlSplit[1];
                    string CurrentMinVal = strDtlSplit[2];
                    string CurrentMaxVal = strDtlSplit[3];
                    string CurrentValues = strDtlSplit[4];

                    if (CurrentCondition == dtAll.Rows[Count]["CNDTN_ID"].ToString())
                    {
                        int CountVal = 0;
                        string[] DeptCurrent = ListDept.Split(',');
                        string strDepVals = dtAll.Rows[Count]["WRKFLW_CPRDEPT_IDS"].ToString();
                        foreach (string strVal in strDepVals.Split(','))
                        {
                            if (DeptCurrent.Contains(strVal))
                            {
                                CountVal++;
                            }
                        }

                        string[] DivCurrent = ListDiv.Split(',');
                        string strDivVals = dtAll.Rows[Count]["WRKFLW_CPRDIV_IDS"].ToString();
                        foreach (string strVal in strDivVals.Split(','))
                        {
                            if (DivCurrent.Contains(strVal))
                            {
                                CountVal++;
                            }
                        }
                        ...
                        if (CountVal > 0)
                        {
                            ...
                            string strRandomId = dtAll.Rows[Count]["WRKFLW_ID"].ToString();
                            int intIdLength = dtAll.Rows[Count]["WRKFLW_ID"].ToString().Length;
                            string stridLength = intIdLength.ToString("00");
                            string strId = stridLength + strRandomId + strRandom;

                            if (strUse != dtAll.Rows[Count]["WRKFLW_ID"].ToString())
                            {
                                Return = 0;
                            }
                            ...
                            {
                                int MAX = 0;
                                if (dtAll.Rows[Count]["WRKFLWRULESVAL_MAXVAL"].ToString() != "")
                                {
                                    MAX = Convert.ToInt32(dtAll.Rows[Count]["WRKFLWRULESVAL_MAXVAL"].ToString());
                                }
                                int MIN = 0;
                                if (dtAll.Rows[Count]["WRKFLWRULESVAL_MINVAL"].ToString() != "")
                                {
                                    MIN = Convert.ToInt32(dtAll.Rows[Count]["WRKFLWRULESVAL_MINVAL"].ToString());
                                }
                                int CONDTNTYP = Convert.ToInt32(dtAll.Rows[Count]["CNDTN_TYPE_ID"].ToString());

                                if (CurrentConditionType == "1")//between
                                {
                                    if ((CONDTNTYP == 1 || CONDTNTYP == 3) && (Convert.ToInt32(CurrentMinVal) <= MIN) || ((CONDTNTYP == 1 || CONDTNTYP == 2) && MAX >= Convert.ToInt32(CurrentMaxVal)))
                                    {
                                        Return++;
                                    }
                                }
                                else if (CurrentConditionType == "2")//less than
                                {
                                    if (MAX < Convert.ToInt32(CurrentMaxVal))
                                    {
                                        Return++;
                                    }
                                }
                                else if (CurrentConditionType == "3")//greater than
                                {
                                    if (MIN > Convert.ToInt32(CurrentMinVal))
                                    {
                                        Return++;
                                    }
                                }
                            ...
                            {
                                string[] arrayOne = CurrentValues.Split('¦');
                                string[] arrayTwo = dtAll.Rows[Count]["WRKFLWRULESVAL_VALUES"].ToString().Split('¦');
                                var isEqual = new HashSet<string>(arrayOne).SetEquals(arrayTwo);
                                if (isEqual == true)
                                {
                                    Return++;
                                }
                            ...
                            if (Return == Convert.ToInt32(dtAll.Rows[Count]["CNT"].ToString()))
                            {
                                if (strArray == "")
                                {
                                    strArray = strId + "‡" + dtAll.Rows[Count]["WRKFLW_NAME"].ToString();
                                }
                                else
                                {
                                    strArray = strArray + "¦" + strId + "‡" + dtAll.Rows[Count]["WRKFLW_NAME"].ToString();
                                }
                            }
                            strUse = strRandomId;
                        }

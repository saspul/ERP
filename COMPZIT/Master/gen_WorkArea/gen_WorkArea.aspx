<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_WorkArea.aspx.cs" Inherits="Master_gen_WorkArea_gen_WorkAreaAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
 ...
 <link href="/css/New css/pro_mng.css" rel="stylesheet" />
    <script>
        ...
        $au(function () {
            $au('#cphMain_ddlPremise').selectToAutocomplete1Letter();
        });
    </script>
  ...
  <script>
      ...
      function ConfirmMessage() {
          if (confirmbox > 0) {
              ezBSAlert({
                  ...
                  if (e == true) {
                      window.location.href = "gen_WorkAreaList.aspx";
                      return false;
                  }
                  else {
                      return false;
      ...
      function AlertClearAll() {
          if (confirmbox > 0) {
              ezBSAlert({
                  ...
                  if (e == true) {
                      window.location.href = "gen_WorkArea.aspx";
                      return false;
                  }
                  else {
                      return false;
    ...
    <script type="text/javascript">
        ...
        function DuplicationName() {
            $("#divWarning").html("Duplication error!. Premise area name can’t be duplicated.");
            $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
            });
            document.getElementById("<%=txtWorkAreaName.ClientID%>").style.borderColor = "Red";
            document.getElementById("<%=txtWorkAreaName.ClientID%>").focus();
        }

        function SuccessConfirmation() {
            $("#success-alert").html("Premise area details inserted successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        }
        function SuccessUpdation() {
            $("#success-alert").html("Premise area details updated successfully.");
            $("#success-alert").fadeTo(3000, 500).slideUp(500, function () {
            });
        }
        function NameValidate() {
            ...
            // replacing < and > tags
            var NameWithoutReplace = document.getElementById("<%=txtWorkAreaName.ClientID%>").value;
            var replaceText1 = NameWithoutReplace.replace(/</g, "");
            var replaceText2 = replaceText1.replace(/>/g, "");
            document.getElementById("<%=txtWorkAreaName.ClientID%>").value = replaceText2;

            document.getElementById("<%=txtWorkAreaName.ClientID%>").style.borderColor = "";
            document.getElementById("<%=ddlPremise.ClientID%>").style.borderColor = "";
        

            var Name = document.getElementById("<%=txtWorkAreaName.ClientID%>").value.trim();

            var Department = document.getElementById("<%=ddlPremise.ClientID%>");
            var Dept = Department.options[Department.selectedIndex].text;
            $("div#divBnk input.ui-autocomplete-input").css("borderColor", "");
            if (Name == "" || Dept == "--SELECT PREMISE--") {
                $("#divWarning").html("Some of the information you entered is not correct or missing. Please check the highlighted fields below.");
                $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
                });

                if (Dept == "--SELECT PREMISE--") {
                    document.getElementById("<%=ddlPremise.ClientID%>").style.borderColor = "Red";
                    document.getElementById("<%=ddlPremise.ClientID%>").focus();
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="gen_WorkAreaList.aspx">Premise Area</a></li>
        <li id="lblEntryB" runat="server" class="active">Add Premise Area</li>
      </ol>
   <div class="myAlert-top alert alert-success" id="success-alert">
    ...
    <div class="content_area_container cont_contr">  
      <div class="content_box1 cont_contr" onmouseover="closesave()">
        <h2 id="lblEntry" runat="server">Add Premise Area</h2>
 <!---------------------------==============frame===============--------------------------------> 

        <div class="form-group fg2 sa_o_fg6">
          <label for="email" class="fg2_la1">Premise Area Name:<span class="spn1">*</span></label>
             <asp:TextBox ID="txtWorkAreaName" class="form-control fg2_inp1 inp_mst" runat="server" MaxLength="150" Style="text-transform: uppercase;" placeholder="Area Name"></asp:TextBox>
        </div>
        <div class="form-group fg2 sa_o_fg6" id="divBnk">
          <label for="email" class="fg2_la1">Premise:<span class="spn1">*</span></label>
             <asp:DropDownList ID="ddlPremise" class="form-control fg2_inp1 inp_mst" runat="server"></asp:DropDownList>
        </div>        

<%@ Page Language="C#"  MasterPageFile="~/MasterPage/MasterPageCompzit_Hcm.master" AutoEventWireup="true" CodeFile="gen_TeamHierarchyList.aspx.cs" Inherits="Master_gen_TeamHierarchy_gen_TeamHierarchyList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
    ...
    <script type="text/javascript">
        function SuccessConfirmation() {
            ...
            document.getElementById("<%=lblSuccessUpd.ClientID%>").innerHTML = "Team Details Inserted Successfully.";
        }
        function SuccessUpdation() {
            document.getElementById('divSuccessUpd').style.visibility = "visible";
            document.getElementById("<%=lblSuccessUpd.ClientID%>").innerHTML = "Team Details Updated Successfully.";
        }
        function SuccessCancelation() {
            document.getElementById('divSuccessUpd').style.visibility = "visible";
            document.getElementById("<%=lblSuccessUpd.ClientID%>").innerHTML = "Team Cancelled Successfully.";
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div class="cont_rght">
        ...
        <div id="divReportCaption" style="font-size: 24px; font-weight: bold; color: rgb(83, 101, 51); font-family: Calibri">
            <img src="../../Images/BigIcons/Team-Hierarchy48x48.png" style="vertical-align: middle;" />
            Team Hierarchy
        </div>
         <%--0006 start--%>
        ...
        <div onclick="location.href='gen_TeamHierarchy.aspx'" id="divAdd" class="add" runat="server" style=" position: fixed; height:26.5px; right:1%;">

           <%-- <a href="gen_TeamHierarchy.aspx">
            ...
            <div id="MymodalCancelView" class="modalCancelView" >
                ...
                <div class="modal-CancelView">
                    <div class="modal-headerCancelView">
                        ...
                        <h3 style="font-family: Calibri; font-size: 18px; margin-left: 37%; padding-bottom: 0.7%; padding-top: 0.6%;">Team Hierarchy</h3>
                    </div>

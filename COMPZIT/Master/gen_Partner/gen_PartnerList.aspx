<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_PartnerList.aspx.cs" Inherits="Master_gen_Partner_gen_Partner_List" %>
    ...
    <link href="/css/New css/pro_mng.css" rel="stylesheet" />
     <script>
         ...
         function SuccessCancelation() {
             $("#success-alert").html("Corporate partner cancelled successfully.");
             $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
             });
         }
        ...
        function OpenCancelView(StrId) {
            ezBSAlert({
                type: "confirm",
                messageText: "Do you want to cancel this corporate partner?",
                alertType: "info"
            }).done(function (e) {
                if (e == true) {
         ...
         function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
             ...
             var orgID = '<%= Session["ORGID"] %>';
                 ...
                 $.ajax({
                     ...
                     url: "gen_PartnerList.aspx/ReOpenConfByID",
                     data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                     dataType: "json",
                     success: function (data) {
                         window.location.href = "gen_PartnerList.aspx?InsUpd=" + data.d;
                     }
                 });
                 return false;
             }
             function SuccessSts() {
                 $("#success-alert").html("Corporate partner status changed successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
                 return false;
             }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:HiddenField ID="hiddenCbxDele" runat="server"/>
    ...
    <asp:HiddenField ID="HiddenFieldType" runat="server" />
     ...
     <ol class="breadcrumb">
        ...
        <li class="active">Corporate Partner</li>      
      </ol>
    ...
    <div class="content_sec2 cont_contr">
      ...
      <div class="content_box1 cont_contr">
        <h1 class="h1_con">Corporate Partner</h1>


            <div class="form-group fg2" id="divBnk">
         <label for="email" class="fg2_la1">Partnership Type:<span class="spn1">*</span></label>
                 <asp:DropDownList ID="ddlPartType" class="form-control fg2_inp1 inp_mst" runat="server">
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Partner.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
 ...
 <script>
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this corporate partner?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_PartnerList.aspx?InsUpd=StsCh';
                         }
                         else {
                             window.location = 'gen_PartnerList.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
         ...
         if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
             $.ajax({
                 ...
                 async: false,
                 contentType: "application/json; charset=utf-8",
                 url: "gen_PartnerList.aspx/PrintList",
     ...
     <script>
         ...
         $(document).ready(function () {
             ...
             document.getElementById("<%=HiddenFieldType.ClientID%>").value = document.getElementById("<%=ddlPartType.ClientID%>").value;
             document.getElementById("<%=HiddenFieldTypeText.ClientID%>").value = $("#cphMain_ddlPartType option:selected").text();
         ...
         function Load_dt() {
             ...
             var url = "gen_PartnerList.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_PartnerList.aspx/GetData";
             var objData = {};

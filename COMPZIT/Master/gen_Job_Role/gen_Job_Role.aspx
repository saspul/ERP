<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Job_Role.aspx.cs" Inherits="Master_gen_Job_Role_Job_Role" %>
 ...
 <link href="/css/New css/pro_mng.css" rel="stylesheet" />
    ...
    <script>
        ...
        $noCon(window).load(function () {
            ...
            if (document.getElementById("<%=lblEntry.ClientID%>").innerText == "VIEW JOB ROLE") {
        ...
        function ConfirmMessage() {
            if (confirmbox > 0) {
                ezBSAlert({
                    ...
                    if (e == true) {
                        window.location.href = "gen_Job_Role_List.aspx";
                        return false;
                    }
                    else {
                        return false;
        ...
        function AlertClearAll() {
            if (confirmbox > 0) {
                ezBSAlert({
                    ...
                    if (e == true) {
                        window.location.href = "gen_Job_Role.aspx";
                        return false;
                    }
                    else {
                        return false;
    ...
    <script type="text/javascript">
         ...
         function DuplicationName() {
             $("#divWarning").html("Duplication error! Job Role cannot be duplicated");
         ...
         function Validate() {
            ...
            document.getElementById("<%=ddlDesignation.ClientID%>").style.borderColor = "";
             ...
             var jobrol = document.getElementById("<%=txtJobRoleName.ClientID%>").value;

             document.getElementById("<%=txtJobRoleName.ClientID%>").style.borderColor = "";
             ...
             if (jobrol == "") {
                 ...
                 document.getElementById("<%=txtJobRoleName.ClientID%>").style.borderColor = "Red";
                document.getElementById("<%=txtJobRoleName.ClientID%>").focus();
                  ret = false;
              }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="gen_Job_Role_List.aspx">Job Role</a></li>
        <li id="lblEntryB" runat="server" class="active">Job Role Allocation</li>
      </ol>
   <div class="myAlert-top alert alert-success" id="success-alert">
    ...
    <div class="content_area_container cont_contr">
      ...
      <div class="content_box1 cont_contr" onmouseover="closesave()">
        <h2 id="lblEntry" runat="server">Add Job Role </h2>        
       
        <div class="form-group fg2 sa_fg4 sa_640_i1 sa_480">
          <label for="email" class="fg2_la1">Job Role:<span class="spn1">*</span></label>
             <asp:TextBox ID="txtJobRoleName" runat="server" autocomplete="off" MaxLength="100" class="form-control fg2_inp1" placeholder="Job Role" onkeydown="return isTagEnter(event);" onkeypress="return isTagEnter(event);"  onkeyup="IncrmntConfrmCounter()"></asp:TextBox>   
        </div>
...
<!------tree_section_closed----->
         ...
         <div class="sub_cont pull-right">
          <div class="save_sec">
                    ...
                    <asp:Button ID="btnAdd" runat="server" class="btn sub1" Text="Save"  OnClientClick="return Validate();  " OnClick="btnAdd_Click" />
                    <asp:Button ID="btnAddClose" runat="server" class="btn sub3" Text="Save & Close"  OnClientClick="return Validate();  " OnClick="btnAdd_Click" />
  ...
  <div class="save_sec">
           <asp:Button ID="btnUpdateF" runat="server" class="btn sub1 bt_b" Text="Update"  OnClientClick="return Validate(); " OnClick="btnUpdate_Click" />
                    ...
                    <asp:Button ID="btnAddF" runat="server" class="btn sub1 bt_b" Text="Save"  OnClientClick="return Validate();" OnClick="btnAdd_Click" />
                    <asp:Button ID="btnAddCloseF" runat="server" class="btn sub3 bt_b" Text="Save & Close" OnClientClick="return Validate();  " OnClick="btnAdd_Click" />

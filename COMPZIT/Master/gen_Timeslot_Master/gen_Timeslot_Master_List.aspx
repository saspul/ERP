<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageCompzit.master" AutoEventWireup="true" CodeFile="gen_Timeslot_Master_List.aspx.cs" Inherits="Master_gen_Timeslot_Master_gen_Timeslot_Master_List" %>
    ...
    <link href="/css/New css/pro_mng.css" rel="stylesheet" />
         <script>
             ...
             function SuccessCancelation() {
                 $("#success-alert").html("Time slot cancelled successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
             }
             function SuccessRecall() {
                 $("#success-alert").html("Time slot details recalled successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
             }
             ...
             function DuplicationName() {
                 $("#divWarning").html("Recalling denied!. Time slot name can’t be duplicated.");
                 $("#divWarning").fadeTo(3000, 500).slideUp(500, function () {
                 });
             }
             ...
             function OpenCancelView(StrId) {
                 ezBSAlert({
                     type: "confirm",
                     messageText: "Do you want to cancel this time slot?",
                     alertType: "info"
                 }).done(function (e) {
                     if (e == true) {
         ...
         function ReOpenConfByID(StrId, Mode, reasonmust, cnclRsn) {
             ...
             var orgID = '<%= Session["ORGID"] %>';
                 ...
                 $.ajax({
                     ...
                     url: "gen_Timeslot_Master_List.aspx/ReOpenConfByID",
                     data: '{orgID: "' + orgID + '",corptID: "' + corptID + '",userID: "' + userID + '",MasterDbId: "' + MasterDbId + '",Mode: "' + Mode + '",reasonmust: "' + reasonmust + '",cnclRsn: "' + cnclRsn + '"}',
                     dataType: "json",
                     success: function (data) {
                         window.location.href = "gen_Timeslot_Master_List.aspx?InsUpd=" + data.d;
                     }
                 });
                 return false;
             }
             function SuccessSts() {
                 $("#success-alert").html("Time slot status changed successfully.");
                 $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                 });
                 return false;
             }
             ...
             function ReCallAlert(StrId) {
                 ezBSAlert({
                     type: "confirm",
                     messageText: "Do you want to recall this time slot?",
                     alertType: "info"
                 }).done(function (e) {
                     if (e == true) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
      ...
      <asp:HiddenField ID="hiddenRoleRecall" runat="server" Value="0" />
 ...
 <a href="#" type="button" class="print_o" title="Print page" onclick="return PrintClick();">
  <i class="fa fa-print"></i>
    ...
    <a href="gen_Timeslot_Master.aspx" type="button" onclick="topFunction()" id="myBtn" runat="server" title="Add New">
 ...
 <script>
     ...
     function ChangeStatus(StrId, stsmode, cnclusrId) {
         if (cnclusrId == "0") {
             ezBSAlert({
                 type: "confirm",
                 messageText: "Do you want to change the status of this time slot?",
                 alertType: "info"
             }).done(function (e) {
                 if (e == true) {
                     ...
                     var Details = PageMethods.ChangeStatus(StrId, stsmode, usrId,corptID, function (response) {
                         ...
                         if (SucessDetails == "success") {
                             window.location = 'gen_Timeslot_Master_List.aspx?InsUpd=StsCh';
                         }
                         else if (SucessDetails == "AlCncl") {
                             window.location = 'gen_Timeslot_Master_List.aspx?InsUpd=AlCncl';
                         }
                         else {
                             window.location = 'gen_Timeslot_Master_List.aspx?InsUpd=Error';
                         }
                     });
                 }
             });
     ...
     function PrintClick() {
        ...
        if (corptID != "" && corptID != null && orgID != "" && orgID != null) {
            $.ajax({
                ...
                async: false,
                contentType: "application/json; charset=utf-8",
                url: "gen_Timeslot_Master_List.aspx/PrintList",
     ...
     <script>
         ...
         function Load_dt() {
             ...
             var url = "gen_Timeslot_Master_List.aspx/LoadStaticDatafordt";
             $.ajax({
                 type: 'POST',
                 dataType: 'json',
                 contentType: "application/json; charset=utf-8",
         ...
         function getdata(strPageNumber) {
             ...
             var url = "gen_Timeslot_Master_List.aspx/GetData";
             var objData = {};
